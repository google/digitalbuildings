...
/**
* Class Cdws_swtc_bypvpm 
* Condenser water system with supply and bypass control.
*/
@SuppressWarnings("serial")
public class Cdws_swtc_bypvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Bypvpm implements ICdws_swtc_bypvpm{

	IRI newInstance;
	public Cdws_swtc_bypvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cdws_swtc_bypvpm"));
	}
  ...
  public void addUsesSupply_water_isolation_valve_status (ISupply_water_isolation_valve_status parameter)
	...
	public static Set<ICdws_swtc_bypvpm> getAllCdws_swtc_bypvpmsObjectsCreated(){
		Set<ICdws_swtc_bypvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cdws_swtc_bypvpm")).subjects().stream()
		.map(mapper->(ICdws_swtc_bypvpm)mapper)
