...
public class Stdspc extends www.google.com.digitalbuildings._0_0_1.Operational implements IStdspc{

	IRI newInstance;
	public Stdspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Stdspc"));
	}
  ...
  public void addUsesSupply_air_temperature_sensor (ISupply_air_temperature_sensor parameter)
	...
	public static Set<IStdspc> getAllStdspcsObjectsCreated(){
		Set<IStdspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Stdspc")).subjects().stream()
		.map(mapper->(IStdspc)mapper)
