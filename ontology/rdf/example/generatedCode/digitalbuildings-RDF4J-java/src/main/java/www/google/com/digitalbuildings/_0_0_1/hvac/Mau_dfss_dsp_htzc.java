...
/**
* Class Mau_dfss_dsp_htzc 
* Single zone reheat make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dsp_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Htzc implements IMau_dfss_dsp_htzc{

	IRI newInstance;
	public Mau_dfss_dsp_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dsp_htzc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IMau_dfss_dsp_htzc> getAllMau_dfss_dsp_htzcsObjectsCreated(){
		Set<IMau_dfss_dsp_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dsp_htzc")).subjects().stream()
		.map(mapper->(IMau_dfss_dsp_htzc)mapper)
