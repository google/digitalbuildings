...
/**
* Class Dx2dc 
* Two compressor run control on discharge side (DTC).
*/
@SuppressWarnings("serial")
public class Dx2dc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx2dc{

	IRI newInstance;
	public Dx2dc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2dc"));
	}
  ...
  public void addUsesDischarge_air_temperature_setpoint (IDischarge_air_temperature_setpoint parameter)
	...
	public static Set<IDx2dc> getAllDx2dcsObjectsCreated(){
		Set<IDx2dc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2dc")).subjects().stream()
		.map(mapper->(IDx2dc)mapper)
