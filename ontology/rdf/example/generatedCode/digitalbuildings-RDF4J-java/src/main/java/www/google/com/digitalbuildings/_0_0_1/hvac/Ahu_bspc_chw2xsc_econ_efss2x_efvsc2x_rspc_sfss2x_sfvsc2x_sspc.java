...
/**
* Class Ahu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss2x implements IAhu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc{

	IRI newInstance;
	public Ahu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc"));
	}
  ...
  public void addUsesOptionalsOutside_air_flowrate_requirement (IOutside_air_flowrate_requirement parameter)
	...
	public static Set<IAhu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc> getAllAhu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspcsObjectsCreated(){
		Set<IAhu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc")).subjects().stream()
		.map(mapper->(IAhu_bspc_chw2xsc_econ_efss2x_efvsc2x_rspc_sfss2x_sfvsc2x_sspc)mapper)
