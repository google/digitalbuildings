...
public class Return_air_temperature_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IReturn_air_temperature_setpoint{

	IRI newInstance;
	public Return_air_temperature_setpoint(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Return_air_temperature_setpoint"));
	}
  ...
  public void addComposedOfTemperature (ITemperature parameter)
	...
	public static Set<IReturn_air_temperature_setpoint> getAllReturn_air_temperature_setpointsObjectsCreated(){
		Set<IReturn_air_temperature_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Return_air_temperature_setpoint")).subjects().stream()
		.map(mapper->(IReturn_air_temperature_setpoint)mapper)
