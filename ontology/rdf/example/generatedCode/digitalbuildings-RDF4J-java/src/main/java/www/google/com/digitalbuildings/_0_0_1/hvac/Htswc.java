...
public class Htswc extends www.google.com.digitalbuildings._0_0_1.Control implements IHtswc{

	IRI newInstance;
	public Htswc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htswc"));
	}
  ...
  public void addUsesSupply_water_temperature_setpoint (ISupply_water_temperature_setpoint parameter)
	...
	public static Set<IHtswc> getAllHtswcsObjectsCreated(){
		Set<IHtswc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htswc")).subjects().stream()
		.map(mapper->(IHtswc)mapper)
