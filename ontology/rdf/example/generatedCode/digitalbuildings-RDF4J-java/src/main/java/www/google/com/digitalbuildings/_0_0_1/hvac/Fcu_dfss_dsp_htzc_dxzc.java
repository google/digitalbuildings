...
/**
* Class Fcu_dfss_dsp_htzc_dxzc 
* DX fan coil with reheat (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_htzc_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Htzc implements IFcu_dfss_dsp_htzc_dxzc{

	IRI newInstance;
	public Fcu_dfss_dsp_htzc_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_htzc_dxzc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFcu_dfss_dsp_htzc_dxzc> getAllFcu_dfss_dsp_htzc_dxzcsObjectsCreated(){
		Set<IFcu_dfss_dsp_htzc_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_htzc_dxzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_htzc_dxzc)mapper)
