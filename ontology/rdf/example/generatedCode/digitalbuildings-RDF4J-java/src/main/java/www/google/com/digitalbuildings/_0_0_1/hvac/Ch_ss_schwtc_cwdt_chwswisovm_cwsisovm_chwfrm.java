...
/**
* Class Ch_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm 
* Water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICh_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm{

	IRI newInstance;
	public Ch_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm"));
	}
  ...
  public void addUsesChilled_water_flowrate_sensor (IChilled_water_flowrate_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm> getAllCh_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrmsObjectsCreated(){
		Set<ICh_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_cwdt_chwswisovm_cwsisovm_chwfrm)mapper)
