...
import www.google.com.digitalbuildings._0_0_1.subfields.IInput;
import www.google.com.digitalbuildings._0_0_1.subfields.Input;
...
public class Heating_input_thermal_power_capacity extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IHeating_input_thermal_power_capacity{

	IRI newInstance;
	public Heating_input_thermal_power_capacity(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Heating_input_thermal_power_capacity"));
	}
  ...
  public void addComposedOfInput (IInput parameter)
	{
		GLOBAL.model.add(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), parameter);
	}

	public Set<IInput> getComposedOfInput (){
		Set<IInput> ComposedOfInput = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Input) {
				ComposedOfInput.add((Input)action);
			}
		});
		return ComposedOfInput;
	}
  ...
  public void addComposedOfThermal (IThermal parameter)
	...
	public static Set<IHeating_input_thermal_power_capacity> getAllHeating_input_thermal_power_capacitysObjectsCreated(){
		Set<IHeating_input_thermal_power_capacity> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Heating_input_thermal_power_capacity")).subjects().stream()
		.map(mapper->(IHeating_input_thermal_power_capacity)mapper)
