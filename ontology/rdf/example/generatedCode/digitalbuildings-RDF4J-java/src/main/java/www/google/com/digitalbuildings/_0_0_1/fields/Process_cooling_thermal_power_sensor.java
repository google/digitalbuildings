...
public class Process_cooling_thermal_power_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IProcess_cooling_thermal_power_sensor{

	IRI newInstance;
	public Process_cooling_thermal_power_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_cooling_thermal_power_sensor"));
	}
  ...
  public void addComposedOfThermal (IThermal parameter)
	...
	public static Set<IProcess_cooling_thermal_power_sensor> getAllProcess_cooling_thermal_power_sensorsObjectsCreated(){
		Set<IProcess_cooling_thermal_power_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_cooling_thermal_power_sensor")).subjects().stream()
		.map(mapper->(IProcess_cooling_thermal_power_sensor)mapper)
