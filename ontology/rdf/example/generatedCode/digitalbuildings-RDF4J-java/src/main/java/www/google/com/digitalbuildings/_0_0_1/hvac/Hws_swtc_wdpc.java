...
public class Hws_swtc_wdpc extends www.google.com.digitalbuildings._0_0_1.hvac.Wdpc implements IHws_swtc_wdpc{

	IRI newInstance;
	public Hws_swtc_wdpc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc"));
	}
  ...
  public void addUsesSpeed_percentage_command (ISpeed_percentage_command parameter)
	...
	public static Set<IHws_swtc_wdpc> getAllHws_swtc_wdpcsObjectsCreated(){
		Set<IHws_swtc_wdpc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc")).subjects().stream()
		.map(mapper->(IHws_swtc_wdpc)mapper)
