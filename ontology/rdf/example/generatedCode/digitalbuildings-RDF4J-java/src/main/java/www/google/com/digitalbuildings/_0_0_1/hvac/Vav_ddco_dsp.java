...
/**
* Class Vav_ddco_dsp 
* Weird dual duct VAV with cooling only, twice.
*/
@SuppressWarnings("serial")
public class Vav_ddco_dsp extends www.google.com.digitalbuildings._0_0_1.hvac.Ddco implements IVav_ddco_dsp{

	IRI newInstance;
	public Vav_ddco_dsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_ddco_dsp"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IVav_ddco_dsp> getAllVav_ddco_dspsObjectsCreated(){
		Set<IVav_ddco_dsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_ddco_dsp")).subjects().stream()
		.map(mapper->(IVav_ddco_dsp)mapper)
