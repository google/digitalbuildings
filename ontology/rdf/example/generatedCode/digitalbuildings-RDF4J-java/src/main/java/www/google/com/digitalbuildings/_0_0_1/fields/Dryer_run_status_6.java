...
public class Dryer_run_status_6 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDryer_run_status_6{

	IRI newInstance;
	public Dryer_run_status_6(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Dryer_run_status_6"));
	}
  ...
  public void addComposedOfStatus (IStatus parameter)
	...
	public static Set<IDryer_run_status_6> getAllDryer_run_status_6sObjectsCreated(){
		Set<IDryer_run_status_6> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Dryer_run_status_6")).subjects().stream()
		.map(mapper->(IDryer_run_status_6)mapper)
