...
/**
* Class Ch_ss_schwtc_chwswisovm 
* Simple water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_chwswisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICh_ss_schwtc_chwswisovm{

	IRI newInstance;
	public Ch_ss_schwtc_chwswisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwswisovm"));
	}
  ...
  public void addUsesRefrigerant_evaporator_saturation_temperature_sensor (IRefrigerant_evaporator_saturation_temperature_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_chwswisovm> getAllCh_ss_schwtc_chwswisovmsObjectsCreated(){
		Set<ICh_ss_schwtc_chwswisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwswisovm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_chwswisovm)mapper)
