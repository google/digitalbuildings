...
public class Cdws_swtc_wdpc_minfc_clpm extends www.google.com.digitalbuildings._0_0_1.hvac.Minfc implements ICdws_swtc_wdpc_minfc_clpm{

	IRI newInstance;
	public Cdws_swtc_wdpc_minfc_clpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cdws_swtc_wdpc_minfc_clpm"));
	}
  ...
  public void addUsesOptionalsHeating_percentage_command (IHeating_percentage_command parameter)
	...
	public static Set<ICdws_swtc_wdpc_minfc_clpm> getAllCdws_swtc_wdpc_minfc_clpmsObjectsCreated(){
		Set<ICdws_swtc_wdpc_minfc_clpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cdws_swtc_wdpc_minfc_clpm")).subjects().stream()
		.map(mapper->(ICdws_swtc_wdpc_minfc_clpm)mapper)
