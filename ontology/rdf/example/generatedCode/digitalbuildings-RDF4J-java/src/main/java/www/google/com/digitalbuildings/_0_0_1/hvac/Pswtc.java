...
public class Pswtc extends www.google.com.digitalbuildings._0_0_1.Operational implements IPswtc{

	IRI newInstance;
	public Pswtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Pswtc"));
	}
  ...
  public void addUsesOptionalsProcess_return_water_temperature_sensor (IProcess_return_water_temperature_sensor parameter)
	...
	public static Set<IPswtc> getAllPswtcsObjectsCreated(){
		Set<IPswtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Pswtc")).subjects().stream()
		.map(mapper->(IPswtc)mapper)
