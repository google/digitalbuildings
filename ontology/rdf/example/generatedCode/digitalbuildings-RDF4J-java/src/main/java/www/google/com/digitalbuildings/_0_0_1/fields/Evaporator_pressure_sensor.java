...
public class Evaporator_pressure_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IEvaporator_pressure_sensor{

	IRI newInstance;
	public Evaporator_pressure_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Evaporator_pressure_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IEvaporator_pressure_sensor> getAllEvaporator_pressure_sensorsObjectsCreated(){
		Set<IEvaporator_pressure_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Evaporator_pressure_sensor")).subjects().stream()
		.map(mapper->(IEvaporator_pressure_sensor)mapper)
