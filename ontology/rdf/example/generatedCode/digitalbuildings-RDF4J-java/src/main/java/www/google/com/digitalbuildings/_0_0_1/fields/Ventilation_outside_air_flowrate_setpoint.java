...
public class Ventilation_outside_air_flowrate_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IVentilation_outside_air_flowrate_setpoint{

	IRI newInstance;
	public Ventilation_outside_air_flowrate_setpoint(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Ventilation_outside_air_flowrate_setpoint"));
	}
  ...
  public void addComposedOfVentilation (IVentilation parameter)
	...
	public static Set<IVentilation_outside_air_flowrate_setpoint> getAllVentilation_outside_air_flowrate_setpointsObjectsCreated(){
		Set<IVentilation_outside_air_flowrate_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Ventilation_outside_air_flowrate_setpoint")).subjects().stream()
		.map(mapper->(IVentilation_outside_air_flowrate_setpoint)mapper)
