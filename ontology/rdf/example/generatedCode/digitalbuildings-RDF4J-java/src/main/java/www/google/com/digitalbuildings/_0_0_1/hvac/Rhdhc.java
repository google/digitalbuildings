...
/**
* Class Rhdhc 
* Return humidification/dehumidification control.
*/
@SuppressWarnings("serial")
public class Rhdhc extends www.google.com.digitalbuildings._0_0_1.Control implements IRhdhc{

	IRI newInstance;
	public Rhdhc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Rhdhc"));
	}
  ...
  public void addUsesHeater_run_command_3 (IHeater_run_command_3 parameter)
	...
	public static Set<IRhdhc> getAllRhdhcsObjectsCreated(){
		Set<IRhdhc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Rhdhc")).subjects().stream()
		.map(mapper->(IRhdhc)mapper)
