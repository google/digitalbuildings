...
public class Econmd extends www.google.com.digitalbuildings._0_0_1.Control implements IEconmd{

	IRI newInstance;
	public Econmd(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Econmd"));
	}
  ...
  public void addUsesOptionalsReturn_air_temperature_sensor (IReturn_air_temperature_sensor parameter)
	...
	public static Set<IEconmd> getAllEconmdsObjectsCreated(){
		Set<IEconmd> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Econmd")).subjects().stream()
		.map(mapper->(IEconmd)mapper)
