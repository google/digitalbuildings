...
/**
* Class Fcu_dfss_dfvsc_dsp_hwzc_chwzc 
* Hydronic variable speed fan coil with cooling and heating (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfvsc_dsp_hwzc_chwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_dfvsc_dsp_hwzc_chwzc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_dsp_hwzc_chwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_dsp_hwzc_chwzc"));
	}
  ...
  public void addUsesDischarge_fan_speed_mode (IDischarge_fan_speed_mode parameter)
	...
	public static Set<IFcu_dfss_dfvsc_dsp_hwzc_chwzc> getAllFcu_dfss_dfvsc_dsp_hwzc_chwzcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_dsp_hwzc_chwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_dsp_hwzc_chwzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_dsp_hwzc_chwzc)mapper)
