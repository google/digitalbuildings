...
/**
* Class Fan_ss_dsp_vsc 
* Fan with dual setpoint control and variable speed.
*/
@SuppressWarnings("serial")
public class Fan_ss_dsp_vsc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IFan_ss_dsp_vsc{

	IRI newInstance;
	public Fan_ss_dsp_vsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_dsp_vsc"));
	}
  ...
  public void addUsesHeater_run_command_3 (IHeater_run_command_3 parameter)
	...
	public static Set<IFan_ss_dsp_vsc> getAllFan_ss_dsp_vscsObjectsCreated(){
		Set<IFan_ss_dsp_vsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_dsp_vsc")).subjects().stream()
		.map(mapper->(IFan_ss_dsp_vsc)mapper)
