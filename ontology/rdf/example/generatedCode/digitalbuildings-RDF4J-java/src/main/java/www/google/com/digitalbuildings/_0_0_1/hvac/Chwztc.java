...
/**
* Class Chwztc 
* Chilled water valve monitoring on zone side (ZTC).
*/
@SuppressWarnings("serial")
public class Chwztc extends www.google.com.digitalbuildings._0_0_1.Control implements IChwztc{

	IRI newInstance;
	public Chwztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwztc"));
	}
  ...
  public void addUsesZone_air_temperature_setpoint (IZone_air_temperature_setpoint parameter)
	...
	public static Set<IChwztc> getAllChwztcsObjectsCreated(){
		Set<IChwztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwztc")).subjects().stream()
		.map(mapper->(IChwztc)mapper)
