...
public class Supply_fan_run_status_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_fan_run_status_1{

	IRI newInstance;
	public Supply_fan_run_status_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_fan_run_status_1"));
	}
  ...
  public void addComposedOfSupply (ISupply parameter)
	...
	public static Set<ISupply_fan_run_status_1> getAllSupply_fan_run_status_1sObjectsCreated(){
		Set<ISupply_fan_run_status_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_fan_run_status_1")).subjects().stream()
		.map(mapper->(ISupply_fan_run_status_1)mapper)
