...
/**
* Class Chws_swtc_wdpc_clpm_wfrc_bypvpm 
* Chilled water system with supply water temp, pressure, flow and bypass control.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc_clpm_wfrc_bypvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Wdpc implements IChws_swtc_wdpc_clpm_wfrc_bypvpm{

	IRI newInstance;
	public Chws_swtc_wdpc_clpm_wfrc_bypvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm_wfrc_bypvpm"));
	}
  ...
  public void addUsesOptionalsCompressor_speed_frequency_sensor (ICompressor_speed_frequency_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc_clpm_wfrc_bypvpm> getAllChws_swtc_wdpc_clpm_wfrc_bypvpmsObjectsCreated(){
		Set<IChws_swtc_wdpc_clpm_wfrc_bypvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm_wfrc_bypvpm")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc_clpm_wfrc_bypvpm)mapper)
