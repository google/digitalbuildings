...
/**
* Class Vav_sd_ztc_hwdc 
* Single duct reheat VAV with zone setpoint control.
*/
@SuppressWarnings("serial")
public class Vav_sd_ztc_hwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_ztc_hwdc{

	IRI newInstance;
	public Vav_sd_ztc_hwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_ztc_hwdc"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_ztc_hwdc> getAllVav_sd_ztc_hwdcsObjectsCreated(){
		Set<IVav_sd_ztc_hwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_ztc_hwdc")).subjects().stream()
		.map(mapper->(IVav_sd_ztc_hwdc)mapper)
