...
public class Dfhlc extends www.google.com.digitalbuildings._0_0_1.Remap_required implements IDfhlc{

	IRI newInstance;
	public Dfhlc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfhlc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IDfhlc> getAllDfhlcsObjectsCreated(){
		Set<IDfhlc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfhlc")).subjects().stream()
		.map(mapper->(IDfhlc)mapper)
