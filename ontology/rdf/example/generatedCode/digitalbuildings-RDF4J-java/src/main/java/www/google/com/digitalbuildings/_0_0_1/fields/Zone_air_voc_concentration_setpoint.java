...
import www.google.com.digitalbuildings._0_0_1.subfields.Voc;


@SuppressWarnings("serial")
public class Zone_air_voc_concentration_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_air_voc_concentration_setpoint{

	IRI newInstance;
	public Zone_air_voc_concentration_setpoint(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_voc_concentration_setpoint"));
	}
  ...
  public void addComposedOfVoc (IVoc parameter)
	...
	public Set<IVoc> getComposedOfVoc (){
		Set<IVoc> ComposedOfVoc = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Voc) {
				ComposedOfVoc.add((Voc)action);
			}
		});
		return ComposedOfVoc;
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_air_voc_concentration_setpoint> getAllZone_air_voc_concentration_setpointsObjectsCreated(){
		Set<IZone_air_voc_concentration_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_voc_concentration_setpoint")).subjects().stream()
		.map(mapper->(IZone_air_voc_concentration_setpoint)mapper)
