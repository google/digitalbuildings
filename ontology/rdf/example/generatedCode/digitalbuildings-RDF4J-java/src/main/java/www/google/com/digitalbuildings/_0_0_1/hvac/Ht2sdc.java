...
/**
* Class Ht2sdc 
* Two gas or electric heater control on supply side (dual setpoint).
*/
@SuppressWarnings("serial")
public class Ht2sdc extends www.google.com.digitalbuildings._0_0_1.Control implements IHt2sdc{

	IRI newInstance;
	public Ht2sdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2sdc"));
	}
  ...
  public void addUsesOptionalsHeating_thermal_power_capacity (IHeating_thermal_power_capacity parameter)
	...
	public static Set<IHt2sdc> getAllHt2sdcsObjectsCreated(){
		Set<IHt2sdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2sdc")).subjects().stream()
		.map(mapper->(IHt2sdc)mapper)
