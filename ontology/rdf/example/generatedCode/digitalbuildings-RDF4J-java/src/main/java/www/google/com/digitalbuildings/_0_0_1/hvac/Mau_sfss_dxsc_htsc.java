...
/**
* Class Mau_sfss_dxsc_htsc 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_dxsc_htsc extends www.google.com.digitalbuildings._0_0_1.hvac.Htsc implements IMau_sfss_dxsc_htsc{

	IRI newInstance;
	public Mau_sfss_dxsc_htsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_dxsc_htsc"));
	}
  ...
  public void addUsesMixed_air_temperature_sensor_2 (IMixed_air_temperature_sensor_2 parameter)
	...
	public static Set<IMau_sfss_dxsc_htsc> getAllMau_sfss_dxsc_htscsObjectsCreated(){
		Set<IMau_sfss_dxsc_htsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_dxsc_htsc")).subjects().stream()
		.map(mapper->(IMau_sfss_dxsc_htsc)mapper)
