...
public class Ahu_bpc_chwdc_dfss_dsp_econd_htdc_zspc extends www.google.com.digitalbuildings._0_0_1.hvac.Htdc implements IAhu_bpc_chwdc_dfss_dsp_econd_htdc_zspc{

	IRI newInstance;
	public Ahu_bpc_chwdc_dfss_dsp_econd_htdc_zspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bpc_chwdc_dfss_dsp_econd_htdc_zspc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_power_sensor (IDischarge_fan_power_sensor parameter)
	...
	public static Set<IAhu_bpc_chwdc_dfss_dsp_econd_htdc_zspc> getAllAhu_bpc_chwdc_dfss_dsp_econd_htdc_zspcsObjectsCreated(){
		Set<IAhu_bpc_chwdc_dfss_dsp_econd_htdc_zspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bpc_chwdc_dfss_dsp_econd_htdc_zspc")).subjects().stream()
		.map(mapper->(IAhu_bpc_chwdc_dfss_dsp_econd_htdc_zspc)mapper)
