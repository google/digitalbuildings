...
/**
* Class Dc_ss_swtc 
* Typical dry-cooler (closed loop sensible cooler).
*/
@SuppressWarnings("serial")
public class Dc_ss_swtc extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IDc_ss_swtc{

	IRI newInstance;
	public Dc_ss_swtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dc_ss_swtc"));
	}
  ...
  public void addUsesOptionalsSpeed_percentage_sensor (ISpeed_percentage_sensor parameter)
	...
	public static Set<IDc_ss_swtc> getAllDc_ss_swtcsObjectsCreated(){
		Set<IDc_ss_swtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dc_ss_swtc")).subjects().stream()
		.map(mapper->(IDc_ss_swtc)mapper)
