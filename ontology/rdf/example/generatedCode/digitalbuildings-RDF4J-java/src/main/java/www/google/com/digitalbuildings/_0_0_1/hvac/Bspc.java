...
public class Bspc extends www.google.com.digitalbuildings._0_0_1.Control implements IBspc{

	IRI newInstance;
	public Bspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Bspc"));
	}
  ...
  public void addUsesExhaust_fan_run_command (IExhaust_fan_run_command parameter)
	...
	public static Set<IBspc> getAllBspcsObjectsCreated(){
		Set<IBspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Bspc")).subjects().stream()
		.map(mapper->(IBspc)mapper)
