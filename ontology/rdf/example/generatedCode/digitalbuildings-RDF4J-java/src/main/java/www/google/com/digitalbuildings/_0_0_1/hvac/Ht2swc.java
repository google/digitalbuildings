...
public class Ht2swc extends www.google.com.digitalbuildings._0_0_1.Control implements IHt2swc{

	IRI newInstance;
	public Ht2swc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2swc"));
	}
  ...
  public void addUsesSupply_water_temperature_setpoint (ISupply_water_temperature_setpoint parameter)
	...
	public static Set<IHt2swc> getAllHt2swcsObjectsCreated(){
		Set<IHt2swc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2swc")).subjects().stream()
		.map(mapper->(IHt2swc)mapper)
