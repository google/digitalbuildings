...
/**
* Class Fcu_dfss_dfmsc_csp_dxzc 
* DX fan coil with multi-speed control (zone control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfmsc_csp_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxzc implements IFcu_dfss_dfmsc_csp_dxzc{

	IRI newInstance;
	public Fcu_dfss_dfmsc_csp_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfmsc_csp_dxzc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IFcu_dfss_dfmsc_csp_dxzc> getAllFcu_dfss_dfmsc_csp_dxzcsObjectsCreated(){
		Set<IFcu_dfss_dfmsc_csp_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfmsc_csp_dxzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfmsc_csp_dxzc)mapper)
