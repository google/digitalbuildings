...
/**
* Class Mau_sfss_htsc 
* Simple reheat make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_htsc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IMau_sfss_htsc{

	IRI newInstance;
	public Mau_sfss_htsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_htsc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IMau_sfss_htsc> getAllMau_sfss_htscsObjectsCreated(){
		Set<IMau_sfss_htsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_htsc")).subjects().stream()
		.map(mapper->(IMau_sfss_htsc)mapper)
