...
public class Supply_air_temperature_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_air_temperature_setpoint{
	...
	public Supply_air_temperature_setpoint(String namespace, String instanceId) {
		...
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_temperature_setpoint"));
	}
  ...
  public void addComposedOfTemperature (ITemperature parameter)
	...
	public static Set<ISupply_air_temperature_setpoint> getAllSupply_air_temperature_setpointsObjectsCreated(){
		Set<ISupply_air_temperature_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_temperature_setpoint")).subjects().stream()
		.map(mapper->(ISupply_air_temperature_setpoint)mapper)
