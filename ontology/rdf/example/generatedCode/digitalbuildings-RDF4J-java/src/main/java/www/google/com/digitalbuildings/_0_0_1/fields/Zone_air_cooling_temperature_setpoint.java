...
public class Zone_air_cooling_temperature_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_air_cooling_temperature_setpoint{

	IRI newInstance;
	public Zone_air_cooling_temperature_setpoint(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_cooling_temperature_setpoint"));
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_air_cooling_temperature_setpoint> getAllZone_air_cooling_temperature_setpointsObjectsCreated(){
		Set<IZone_air_cooling_temperature_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_cooling_temperature_setpoint")).subjects().stream()
		.map(mapper->(IZone_air_cooling_temperature_setpoint)mapper)
