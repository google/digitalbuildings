...
/**
* Class Fcu_dfss_dfmsc_dsp_dxzc 
* Multi-speed DX fan coil with zone temp control.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfmsc_dsp_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxzc implements IFcu_dfss_dfmsc_dsp_dxzc{

	IRI newInstance;
	public Fcu_dfss_dfmsc_dsp_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfmsc_dsp_dxzc"));
	}
  ...
  public void addUsesMedium_discharge_fan_speed_command (IMedium_discharge_fan_speed_command parameter)
	...
	public static Set<IFcu_dfss_dfmsc_dsp_dxzc> getAllFcu_dfss_dfmsc_dsp_dxzcsObjectsCreated(){
		Set<IFcu_dfss_dfmsc_dsp_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfmsc_dsp_dxzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfmsc_dsp_dxzc)mapper)
