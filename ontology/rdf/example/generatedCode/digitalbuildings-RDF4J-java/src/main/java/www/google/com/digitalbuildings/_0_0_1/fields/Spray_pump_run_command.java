...
public class Spray_pump_run_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISpray_pump_run_command{

	IRI newInstance;
	public Spray_pump_run_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Spray_pump_run_command"));
	}
  ...
  public void addComposedOfSpray (ISpray parameter)
	...
	public static Set<ISpray_pump_run_command> getAllSpray_pump_run_commandsObjectsCreated(){
		Set<ISpray_pump_run_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Spray_pump_run_command")).subjects().stream()
		.map(mapper->(ISpray_pump_run_command)mapper)
