...
public class Supply_fan_speed_frequency_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_fan_speed_frequency_sensor{

	IRI newInstance;
	public Supply_fan_speed_frequency_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_fan_speed_frequency_sensor"));
	}
  ...
  public void addComposedOfSupply (ISupply parameter)
	...
	public static Set<ISupply_fan_speed_frequency_sensor> getAllSupply_fan_speed_frequency_sensorsObjectsCreated(){
		Set<ISupply_fan_speed_frequency_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_fan_speed_frequency_sensor")).subjects().stream()
		.map(mapper->(ISupply_fan_speed_frequency_sensor)mapper)
