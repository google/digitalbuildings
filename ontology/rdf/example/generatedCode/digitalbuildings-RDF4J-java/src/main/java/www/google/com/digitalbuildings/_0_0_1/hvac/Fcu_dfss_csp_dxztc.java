...
/**
* Class Fcu_dfss_csp_dxztc 
* Typical DX FCU with cooling-only (zone control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_csp_dxztc extends www.google.com.digitalbuildings._0_0_1.hvac.Csp implements IFcu_dfss_csp_dxztc{

	IRI newInstance;
	public Fcu_dfss_csp_dxztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_csp_dxztc"));
	}
  ...
  public void addUsesDischarge_fan_run_status_2 (IDischarge_fan_run_status_2 parameter)
	...
	public static Set<IFcu_dfss_csp_dxztc> getAllFcu_dfss_csp_dxztcsObjectsCreated(){
		Set<IFcu_dfss_csp_dxztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_csp_dxztc")).subjects().stream()
		.map(mapper->(IFcu_dfss_csp_dxztc)mapper)
