...
/**
* Class Hx_cwdt_chwdt_cwrisovpm_chwbypvpm 
* Condenser/chilled water heat exchanger.
*/
@SuppressWarnings("serial")
public class Hx_cwdt_chwdt_cwrisovpm_chwbypvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Chwbypvpm implements IHx_cwdt_chwdt_cwrisovpm_chwbypvpm{

	IRI newInstance;
	public Hx_cwdt_chwdt_cwrisovpm_chwbypvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_cwdt_chwdt_cwrisovpm_chwbypvpm"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<IHx_cwdt_chwdt_cwrisovpm_chwbypvpm> getAllHx_cwdt_chwdt_cwrisovpm_chwbypvpmsObjectsCreated(){
		Set<IHx_cwdt_chwdt_cwrisovpm_chwbypvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_cwdt_chwdt_cwrisovpm_chwbypvpm")).subjects().stream()
		.map(mapper->(IHx_cwdt_chwdt_cwrisovpm_chwbypvpm)mapper)
