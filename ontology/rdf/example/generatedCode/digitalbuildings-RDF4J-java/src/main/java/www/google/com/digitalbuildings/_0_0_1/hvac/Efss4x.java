...
public class Efss4x extends www.google.com.digitalbuildings._0_0_1.Operational implements IEfss4x{

	IRI newInstance;
	public Efss4x(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Efss4x"));
	}
  ...
  public void addUsesExhaust_fan_run_status_4 (IExhaust_fan_run_status_4 parameter)
	...
	public static Set<IEfss4x> getAllEfss4xsObjectsCreated(){
		Set<IEfss4x> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Efss4x")).subjects().stream()
		.map(mapper->(IEfss4x)mapper)
