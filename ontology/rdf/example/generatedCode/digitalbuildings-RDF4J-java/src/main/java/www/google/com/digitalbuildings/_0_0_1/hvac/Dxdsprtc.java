...
public class Dxdsprtc extends www.google.com.digitalbuildings._0_0_1.Control implements IDxdsprtc{

	IRI newInstance;
	public Dxdsprtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dxdsprtc"));
	}
  ...
  public void addUsesReturn_air_temperature_sensor (IReturn_air_temperature_sensor parameter)
	...
	public static Set<IDxdsprtc> getAllDxdsprtcsObjectsCreated(){
		Set<IDxdsprtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dxdsprtc")).subjects().stream()
		.map(mapper->(IDxdsprtc)mapper)
