...
/**
* Class Fcu_dfss_dfhmlc_dsp_hwdc_chwdc 
* Multi-speed heat pump fan coil with zone temp control.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfhmlc_dsp_hwdc_chwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Chwdc implements IFcu_dfss_dfhmlc_dsp_hwdc_chwdc{

	IRI newInstance;
	public Fcu_dfss_dfhmlc_dsp_hwdc_chwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfhmlc_dsp_hwdc_chwdc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFcu_dfss_dfhmlc_dsp_hwdc_chwdc> getAllFcu_dfss_dfhmlc_dsp_hwdc_chwdcsObjectsCreated(){
		Set<IFcu_dfss_dfhmlc_dsp_hwdc_chwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfhmlc_dsp_hwdc_chwdc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfhmlc_dsp_hwdc_chwdc)mapper)
