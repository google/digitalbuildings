...
public class Fan_us_pao_hv5_1 extends www.google.com.digitalbuildings._0_0_1.hvac.Fan_ss_vsc_bspc implements IFan_us_pao_hv5_1{

	IRI newInstance;
	public Fan_us_pao_hv5_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_us_pao_hv5_1"));
	}
  ...
  public void addUsesExhaust_air_static_pressure_setpoint (IExhaust_air_static_pressure_setpoint parameter)
	...
	public static Set<IFan_us_pao_hv5_1> getAllFan_us_pao_hv5_1sObjectsCreated(){
		Set<IFan_us_pao_hv5_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_us_pao_hv5_1")).subjects().stream()
		.map(mapper->(IFan_us_pao_hv5_1)mapper)
