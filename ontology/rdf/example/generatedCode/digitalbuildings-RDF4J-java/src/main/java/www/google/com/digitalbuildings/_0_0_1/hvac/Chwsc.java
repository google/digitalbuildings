...
public class Chwsc extends www.google.com.digitalbuildings._0_0_1.Control implements IChwsc{

	IRI newInstance;
	public Chwsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwsc"));
	}
  ...
  public void addUsesSupply_air_temperature_setpoint (ISupply_air_temperature_setpoint parameter)
	...
	public static Set<IChwsc> getAllChwscsObjectsCreated(){
		Set<IChwsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwsc")).subjects().stream()
		.map(mapper->(IChwsc)mapper)
