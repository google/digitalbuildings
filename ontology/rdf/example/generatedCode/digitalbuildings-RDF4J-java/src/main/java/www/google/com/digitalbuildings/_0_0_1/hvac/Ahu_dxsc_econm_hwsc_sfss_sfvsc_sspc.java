...
/**
* Class Ahu_dxsc_econm_hwsc_sfss_sfvsc_sspc 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dxsc_econm_hwsc_sfss_sfvsc_sspc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxsc implements IAhu_dxsc_econm_hwsc_sfss_sfvsc_sspc{

	IRI newInstance;
	public Ahu_dxsc_econm_hwsc_sfss_sfvsc_sspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dxsc_econm_hwsc_sfss_sfvsc_sspc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dxsc_econm_hwsc_sfss_sfvsc_sspc> getAllAhu_dxsc_econm_hwsc_sfss_sfvsc_sspcsObjectsCreated(){
		Set<IAhu_dxsc_econm_hwsc_sfss_sfvsc_sspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dxsc_econm_hwsc_sfss_sfvsc_sspc")).subjects().stream()
		.map(mapper->(IAhu_dxsc_econm_hwsc_sfss_sfvsc_sspc)mapper)
