...
/**
* Class Vav_sd_dsp_hwdc_co2c 
* Single duct reheat VAV with CO2 and temp control.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_hwdc_co2c extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_dsp_hwdc_co2c{

	IRI newInstance;
	public Vav_sd_dsp_hwdc_co2c(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_co2c"));
	}
  ...
  public void addUsesOptionalsSupply_air_ventilation_flowrate_requirement (ISupply_air_ventilation_flowrate_requirement parameter)
	...
	public static Set<IVav_sd_dsp_hwdc_co2c> getAllVav_sd_dsp_hwdc_co2csObjectsCreated(){
		Set<IVav_sd_dsp_hwdc_co2c> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_co2c")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_hwdc_co2c)mapper)
