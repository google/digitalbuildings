...
/**
* Class Ahu_dxsc_econ_efss_sfss 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dxsc_econ_efss_sfss extends www.google.com.digitalbuildings._0_0_1.hvac.Efss implements IAhu_dxsc_econ_efss_sfss{

	IRI newInstance;
	public Ahu_dxsc_econ_efss_sfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dxsc_econ_efss_sfss"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dxsc_econ_efss_sfss> getAllAhu_dxsc_econ_efss_sfsssObjectsCreated(){
		Set<IAhu_dxsc_econ_efss_sfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dxsc_econ_efss_sfss")).subjects().stream()
		.map(mapper->(IAhu_dxsc_econ_efss_sfss)mapper)
