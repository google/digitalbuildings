...
/**
* Class Ct_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm 
* Variable speed supply temp controlling cooling tower.
*/
@SuppressWarnings("serial")
public class Ct_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements ICt_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm{

	IRI newInstance;
	public Ct_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm"));
	}
  ...
  public void addUsesMakeup_water_valve_percentage_command (IMakeup_water_valve_percentage_command parameter)
	...
	public static Set<ICt_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm> getAllCt_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpmsObjectsCreated(){
		Set<ICt_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm")).subjects().stream()
		.map(mapper->(ICt_ss_vsc_swtc_swisovpm_rwisovpm_swisovm_mwvpm)mapper)
