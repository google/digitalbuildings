...
/**
* Class Fcu_dfss_rtc_chwrc_rhc 
* Chilled water fan coil with return temp control.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_rtc_chwrc_rhc extends www.google.com.digitalbuildings._0_0_1.hvac.Rhc implements IFcu_dfss_rtc_chwrc_rhc{

	IRI newInstance;
	public Fcu_dfss_rtc_chwrc_rhc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_rtc_chwrc_rhc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_rtc_chwrc_rhc> getAllFcu_dfss_rtc_chwrc_rhcsObjectsCreated(){
		Set<IFcu_dfss_rtc_chwrc_rhc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_rtc_chwrc_rhc")).subjects().stream()
		.map(mapper->(IFcu_dfss_rtc_chwrc_rhc)mapper)
