...
/**
* Class Ch_ss_schwtc_chwrwisovm_cwsisovm 
* Two stage water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_chwrwisovm_cwsisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Schwtc implements ICh_ss_schwtc_chwrwisovm_cwsisovm{

	IRI newInstance;
	public Ch_ss_schwtc_chwrwisovm_cwsisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovm_cwsisovm"));
	}
  ...
  public void addUsesOptionalsRun_command (IRun_command parameter)
	...
	public static Set<ICh_ss_schwtc_chwrwisovm_cwsisovm> getAllCh_ss_schwtc_chwrwisovm_cwsisovmsObjectsCreated(){
		Set<ICh_ss_schwtc_chwrwisovm_cwsisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovm_cwsisovm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_chwrwisovm_cwsisovm)mapper)
