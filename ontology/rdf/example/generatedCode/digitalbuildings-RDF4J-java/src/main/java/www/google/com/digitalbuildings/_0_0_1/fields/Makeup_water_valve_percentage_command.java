...
import www.google.com.digitalbuildings._0_0_1.subfields.Makeup;
...
public class Makeup_water_valve_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IMakeup_water_valve_percentage_command{

	IRI newInstance;
	public Makeup_water_valve_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Makeup_water_valve_percentage_command"));
	}
  ...
  public void addComposedOfMakeup (IMakeup parameter)
	...
	public Set<IMakeup> getComposedOfMakeup (){
		Set<IMakeup> ComposedOfMakeup = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Makeup) {
				ComposedOfMakeup.add((Makeup)action);
			}
		});
		return ComposedOfMakeup;
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IMakeup_water_valve_percentage_command> getAllMakeup_water_valve_percentage_commandsObjectsCreated(){
		Set<IMakeup_water_valve_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Makeup_water_valve_percentage_command")).subjects().stream()
		.map(mapper->(IMakeup_water_valve_percentage_command)mapper)
