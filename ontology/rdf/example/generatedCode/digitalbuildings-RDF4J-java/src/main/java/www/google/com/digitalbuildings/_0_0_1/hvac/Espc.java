...
public class Espc extends www.google.com.digitalbuildings._0_0_1.Operational implements IEspc{

	IRI newInstance;
	public Espc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Espc"));
	}
  ...
  public void addUsesExhaust_fan_speed_percentage_command (IExhaust_fan_speed_percentage_command parameter)
	...
	public static Set<IEspc> getAllEspcsObjectsCreated(){
		Set<IEspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Espc")).subjects().stream()
		.map(mapper->(IEspc)mapper)
