...
/**
* Class Dfr_sfss_bypsspc_ht3sc_rtm 
* Three-stage gas/electric duct furnace.
*/
@SuppressWarnings("serial")
public class Dfr_sfss_bypsspc_ht3sc_rtm extends www.google.com.digitalbuildings._0_0_1.hvac.Bypsspc implements IDfr_sfss_bypsspc_ht3sc_rtm{

	IRI newInstance;
	public Dfr_sfss_bypsspc_ht3sc_rtm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfr_sfss_bypsspc_ht3sc_rtm"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IDfr_sfss_bypsspc_ht3sc_rtm> getAllDfr_sfss_bypsspc_ht3sc_rtmsObjectsCreated(){
		Set<IDfr_sfss_bypsspc_ht3sc_rtm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfr_sfss_bypsspc_ht3sc_rtm")).subjects().stream()
		.map(mapper->(IDfr_sfss_bypsspc_ht3sc_rtm)mapper)
