...
* Multi-zone AHU.
*/
public interface IAhu_bspc_chwsc_econ_efss_efvsc_moafc_sarc_sfss_sfvsc_sspc extends IEfvsc, ISspc, IAhu, IBspc, IEfss, IEcon, IMoafc, ISfss, ISfvsc, ISarc, IChwsc{
