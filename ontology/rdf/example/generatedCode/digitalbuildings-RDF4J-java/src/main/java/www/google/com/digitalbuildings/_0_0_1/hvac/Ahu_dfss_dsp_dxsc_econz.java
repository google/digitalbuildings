...
/**
* Class Ahu_dfss_dsp_dxsc_econz 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_dxsc_econz extends www.google.com.digitalbuildings._0_0_1.hvac.Dxsc implements IAhu_dfss_dsp_dxsc_econz{

	IRI newInstance;
	public Ahu_dfss_dsp_dxsc_econz(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxsc_econz"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dfss_dsp_dxsc_econz> getAllAhu_dfss_dsp_dxsc_econzsObjectsCreated(){
		Set<IAhu_dfss_dsp_dxsc_econz> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxsc_econz")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_dxsc_econz)mapper)
