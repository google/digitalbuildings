...
/**
* Class Ahu_csp_dfss_dxzc_econmd 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_csp_dfss_dxzc_econmd extends www.google.com.digitalbuildings._0_0_1.hvac.Csp implements IAhu_csp_dfss_dxzc_econmd{

	IRI newInstance;
	public Ahu_csp_dfss_dxzc_econmd(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_csp_dfss_dxzc_econmd"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_csp_dfss_dxzc_econmd> getAllAhu_csp_dfss_dxzc_econmdsObjectsCreated(){
		Set<IAhu_csp_dfss_dxzc_econmd> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_csp_dfss_dxzc_econmd")).subjects().stream()
		.map(mapper->(IAhu_csp_dfss_dxzc_econmd)mapper)
