...
/**
* Class Fcu_dfss_dfvsc_csp_chwzc 
* Hydronic variable speed fan coil with cooling (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfvsc_csp_chwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_dfvsc_csp_chwzc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_csp_chwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_csp_chwzc"));
	}
  ...
  public void addUsesMedium_discharge_fan_speed_command (IMedium_discharge_fan_speed_command parameter)
	...
	public static Set<IFcu_dfss_dfvsc_csp_chwzc> getAllFcu_dfss_dfvsc_csp_chwzcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_csp_chwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_csp_chwzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_csp_chwzc)mapper)
