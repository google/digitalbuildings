...
/**
* Class Fcu_dfss_csp_dxzc 
* Typical DX FCU with cooling-only (discharge control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_csp_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Csp implements IFcu_dfss_csp_dxzc{

	IRI newInstance;
	public Fcu_dfss_csp_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_csp_dxzc"));
	}
  ...
  public void addUsesOptionalsReturn_air_relative_humidity_sensor (IReturn_air_relative_humidity_sensor parameter)
	...
	public static Set<IFcu_dfss_csp_dxzc> getAllFcu_dfss_csp_dxzcsObjectsCreated(){
		Set<IFcu_dfss_csp_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_csp_dxzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_csp_dxzc)mapper)
