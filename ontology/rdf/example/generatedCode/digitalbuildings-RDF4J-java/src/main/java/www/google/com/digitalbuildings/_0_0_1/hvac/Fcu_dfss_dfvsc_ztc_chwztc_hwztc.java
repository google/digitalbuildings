...
/**
* Class Fcu_dfss_dfvsc_ztc_chwztc_hwztc 
* Hydronic varaible speed fan coil with cooling and heating (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfvsc_ztc_chwztc_hwztc extends www.google.com.digitalbuildings._0_0_1.hvac.Ztc implements IFcu_dfss_dfvsc_ztc_chwztc_hwztc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_ztc_chwztc_hwztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_ztc_chwztc_hwztc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_dfvsc_ztc_chwztc_hwztc> getAllFcu_dfss_dfvsc_ztc_chwztc_hwztcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_ztc_chwztc_hwztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_ztc_chwztc_hwztc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_ztc_chwztc_hwztc)mapper)
