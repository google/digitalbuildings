...
public class Discharge_air_flowrate_capacity extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDischarge_air_flowrate_capacity{

	IRI newInstance;
	public Discharge_air_flowrate_capacity(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_air_flowrate_capacity"));
	}
  ...
  public void addComposedOfFlowrate (IFlowrate parameter)
	...
	public static Set<IDischarge_air_flowrate_capacity> getAllDischarge_air_flowrate_capacitysObjectsCreated(){
		Set<IDischarge_air_flowrate_capacity> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_air_flowrate_capacity")).subjects().stream()
		.map(mapper->(IDischarge_air_flowrate_capacity)mapper)
