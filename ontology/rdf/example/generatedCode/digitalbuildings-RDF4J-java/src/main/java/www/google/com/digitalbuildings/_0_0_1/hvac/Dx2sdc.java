...
public class Dx2sdc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx2sdc{

	IRI newInstance;
	public Dx2sdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2sdc"));
	}
  ...
  public void addUsesOptionalsCooling_request_count (ICooling_request_count parameter)
	...
	public static Set<IDx2sdc> getAllDx2sdcsObjectsCreated(){
		Set<IDx2sdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2sdc")).subjects().stream()
		.map(mapper->(IDx2sdc)mapper)
