...
/**
* Class Fan_ss_vsc_coc 
* Variable speed ventilation fan (for carbon monoxide control).
*/
@SuppressWarnings("serial")
public class Fan_ss_vsc_coc extends www.google.com.digitalbuildings._0_0_1.hvac.Coc implements IFan_ss_vsc_coc{

	IRI newInstance;
	public Fan_ss_vsc_coc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_coc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFan_ss_vsc_coc> getAllFan_ss_vsc_cocsObjectsCreated(){
		Set<IFan_ss_vsc_coc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_coc")).subjects().stream()
		.map(mapper->(IFan_ss_vsc_coc)mapper)
