...
/**
* Class Ct_ss_vsc_swtc_bypvpm 
* Cooling tower with bypass.
*/
@SuppressWarnings("serial")
public class Ct_ss_vsc_swtc_bypvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICt_ss_vsc_swtc_bypvpm{

	IRI newInstance;
	public Ct_ss_vsc_swtc_bypvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_bypvpm"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<ICt_ss_vsc_swtc_bypvpm> getAllCt_ss_vsc_swtc_bypvpmsObjectsCreated(){
		Set<ICt_ss_vsc_swtc_bypvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_bypvpm")).subjects().stream()
		.map(mapper->(ICt_ss_vsc_swtc_bypvpm)mapper)
