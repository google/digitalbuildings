...
/**
* Class Stm 
* Basic supply temperature monitoring.
*/
@SuppressWarnings("serial")
public class Stm extends www.google.com.digitalbuildings._0_0_1.Monitoring implements IStm{

	IRI newInstance;
	public Stm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Stm"));
	}
  ...
  public void addUsesSupply_air_temperature_sensor (ISupply_air_temperature_sensor parameter)
	...
	public static Set<IStm> getAllStmsObjectsCreated(){
		Set<IStm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Stm")).subjects().stream()
		.map(mapper->(IStm)mapper)
