...
/**
* Class Ahu_dfss_dsp_econz_hpzc_htzc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_econz_hpzc_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IAhu_dfss_dsp_econz_hpzc_htzc{

	IRI newInstance;
	public Ahu_dfss_dsp_econz_hpzc_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_econz_hpzc_htzc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dfss_dsp_econz_hpzc_htzc> getAllAhu_dfss_dsp_econz_hpzc_htzcsObjectsCreated(){
		Set<IAhu_dfss_dsp_econz_hpzc_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_econz_hpzc_htzc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_econz_hpzc_htzc)mapper)
