...
public class Hwztc extends www.google.com.digitalbuildings._0_0_1.Control implements IHwztc{

	IRI newInstance;
	public Hwztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hwztc"));
	}
  ...
  public void addUsesZone_air_temperature_setpoint (IZone_air_temperature_setpoint parameter)
	...
	public static Set<IHwztc> getAllHwztcsObjectsCreated(){
		Set<IHwztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hwztc")).subjects().stream()
		.map(mapper->(IHwztc)mapper)
