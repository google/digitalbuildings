...
/**
* Class Dfr_sfss_sfvsc_bypsspc_htsc 
* VFD converted gas/electric duct furnace.
*/
@SuppressWarnings("serial")
public class Dfr_sfss_sfvsc_bypsspc_htsc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IDfr_sfss_sfvsc_bypsspc_htsc{

	IRI newInstance;
	public Dfr_sfss_sfvsc_bypsspc_htsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfr_sfss_sfvsc_bypsspc_htsc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IDfr_sfss_sfvsc_bypsspc_htsc> getAllDfr_sfss_sfvsc_bypsspc_htscsObjectsCreated(){
		Set<IDfr_sfss_sfvsc_bypsspc_htsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfr_sfss_sfvsc_bypsspc_htsc")).subjects().stream()
		.map(mapper->(IDfr_sfss_sfvsc_bypsspc_htsc)mapper)
