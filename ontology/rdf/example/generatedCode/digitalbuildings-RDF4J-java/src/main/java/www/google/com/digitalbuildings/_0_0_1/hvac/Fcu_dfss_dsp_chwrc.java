...
/**
* Class Fcu_dfss_dsp_chwrc 
* Chilled water FCU with return temp contol.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_chwrc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_dsp_chwrc{

	IRI newInstance;
	public Fcu_dfss_dsp_chwrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_chwrc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFcu_dfss_dsp_chwrc> getAllFcu_dfss_dsp_chwrcsObjectsCreated(){
		Set<IFcu_dfss_dsp_chwrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_chwrc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_chwrc)mapper)
