...
/**
* Class Mau_dfss_ztc_dx2ztc 
* Single zone cooling only (2 stage) make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_ztc_dx2ztc extends www.google.com.digitalbuildings._0_0_1.hvac.Ztc implements IMau_dfss_ztc_dx2ztc{

	IRI newInstance;
	public Mau_dfss_ztc_dx2ztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_ztc_dx2ztc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IMau_dfss_ztc_dx2ztc> getAllMau_dfss_ztc_dx2ztcsObjectsCreated(){
		Set<IMau_dfss_ztc_dx2ztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_ztc_dx2ztc")).subjects().stream()
		.map(mapper->(IMau_dfss_ztc_dx2ztc)mapper)
