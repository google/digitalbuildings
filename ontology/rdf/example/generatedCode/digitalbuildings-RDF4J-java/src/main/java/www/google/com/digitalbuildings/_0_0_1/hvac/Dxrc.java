...
/**
* Class Dxrc 
* Compressor run control on return air side (RC).
*/
@SuppressWarnings("serial")
public class Dxrc extends www.google.com.digitalbuildings._0_0_1.Control implements IDxrc{

	IRI newInstance;
	public Dxrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dxrc"));
	}
  ...
  public void addUsesReturn_air_temperature_setpoint (IReturn_air_temperature_setpoint parameter)
	...
	public static Set<IDxrc> getAllDxrcsObjectsCreated(){
		Set<IDxrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dxrc")).subjects().stream()
		.map(mapper->(IDxrc)mapper)
