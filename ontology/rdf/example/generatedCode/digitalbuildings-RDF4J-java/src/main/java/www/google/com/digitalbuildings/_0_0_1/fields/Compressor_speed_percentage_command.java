...
public class Compressor_speed_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICompressor_speed_percentage_command{

	IRI newInstance;
	public Compressor_speed_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_speed_percentage_command"));
	}
  ...
  public void addComposedOfSpeed (ISpeed parameter)
	...
	public static Set<ICompressor_speed_percentage_command> getAllCompressor_speed_percentage_commandsObjectsCreated(){
		Set<ICompressor_speed_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_speed_percentage_command")).subjects().stream()
		.map(mapper->(ICompressor_speed_percentage_command)mapper)
