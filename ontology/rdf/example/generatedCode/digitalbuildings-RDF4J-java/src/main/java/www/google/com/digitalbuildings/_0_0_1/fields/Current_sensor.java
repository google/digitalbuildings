...
public class Current_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICurrent_sensor{
	...
	public Current_sensor(String namespace, String instanceId) {
		...
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Current_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<ICurrent_sensor> getAllCurrent_sensorsObjectsCreated(){
		Set<ICurrent_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Current_sensor")).subjects().stream()
		.map(mapper->(ICurrent_sensor)mapper)
