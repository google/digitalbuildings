...
/**
* Class Ch_ss_swtc_dx4swc_swisovpm 
* Four stage air cooled cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_swtc_dx4swc_swisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Dx4swc implements ICh_ss_swtc_dx4swc_swisovpm{

	IRI newInstance;
	public Ch_ss_swtc_dx4swc_swisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc_dx4swc_swisovpm"));
	}
  ...
  public void addUsesSupply_water_isolation_valve_percentage_sensor (ISupply_water_isolation_valve_percentage_sensor parameter)
	...
	public static Set<ICh_ss_swtc_dx4swc_swisovpm> getAllCh_ss_swtc_dx4swc_swisovpmsObjectsCreated(){
		Set<ICh_ss_swtc_dx4swc_swisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc_dx4swc_swisovpm")).subjects().stream()
		.map(mapper->(ICh_ss_swtc_dx4swc_swisovpm)mapper)
