...
/**
* Class Ahu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc extends www.google.com.digitalbuildings._0_0_1.hvac.Bypsspc implements IAhu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc{

	IRI newInstance;
	public Ahu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc> getAllAhu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvscsObjectsCreated(){
		Set<IAhu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc")).subjects().stream()
		.map(mapper->(IAhu_bypsspc_dxsc_econ_efss_htsc_sfss_sfvsc)mapper)
