...
public class Chdxsc extends www.google.com.digitalbuildings._0_0_1.hvac.Functionality implements IChdxsc{

	IRI newInstance;
	public Chdxsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chdxsc"));
	}
  ...
  public void addUsesOptionalsCooling_percentage_command (ICooling_percentage_command parameter)
	...
	public static Set<IChdxsc> getAllChdxscsObjectsCreated(){
		Set<IChdxsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chdxsc")).subjects().stream()
		.map(mapper->(IChdxsc)mapper)
