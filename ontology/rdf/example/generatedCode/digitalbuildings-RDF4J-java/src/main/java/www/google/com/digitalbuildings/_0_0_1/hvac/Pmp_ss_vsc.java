...
/**
* Class Pmp_ss_vsc 
* Typical variable speed pump.
*/
@SuppressWarnings("serial")
public class Pmp_ss_vsc extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IPmp_ss_vsc{

	IRI newInstance;
	public Pmp_ss_vsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Pmp_ss_vsc"));
	}
  ...
  public void addUsesHeater_run_command_3 (IHeater_run_command_3 parameter)
	...
	public static Set<IPmp_ss_vsc> getAllPmp_ss_vscsObjectsCreated(){
		Set<IPmp_ss_vsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Pmp_ss_vsc")).subjects().stream()
		.map(mapper->(IPmp_ss_vsc)mapper)
