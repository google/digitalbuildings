...
/**
* Class Vav_sd_dsp_hwzc 
* Single duct reheat VAV with dual setpoint control.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_hwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_dsp_hwzc{

	IRI newInstance;
	public Vav_sd_dsp_hwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwzc"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_hwzc> getAllVav_sd_dsp_hwzcsObjectsCreated(){
		Set<IVav_sd_dsp_hwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwzc")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_hwzc)mapper)
