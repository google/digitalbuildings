...
/**
* Class Ahu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc extends www.google.com.digitalbuildings._0_0_1.hvac.Efvsc implements IAhu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc{

	IRI newInstance;
	public Ahu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc> getAllAhu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdcsObjectsCreated(){
		Set<IAhu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc")).subjects().stream()
		.map(mapper->(IAhu_bspc_dfss_dfvsc_dsp_dx3dc_econd_efss_efvsc_htdc)mapper)
