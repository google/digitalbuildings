...
/**
* Class Uh_ss_dsp_htzc 
* Electric/gas zone unit heater.
*/
@SuppressWarnings("serial")
public class Uh_ss_dsp_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IUh_ss_dsp_htzc{

	IRI newInstance;
	public Uh_ss_dsp_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Uh_ss_dsp_htzc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IUh_ss_dsp_htzc> getAllUh_ss_dsp_htzcsObjectsCreated(){
		Set<IUh_ss_dsp_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Uh_ss_dsp_htzc")).subjects().stream()
		.map(mapper->(IUh_ss_dsp_htzc)mapper)
