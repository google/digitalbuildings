...
import www.google.com.digitalbuildings._0_0_1.subfields.Bypass;
...
public class Chilled_water_bypass_valve_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IChilled_water_bypass_valve_percentage_command{

	IRI newInstance;
	public Chilled_water_bypass_valve_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Chilled_water_bypass_valve_percentage_command"));
	}
  ...
  public void addComposedOfBypass (IBypass parameter)
	...
	public Set<IBypass> getComposedOfBypass (){
		Set<IBypass> ComposedOfBypass = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Bypass) {
				ComposedOfBypass.add((Bypass)action);
			}
		});
		return ComposedOfBypass;
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IChilled_water_bypass_valve_percentage_command> getAllChilled_water_bypass_valve_percentage_commandsObjectsCreated(){
		Set<IChilled_water_bypass_valve_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Chilled_water_bypass_valve_percentage_command")).subjects().stream()
		.map(mapper->(IChilled_water_bypass_valve_percentage_command)mapper)
