...
/**
* Class Ahu_co2c_dfss_dsp_dx2dc_econd_htdc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_co2c_dfss_dsp_dx2dc_econd_htdc extends www.google.com.digitalbuildings._0_0_1.hvac.Econd implements IAhu_co2c_dfss_dsp_dx2dc_econd_htdc{

	IRI newInstance;
	public Ahu_co2c_dfss_dsp_dx2dc_econd_htdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2c_dfss_dsp_dx2dc_econd_htdc"));
	}
  ...
  public void addUsesOptionalsZone_air_deadband_temperature_setpoint (IZone_air_deadband_temperature_setpoint parameter)
	...
	public static Set<IAhu_co2c_dfss_dsp_dx2dc_econd_htdc> getAllAhu_co2c_dfss_dsp_dx2dc_econd_htdcsObjectsCreated(){
		Set<IAhu_co2c_dfss_dsp_dx2dc_econd_htdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2c_dfss_dsp_dx2dc_econd_htdc")).subjects().stream()
		.map(mapper->(IAhu_co2c_dfss_dsp_dx2dc_econd_htdc)mapper)
