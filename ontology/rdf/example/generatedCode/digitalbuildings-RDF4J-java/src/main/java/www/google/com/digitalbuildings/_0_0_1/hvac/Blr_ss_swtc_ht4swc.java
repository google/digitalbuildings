...
/**
* Class Blr_ss_swtc_ht4swc 
* Four-stage boiler with supply control.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_ht4swc extends www.google.com.digitalbuildings._0_0_1.hvac.Ht4swc implements IBlr_ss_swtc_ht4swc{

	IRI newInstance;
	public Blr_ss_swtc_ht4swc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_ht4swc"));
	}
  ...
  public void addUsesOptionalsRun_command (IRun_command parameter)
	...
	public static Set<IBlr_ss_swtc_ht4swc> getAllBlr_ss_swtc_ht4swcsObjectsCreated(){
		Set<IBlr_ss_swtc_ht4swc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_ht4swc")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_ht4swc)mapper)
