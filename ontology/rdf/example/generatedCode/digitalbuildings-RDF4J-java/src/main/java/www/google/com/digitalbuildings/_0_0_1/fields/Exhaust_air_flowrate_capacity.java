...
public class Exhaust_air_flowrate_capacity extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IExhaust_air_flowrate_capacity{

	IRI newInstance;
	public Exhaust_air_flowrate_capacity(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_flowrate_capacity"));
	}
  ...
  public void addComposedOfFlowrate (IFlowrate parameter)
	...
	public static Set<IExhaust_air_flowrate_capacity> getAllExhaust_air_flowrate_capacitysObjectsCreated(){
		Set<IExhaust_air_flowrate_capacity> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_flowrate_capacity")).subjects().stream()
		.map(mapper->(IExhaust_air_flowrate_capacity)mapper)
