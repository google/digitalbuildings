...
public class Mau_sfss_sfvsc_chwsc_hwsc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IMau_sfss_sfvsc_chwsc_hwsc{

	IRI newInstance;
	public Mau_sfss_sfvsc_chwsc_hwsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_chwsc_hwsc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IMau_sfss_sfvsc_chwsc_hwsc> getAllMau_sfss_sfvsc_chwsc_hwscsObjectsCreated(){
		Set<IMau_sfss_sfvsc_chwsc_hwsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_chwsc_hwsc")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_chwsc_hwsc)mapper)
