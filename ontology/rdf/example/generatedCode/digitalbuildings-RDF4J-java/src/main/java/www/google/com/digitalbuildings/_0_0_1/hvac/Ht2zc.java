...
public class Ht2zc extends www.google.com.digitalbuildings._0_0_1.Control implements IHt2zc{

	IRI newInstance;
	public Ht2zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2zc"));
	}
  ...
  public void addUsesBoost_fan_run_status (IBoost_fan_run_status parameter)
	...
	public static Set<IHt2zc> getAllHt2zcsObjectsCreated(){
		Set<IHt2zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2zc")).subjects().stream()
		.map(mapper->(IHt2zc)mapper)
