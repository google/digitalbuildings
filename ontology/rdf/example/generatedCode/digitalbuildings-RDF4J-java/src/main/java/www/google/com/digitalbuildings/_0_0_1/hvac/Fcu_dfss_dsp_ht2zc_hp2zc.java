...
/**
* Class Fcu_dfss_dsp_ht2zc_hp2zc 
* Heat pump fan coil with reheat (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_ht2zc_hp2zc extends www.google.com.digitalbuildings._0_0_1.hvac.Ht2zc implements IFcu_dfss_dsp_ht2zc_hp2zc{

	IRI newInstance;
	public Fcu_dfss_dsp_ht2zc_hp2zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_ht2zc_hp2zc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_dsp_ht2zc_hp2zc> getAllFcu_dfss_dsp_ht2zc_hp2zcsObjectsCreated(){
		Set<IFcu_dfss_dsp_ht2zc_hp2zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_ht2zc_hp2zc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_ht2zc_hp2zc)mapper)
