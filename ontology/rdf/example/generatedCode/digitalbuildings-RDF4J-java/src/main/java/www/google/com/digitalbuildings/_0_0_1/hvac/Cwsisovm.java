...
public class Cwsisovm extends www.google.com.digitalbuildings._0_0_1.Monitoring implements ICwsisovm{

	IRI newInstance;
	public Cwsisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cwsisovm"));
	}
  ...
  public void addUsesEvaporator_pressure_sensor (IEvaporator_pressure_sensor parameter)
	...
	public static Set<ICwsisovm> getAllCwsisovmsObjectsCreated(){
		Set<ICwsisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cwsisovm")).subjects().stream()
		.map(mapper->(ICwsisovm)mapper)
