...
/**
* Class Fan_ss_vsc 
* Fan with start/stop status and open-loop speed control.
*/
@SuppressWarnings("serial")
public class Fan_ss_vsc extends www.google.com.digitalbuildings._0_0_1.hvac.Vsc implements IFan_ss_vsc{

	IRI newInstance;
	public Fan_ss_vsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IFan_ss_vsc> getAllFan_ss_vscsObjectsCreated(){
		Set<IFan_ss_vsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc")).subjects().stream()
		.map(mapper->(IFan_ss_vsc)mapper)
