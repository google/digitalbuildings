...
/**
* Class Fcu_uk_lon_6ps_2 
* Non-standard type for 6PS
*/
@SuppressWarnings("serial")
public class Fcu_uk_lon_6ps_2 extends www.google.com.digitalbuildings._0_0_1.hvac.Fcu_dfss_dfvsc_ztc_chwztc_hwztc implements IFcu_uk_lon_6ps_2{

	IRI newInstance;
	public Fcu_uk_lon_6ps_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_uk_lon_6ps_2"));
	}
  ...
  public void addUsesThermal_power_sensor (IThermal_power_sensor parameter)
	...
	public static Set<IFcu_uk_lon_6ps_2> getAllFcu_uk_lon_6ps_2sObjectsCreated(){
		Set<IFcu_uk_lon_6ps_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_uk_lon_6ps_2")).subjects().stream()
		.map(mapper->(IFcu_uk_lon_6ps_2)mapper)
