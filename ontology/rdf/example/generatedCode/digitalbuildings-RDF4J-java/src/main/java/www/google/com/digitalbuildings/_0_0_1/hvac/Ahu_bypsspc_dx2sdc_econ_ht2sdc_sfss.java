...
/**
* Class Ahu_bypsspc_dx2sdc_econ_ht2sdc_sfss 
* Multi zone AHU with bypass static control.
*/
@SuppressWarnings("serial")
public class Ahu_bypsspc_dx2sdc_econ_ht2sdc_sfss extends www.google.com.digitalbuildings._0_0_1.hvac.Econ implements IAhu_bypsspc_dx2sdc_econ_ht2sdc_sfss{

	IRI newInstance;
	public Ahu_bypsspc_dx2sdc_econ_ht2sdc_sfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dx2sdc_econ_ht2sdc_sfss"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_bypsspc_dx2sdc_econ_ht2sdc_sfss> getAllAhu_bypsspc_dx2sdc_econ_ht2sdc_sfsssObjectsCreated(){
		Set<IAhu_bypsspc_dx2sdc_econ_ht2sdc_sfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dx2sdc_econ_ht2sdc_sfss")).subjects().stream()
		.map(mapper->(IAhu_bypsspc_dx2sdc_econ_ht2sdc_sfss)mapper)
