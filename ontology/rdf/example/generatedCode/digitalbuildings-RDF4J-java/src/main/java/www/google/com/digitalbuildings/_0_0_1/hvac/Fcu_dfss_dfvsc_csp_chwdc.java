...
/**
* Class Fcu_dfss_dfvsc_csp_chwdc 
* Hydronic variable speed fan coil with cooling (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfvsc_csp_chwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfvsc implements IFcu_dfss_dfvsc_csp_chwdc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_csp_chwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_csp_chwdc"));
	}
  ...
  public void addUsesMedium_discharge_fan_speed_command (IMedium_discharge_fan_speed_command parameter)
	...
	public static Set<IFcu_dfss_dfvsc_csp_chwdc> getAllFcu_dfss_dfvsc_csp_chwdcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_csp_chwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_csp_chwdc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_csp_chwdc)mapper)
