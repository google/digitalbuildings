...
/**
* Class Ahu_co2c_dfss_dsp_dxzc_econz_htzc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_co2c_dfss_dsp_dxzc_econz_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IAhu_co2c_dfss_dsp_dxzc_econz_htzc{

	IRI newInstance;
	public Ahu_co2c_dfss_dsp_dxzc_econz_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2c_dfss_dsp_dxzc_econz_htzc"));
	}
  ...
  public void addUsesOptionalsZone_air_deadband_temperature_setpoint (IZone_air_deadband_temperature_setpoint parameter)
	...
	public static Set<IAhu_co2c_dfss_dsp_dxzc_econz_htzc> getAllAhu_co2c_dfss_dsp_dxzc_econz_htzcsObjectsCreated(){
		Set<IAhu_co2c_dfss_dsp_dxzc_econz_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2c_dfss_dsp_dxzc_econz_htzc")).subjects().stream()
		.map(mapper->(IAhu_co2c_dfss_dsp_dxzc_econz_htzc)mapper)
