...
/**
* Class Ahu_csp_dfss_dxzc 
* Single zone AHU (cooling only).
*/
@SuppressWarnings("serial")
public class Ahu_csp_dfss_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IAhu_csp_dfss_dxzc{

	IRI newInstance;
	public Ahu_csp_dfss_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_csp_dfss_dxzc"));
	}
  ...
  public void addUsesHeater_run_command_2 (IHeater_run_command_2 parameter)
	...
	public static Set<IAhu_csp_dfss_dxzc> getAllAhu_csp_dfss_dxzcsObjectsCreated(){
		Set<IAhu_csp_dfss_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_csp_dfss_dxzc")).subjects().stream()
		.map(mapper->(IAhu_csp_dfss_dxzc)mapper)
