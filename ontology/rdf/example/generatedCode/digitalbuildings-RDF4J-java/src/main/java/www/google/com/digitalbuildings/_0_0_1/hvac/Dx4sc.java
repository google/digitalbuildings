...
public class Dx4sc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx4sc{

	IRI newInstance;
	public Dx4sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx4sc"));
	}
  ...
  public void addUsesSupply_air_temperature_setpoint (ISupply_air_temperature_setpoint parameter)
	...
	public static Set<IDx4sc> getAllDx4scsObjectsCreated(){
		Set<IDx4sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx4sc")).subjects().stream()
		.map(mapper->(IDx4sc)mapper)
