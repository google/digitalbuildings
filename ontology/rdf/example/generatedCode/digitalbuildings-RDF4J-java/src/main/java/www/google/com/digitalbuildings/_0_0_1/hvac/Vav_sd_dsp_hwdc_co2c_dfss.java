...
/**
* Class Vav_sd_dsp_hwdc_co2c_dfss 
* Single duct fan powered VAV with reheat and CO2 control.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_hwdc_co2c_dfss extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_dsp_hwdc_co2c_dfss{

	IRI newInstance;
	public Vav_sd_dsp_hwdc_co2c_dfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_co2c_dfss"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_hwdc_co2c_dfss> getAllVav_sd_dsp_hwdc_co2c_dfsssObjectsCreated(){
		Set<IVav_sd_dsp_hwdc_co2c_dfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_co2c_dfss")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_hwdc_co2c_dfss)mapper)
