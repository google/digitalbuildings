...
/**
* Class Ahu_csp_dfss_dx2sc_econz 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_csp_dfss_dx2sc_econz extends www.google.com.digitalbuildings._0_0_1.hvac.Econz implements IAhu_csp_dfss_dx2sc_econz{

	IRI newInstance;
	public Ahu_csp_dfss_dx2sc_econz(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_csp_dfss_dx2sc_econz"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_csp_dfss_dx2sc_econz> getAllAhu_csp_dfss_dx2sc_econzsObjectsCreated(){
		Set<IAhu_csp_dfss_dx2sc_econz> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_csp_dfss_dx2sc_econz")).subjects().stream()
		.map(mapper->(IAhu_csp_dfss_dx2sc_econz)mapper)
