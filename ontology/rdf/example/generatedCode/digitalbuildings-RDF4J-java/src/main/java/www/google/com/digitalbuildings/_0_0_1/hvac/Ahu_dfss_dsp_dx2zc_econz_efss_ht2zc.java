...
/**
* Class Ahu_dfss_dsp_dx2zc_econz_efss_ht2zc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_dx2zc_econz_efss_ht2zc extends www.google.com.digitalbuildings._0_0_1.hvac.Ht2zc implements IAhu_dfss_dsp_dx2zc_econz_efss_ht2zc{

	IRI newInstance;
	public Ahu_dfss_dsp_dx2zc_econz_efss_ht2zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dx2zc_econz_efss_ht2zc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dfss_dsp_dx2zc_econz_efss_ht2zc> getAllAhu_dfss_dsp_dx2zc_econz_efss_ht2zcsObjectsCreated(){
		Set<IAhu_dfss_dsp_dx2zc_econz_efss_ht2zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dx2zc_econz_efss_ht2zc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_dx2zc_econz_efss_ht2zc)mapper)
