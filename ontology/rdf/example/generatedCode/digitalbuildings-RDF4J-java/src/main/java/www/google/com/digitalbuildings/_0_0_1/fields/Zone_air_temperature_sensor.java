...
public class Zone_air_temperature_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_air_temperature_sensor{
	...
	public Zone_air_temperature_sensor(String namespace, String instanceId) {
		...
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_temperature_sensor"));
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_air_temperature_sensor> getAllZone_air_temperature_sensorsObjectsCreated(){
		Set<IZone_air_temperature_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_temperature_sensor")).subjects().stream()
		.map(mapper->(IZone_air_temperature_sensor)mapper)
