...
/**
* Class Fcu_df2xss_dsp_dxzc 
* Two-fan DX fan coil with zone temp control.
*/
@SuppressWarnings("serial")
public class Fcu_df2xss_dsp_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IFcu_df2xss_dsp_dxzc{

	IRI newInstance;
	public Fcu_df2xss_dsp_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_df2xss_dsp_dxzc"));
	}
  ...
  public void addUsesOptionalsReturn_air_relative_humidity_sensor (IReturn_air_relative_humidity_sensor parameter)
	...
	public static Set<IFcu_df2xss_dsp_dxzc> getAllFcu_df2xss_dsp_dxzcsObjectsCreated(){
		Set<IFcu_df2xss_dsp_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_df2xss_dsp_dxzc")).subjects().stream()
		.map(mapper->(IFcu_df2xss_dsp_dxzc)mapper)
