...
import www.google.com.digitalbuildings._0_0_1.subfields.Limit;


@SuppressWarnings("serial")
public class Low_limit_flowrate_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ILow_limit_flowrate_setpoint{

	IRI newInstance;
	public Low_limit_flowrate_setpoint(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Low_limit_flowrate_setpoint"));
	}
  ...
  public void addComposedOfLimit (ILimit parameter)
	...
	public Set<ILimit> getComposedOfLimit (){
		Set<ILimit> ComposedOfLimit = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Limit) {
				ComposedOfLimit.add((Limit)action);
			}
		});
		return ComposedOfLimit;
	}
  ...
  public void addComposedOfSetpoint (ISetpoint parameter)
	...
	public static Set<ILow_limit_flowrate_setpoint> getAllLow_limit_flowrate_setpointsObjectsCreated(){
		Set<ILow_limit_flowrate_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Low_limit_flowrate_setpoint")).subjects().stream()
		.map(mapper->(ILow_limit_flowrate_setpoint)mapper)
