...
/**
* Class Blr_ss_swtc_htswc_rwisovm 
* Boiler with single stage heat and return isolation.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_htswc_rwisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IBlr_ss_swtc_htswc_rwisovm{

	IRI newInstance;
	public Blr_ss_swtc_htswc_rwisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_htswc_rwisovm"));
	}
  ...
  public void addUsesReturn_water_isolation_valve_status (IReturn_water_isolation_valve_status parameter)
	...
	public static Set<IBlr_ss_swtc_htswc_rwisovm> getAllBlr_ss_swtc_htswc_rwisovmsObjectsCreated(){
		Set<IBlr_ss_swtc_htswc_rwisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_htswc_rwisovm")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_htswc_rwisovm)mapper)
