...
public class Discharge_air_temperature_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDischarge_air_temperature_sensor{
	...
	public Discharge_air_temperature_sensor(String namespace, String instanceId) {
		...
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_air_temperature_sensor"));
	}
  ...
  public void addComposedOfTemperature (ITemperature parameter)
	...
	public static Set<IDischarge_air_temperature_sensor> getAllDischarge_air_temperature_sensorsObjectsCreated(){
		Set<IDischarge_air_temperature_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_air_temperature_sensor")).subjects().stream()
		.map(mapper->(IDischarge_air_temperature_sensor)mapper)
