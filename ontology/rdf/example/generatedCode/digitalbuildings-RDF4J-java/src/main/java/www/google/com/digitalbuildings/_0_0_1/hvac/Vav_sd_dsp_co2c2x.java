...
/**
* Class Vav_sd_dsp_co2c2x 
* Single duct VAV with two-zone CO2 control.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_co2c2x extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IVav_sd_dsp_co2c2x{

	IRI newInstance;
	public Vav_sd_dsp_co2c2x(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_co2c2x"));
	}
  ...
  public void addUsesOptionalsSupply_air_ventilation_flowrate_requirement (ISupply_air_ventilation_flowrate_requirement parameter)
	...
	public static Set<IVav_sd_dsp_co2c2x> getAllVav_sd_dsp_co2c2xsObjectsCreated(){
		Set<IVav_sd_dsp_co2c2x> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_co2c2x")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_co2c2x)mapper)
