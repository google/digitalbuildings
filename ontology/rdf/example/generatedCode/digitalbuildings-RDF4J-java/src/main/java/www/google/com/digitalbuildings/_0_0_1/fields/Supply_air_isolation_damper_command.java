...
public class Supply_air_isolation_damper_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_air_isolation_damper_command{

	IRI newInstance;
	public Supply_air_isolation_damper_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_isolation_damper_command"));
	}
  ...
  public void addComposedOfSupply (ISupply parameter)
	...
	public static Set<ISupply_air_isolation_damper_command> getAllSupply_air_isolation_damper_commandsObjectsCreated(){
		Set<ISupply_air_isolation_damper_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_isolation_damper_command")).subjects().stream()
		.map(mapper->(ISupply_air_isolation_damper_command)mapper)
