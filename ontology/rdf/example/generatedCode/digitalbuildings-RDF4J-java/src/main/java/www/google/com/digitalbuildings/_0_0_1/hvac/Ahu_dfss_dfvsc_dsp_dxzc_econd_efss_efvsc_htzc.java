...
/**
* Class Ahu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Htzc implements IAhu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc{

	IRI newInstance;
	public Ahu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc"));
	}
  ...
  public void addUsesOptionalsCooling_request_count (ICooling_request_count parameter)
	...
	public static Set<IAhu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc> getAllAhu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzcsObjectsCreated(){
		Set<IAhu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dfvsc_dsp_dxzc_econd_efss_efvsc_htzc)mapper)
