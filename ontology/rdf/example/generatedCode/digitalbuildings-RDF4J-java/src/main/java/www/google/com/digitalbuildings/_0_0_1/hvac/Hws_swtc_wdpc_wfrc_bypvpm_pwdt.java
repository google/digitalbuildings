...
import www.google.com.digitalbuildings._0_0_1.fields.Primary_return_water_temperature_sensor;
...
import www.google.com.digitalbuildings._0_0_1.fields.Primary_supply_water_temperature_sensor;
...
/**
* Class Hws_swtc_wdpc_wfrc_bypvpm_pwdt 
* Primary secondary heating water system with operable decoupler.
*/
@SuppressWarnings("serial")
public class Hws_swtc_wdpc_wfrc_bypvpm_pwdt extends www.google.com.digitalbuildings._0_0_1.hvac.Bypvpm implements IHws_swtc_wdpc_wfrc_bypvpm_pwdt{

	IRI newInstance;
	public Hws_swtc_wdpc_wfrc_bypvpm_pwdt(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_wfrc_bypvpm_pwdt"));
	}
  ...
  public void addUsesPrimary_return_water_temperature_sensor (IPrimary_return_water_temperature_sensor parameter)
	...
	public Set<IPrimary_return_water_temperature_sensor> getUsesPrimary_return_water_temperature_sensor (){
		Set<IPrimary_return_water_temperature_sensor> UsesPrimary_return_water_temperature_sensor = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), null)
		.objects().forEach(action->{
			if(action instanceof Primary_return_water_temperature_sensor) {
				UsesPrimary_return_water_temperature_sensor.add((Primary_return_water_temperature_sensor)action);
			}
		});
		return UsesPrimary_return_water_temperature_sensor;
	}
  ...
  public void addUsesPrimary_supply_water_temperature_sensor (IPrimary_supply_water_temperature_sensor parameter)
	...
	public Set<IPrimary_supply_water_temperature_sensor> getUsesPrimary_supply_water_temperature_sensor (){
		Set<IPrimary_supply_water_temperature_sensor> UsesPrimary_supply_water_temperature_sensor = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), null)
		.objects().forEach(action->{
			if(action instanceof Primary_supply_water_temperature_sensor) {
				UsesPrimary_supply_water_temperature_sensor.add((Primary_supply_water_temperature_sensor)action);
			}
		});
		return UsesPrimary_supply_water_temperature_sensor;
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IHws_swtc_wdpc_wfrc_bypvpm_pwdt> getAllHws_swtc_wdpc_wfrc_bypvpm_pwdtsObjectsCreated(){
		Set<IHws_swtc_wdpc_wfrc_bypvpm_pwdt> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_wfrc_bypvpm_pwdt")).subjects().stream()
		.map(mapper->(IHws_swtc_wdpc_wfrc_bypvpm_pwdt)mapper)
