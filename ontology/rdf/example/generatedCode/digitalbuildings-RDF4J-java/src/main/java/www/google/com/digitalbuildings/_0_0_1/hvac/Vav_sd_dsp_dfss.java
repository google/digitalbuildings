...
/**
* Class Vav_sd_dsp_dfss 
* Fan powered VAV.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_dfss extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_dsp_dfss{

	IRI newInstance;
	public Vav_sd_dsp_dfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_dfss"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IVav_sd_dsp_dfss> getAllVav_sd_dsp_dfsssObjectsCreated(){
		Set<IVav_sd_dsp_dfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_dfss")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_dfss)mapper)
