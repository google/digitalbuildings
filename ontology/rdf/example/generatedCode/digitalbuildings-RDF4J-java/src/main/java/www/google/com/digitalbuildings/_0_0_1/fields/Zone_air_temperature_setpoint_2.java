...
public class Zone_air_temperature_setpoint_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_air_temperature_setpoint_2{

	IRI newInstance;
	public Zone_air_temperature_setpoint_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_temperature_setpoint_2"));
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_air_temperature_setpoint_2> getAllZone_air_temperature_setpoint_2sObjectsCreated(){
		Set<IZone_air_temperature_setpoint_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_temperature_setpoint_2")).subjects().stream()
		.map(mapper->(IZone_air_temperature_setpoint_2)mapper)
