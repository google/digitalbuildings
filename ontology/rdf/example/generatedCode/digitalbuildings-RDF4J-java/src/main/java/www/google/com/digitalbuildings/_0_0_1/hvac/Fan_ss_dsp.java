...
/**
* Class Fan_ss_dsp 
* Fan with dual setpoint control.
*/
@SuppressWarnings("serial")
public class Fan_ss_dsp extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IFan_ss_dsp{

	IRI newInstance;
	public Fan_ss_dsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_dsp"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IFan_ss_dsp> getAllFan_ss_dspsObjectsCreated(){
		Set<IFan_ss_dsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_dsp")).subjects().stream()
		.map(mapper->(IFan_ss_dsp)mapper)
