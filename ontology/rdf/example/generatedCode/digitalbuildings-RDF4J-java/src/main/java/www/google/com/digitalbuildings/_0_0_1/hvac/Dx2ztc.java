...
/**
* Class Dx2ztc 
* Compressor run control on zone side (ZTC).
*/
@SuppressWarnings("serial")
public class Dx2ztc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx2ztc{

	IRI newInstance;
	public Dx2ztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2ztc"));
	}
  ...
  public void addUsesOptionalsLeaving_cooling_coil_temperature_sensor (ILeaving_cooling_coil_temperature_sensor parameter)
	...
	public static Set<IDx2ztc> getAllDx2ztcsObjectsCreated(){
		Set<IDx2ztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2ztc")).subjects().stream()
		.map(mapper->(IDx2ztc)mapper)
