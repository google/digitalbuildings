...
/**
* Class Hpztc 
* Zone temp heat pump control (ZTC).
*/
@SuppressWarnings("serial")
public class Hpztc extends www.google.com.digitalbuildings._0_0_1.Control implements IHpztc{

	IRI newInstance;
	public Hpztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hpztc"));
	}
  ...
  public void addUsesZone_air_temperature_setpoint (IZone_air_temperature_setpoint parameter)
	...
	public static Set<IHpztc> getAllHpztcsObjectsCreated(){
		Set<IHpztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hpztc")).subjects().stream()
		.map(mapper->(IHpztc)mapper)
