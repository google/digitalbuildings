...
/**
* Class Ahu_dfss_dxrc_rhdhc 
* Single zone AHU with humidity control.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dxrc_rhdhc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxrc implements IAhu_dfss_dxrc_rhdhc{

	IRI newInstance;
	public Ahu_dfss_dxrc_rhdhc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxrc_rhdhc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IAhu_dfss_dxrc_rhdhc> getAllAhu_dfss_dxrc_rhdhcsObjectsCreated(){
		Set<IAhu_dfss_dxrc_rhdhc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxrc_rhdhc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dxrc_rhdhc)mapper)
