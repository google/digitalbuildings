...
/**
* Class Ahu_dfss_dxzc_econd_zhm 
* Single-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dxzc_econd_zhm extends www.google.com.digitalbuildings._0_0_1.hvac.Econd implements IAhu_dfss_dxzc_econd_zhm{

	IRI newInstance;
	public Ahu_dfss_dxzc_econd_zhm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxzc_econd_zhm"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dfss_dxzc_econd_zhm> getAllAhu_dfss_dxzc_econd_zhmsObjectsCreated(){
		Set<IAhu_dfss_dxzc_econd_zhm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxzc_econd_zhm")).subjects().stream()
		.map(mapper->(IAhu_dfss_dxzc_econd_zhm)mapper)
