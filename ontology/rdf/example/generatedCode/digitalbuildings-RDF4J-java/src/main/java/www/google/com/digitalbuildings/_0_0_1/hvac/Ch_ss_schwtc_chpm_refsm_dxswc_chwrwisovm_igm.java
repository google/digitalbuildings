...
/**
* Class Ch_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm 
* Water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm extends www.google.com.digitalbuildings._0_0_1.hvac.Refsm implements ICh_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm{

	IRI newInstance;
	public Ch_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm"));
	}
  ...
  public void addUsesInlet_guidevane_percentage_sensor (IInlet_guidevane_percentage_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm> getAllCh_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igmsObjectsCreated(){
		Set<ICh_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_chpm_refsm_dxswc_chwrwisovm_igm)mapper)
