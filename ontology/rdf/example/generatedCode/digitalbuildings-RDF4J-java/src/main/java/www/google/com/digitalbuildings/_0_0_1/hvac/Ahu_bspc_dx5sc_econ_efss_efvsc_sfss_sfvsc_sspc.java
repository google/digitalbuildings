...
import www.google.com.digitalbuildings._0_0_1.fields.ICompressor_run_command_5;
import www.google.com.digitalbuildings._0_0_1.fields.Compressor_run_command_5;
...
import www.google.com.digitalbuildings._0_0_1.fields.ICompressor_run_status_5;
import www.google.com.digitalbuildings._0_0_1.fields.Compressor_run_status_5;
...
/**
* Class Ahu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfvsc implements IAhu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc{

	IRI newInstance;
	public Ahu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc"));
	}
  ...
  public void addUsesCompressor_run_command_5 (ICompressor_run_command_5 parameter)
	{
		GLOBAL.model.add(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), parameter);
	}

	public Set<ICompressor_run_command_5> getUsesCompressor_run_command_5 (){
		Set<ICompressor_run_command_5> UsesCompressor_run_command_5 = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), null)
		.objects().forEach(action->{
			if(action instanceof Compressor_run_command_5) {
				UsesCompressor_run_command_5.add((Compressor_run_command_5)action);
			}
		});
		return UsesCompressor_run_command_5;
	}
  ...
  public void addUsesCompressor_run_status_5 (ICompressor_run_status_5 parameter)
	{
		GLOBAL.model.add(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), parameter);
	}

	public Set<ICompressor_run_status_5> getUsesCompressor_run_status_5 (){
		Set<ICompressor_run_status_5> UsesCompressor_run_status_5 = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), null)
		.objects().forEach(action->{
			if(action instanceof Compressor_run_status_5) {
				UsesCompressor_run_status_5.add((Compressor_run_status_5)action);
			}
		});
		return UsesCompressor_run_status_5;
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc> getAllAhu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspcsObjectsCreated(){
		Set<IAhu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc")).subjects().stream()
		.map(mapper->(IAhu_bspc_dx5sc_econ_efss_efvsc_sfss_sfvsc_sspc)mapper)
