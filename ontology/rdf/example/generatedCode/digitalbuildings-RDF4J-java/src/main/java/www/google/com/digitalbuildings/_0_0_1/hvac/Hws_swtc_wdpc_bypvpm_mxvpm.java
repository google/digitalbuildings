...
public class Hws_swtc_wdpc_bypvpm_mxvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IHws_swtc_wdpc_bypvpm_mxvpm{

	IRI newInstance;
	public Hws_swtc_wdpc_bypvpm_mxvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_bypvpm_mxvpm"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IHws_swtc_wdpc_bypvpm_mxvpm> getAllHws_swtc_wdpc_bypvpm_mxvpmsObjectsCreated(){
		Set<IHws_swtc_wdpc_bypvpm_mxvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_bypvpm_mxvpm")).subjects().stream()
		.map(mapper->(IHws_swtc_wdpc_bypvpm_mxvpm)mapper)
