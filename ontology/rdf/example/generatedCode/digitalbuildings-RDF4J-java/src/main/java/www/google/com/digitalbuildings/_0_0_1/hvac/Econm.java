...
public class Econm extends www.google.com.digitalbuildings._0_0_1.Control implements IEconm{

	IRI newInstance;
	public Econm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Econm"));
	}
  ...
  public void addUsesOptionalsExhaust_fan_speed_percentage_sensor_4 (IExhaust_fan_speed_percentage_sensor_4 parameter)
	...
	public static Set<IEconm> getAllEconmsObjectsCreated(){
		Set<IEconm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Econm")).subjects().stream()
		.map(mapper->(IEconm)mapper)
