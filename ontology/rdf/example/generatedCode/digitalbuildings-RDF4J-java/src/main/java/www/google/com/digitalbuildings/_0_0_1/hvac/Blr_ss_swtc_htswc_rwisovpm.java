...
/**
* Class Blr_ss_swtc_htswc_rwisovpm 
* Boiler with single stage heat and return isolation.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_htswc_rwisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IBlr_ss_swtc_htswc_rwisovpm{

	IRI newInstance;
	public Blr_ss_swtc_htswc_rwisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_htswc_rwisovpm"));
	}
  ...
  public void addUsesOptionalsPowerfactor_sensor (IPowerfactor_sensor parameter)
	...
	public static Set<IBlr_ss_swtc_htswc_rwisovpm> getAllBlr_ss_swtc_htswc_rwisovpmsObjectsCreated(){
		Set<IBlr_ss_swtc_htswc_rwisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_htswc_rwisovpm")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_htswc_rwisovpm)mapper)
