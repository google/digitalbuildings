...
/**
* Class Fcu_dfss_dfvsc_rtc_chwrc 
* Hydronic variable speed fan coil with cooling (return control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfvsc_rtc_chwrc extends www.google.com.digitalbuildings._0_0_1.hvac.Chwrc implements IFcu_dfss_dfvsc_rtc_chwrc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_rtc_chwrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_rtc_chwrc"));
	}
  ...
  public void addUsesReturn_air_temperature_setpoint (IReturn_air_temperature_setpoint parameter)
	...
	public static Set<IFcu_dfss_dfvsc_rtc_chwrc> getAllFcu_dfss_dfvsc_rtc_chwrcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_rtc_chwrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_rtc_chwrc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_rtc_chwrc)mapper)
