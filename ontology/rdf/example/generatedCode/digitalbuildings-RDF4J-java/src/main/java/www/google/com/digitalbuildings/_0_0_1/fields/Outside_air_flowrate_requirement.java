...
public class Outside_air_flowrate_requirement extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IOutside_air_flowrate_requirement{

	IRI newInstance;
	public Outside_air_flowrate_requirement(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_flowrate_requirement"));
	}
  ...
  public void addComposedOfRequirement (IRequirement parameter)
	...
	public static Set<IOutside_air_flowrate_requirement> getAllOutside_air_flowrate_requirementsObjectsCreated(){
		Set<IOutside_air_flowrate_requirement> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_flowrate_requirement")).subjects().stream()
		.map(mapper->(IOutside_air_flowrate_requirement)mapper)
