...
/**
* Class Mau_sfss_sfvsc_sspc_ht2sc_dx2sc 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc_sspc_ht2sc_dx2sc extends www.google.com.digitalbuildings._0_0_1.hvac.Ht2sc implements IMau_sfss_sfvsc_sspc_ht2sc_dx2sc{

	IRI newInstance;
	public Mau_sfss_sfvsc_sspc_ht2sc_dx2sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_sspc_ht2sc_dx2sc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IMau_sfss_sfvsc_sspc_ht2sc_dx2sc> getAllMau_sfss_sfvsc_sspc_ht2sc_dx2scsObjectsCreated(){
		Set<IMau_sfss_sfvsc_sspc_ht2sc_dx2sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_sspc_ht2sc_dx2sc")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_sspc_ht2sc_dx2sc)mapper)
