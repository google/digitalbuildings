...
public class Filter_differential_pressure_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IFilter_differential_pressure_sensor{
	...
	public Filter_differential_pressure_sensor(String namespace, String instanceId) {
		...
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Filter_differential_pressure_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IFilter_differential_pressure_sensor> getAllFilter_differential_pressure_sensorsObjectsCreated(){
		Set<IFilter_differential_pressure_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Filter_differential_pressure_sensor")).subjects().stream()
		.map(mapper->(IFilter_differential_pressure_sensor)mapper)
