...
public class Supply_water_isolation_valve_percentage_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_water_isolation_valve_percentage_sensor{

	IRI newInstance;
	public Supply_water_isolation_valve_percentage_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_water_isolation_valve_percentage_sensor"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<ISupply_water_isolation_valve_percentage_sensor> getAllSupply_water_isolation_valve_percentage_sensorsObjectsCreated(){
		Set<ISupply_water_isolation_valve_percentage_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_water_isolation_valve_percentage_sensor")).subjects().stream()
		.map(mapper->(ISupply_water_isolation_valve_percentage_sensor)mapper)
