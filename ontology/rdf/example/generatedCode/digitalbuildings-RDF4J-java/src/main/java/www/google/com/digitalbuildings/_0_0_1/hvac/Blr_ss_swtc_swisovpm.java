...
/**
* Class Blr_ss_swtc_swisovpm 
* Simple boiler with supply control and supply isolation.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_swisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Swisovpm implements IBlr_ss_swtc_swisovpm{

	IRI newInstance;
	public Blr_ss_swtc_swisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_swisovpm"));
	}
  ...
  public void addUsesSupply_water_isolation_valve_status (ISupply_water_isolation_valve_status parameter)
	...
	public static Set<IBlr_ss_swtc_swisovpm> getAllBlr_ss_swtc_swisovpmsObjectsCreated(){
		Set<IBlr_ss_swtc_swisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_swisovpm")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_swisovpm)mapper)
