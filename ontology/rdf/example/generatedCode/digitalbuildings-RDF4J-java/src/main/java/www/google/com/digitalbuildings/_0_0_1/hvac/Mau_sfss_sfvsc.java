...
/**
* Class Mau_sfss_sfvsc 
* Variable speed make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IMau_sfss_sfvsc{

	IRI newInstance;
	public Mau_sfss_sfvsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IMau_sfss_sfvsc> getAllMau_sfss_sfvscsObjectsCreated(){
		Set<IMau_sfss_sfvsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc)mapper)
