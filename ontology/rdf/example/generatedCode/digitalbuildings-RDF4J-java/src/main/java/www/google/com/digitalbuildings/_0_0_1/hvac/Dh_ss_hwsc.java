...
public class Dh_ss_hwsc extends www.google.com.digitalbuildings._0_0_1.hvac.Hwsc implements IDh_ss_hwsc{

	IRI newInstance;
	public Dh_ss_hwsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dh_ss_hwsc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IDh_ss_hwsc> getAllDh_ss_hwscsObjectsCreated(){
		Set<IDh_ss_hwsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dh_ss_hwsc")).subjects().stream()
		.map(mapper->(IDh_ss_hwsc)mapper)
