...
/**
* Class Chws_swtc_wdpc_clpm_wfrc 
* Chilled water system with supply temp and pressure control.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc_clpm_wfrc extends www.google.com.digitalbuildings._0_0_1.hvac.Clpm implements IChws_swtc_wdpc_clpm_wfrc{

	IRI newInstance;
	public Chws_swtc_wdpc_clpm_wfrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm_wfrc"));
	}
  ...
  public void addUsesOptionalsCompressor_speed_frequency_sensor (ICompressor_speed_frequency_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc_clpm_wfrc> getAllChws_swtc_wdpc_clpm_wfrcsObjectsCreated(){
		Set<IChws_swtc_wdpc_clpm_wfrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm_wfrc")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc_clpm_wfrc)mapper)
