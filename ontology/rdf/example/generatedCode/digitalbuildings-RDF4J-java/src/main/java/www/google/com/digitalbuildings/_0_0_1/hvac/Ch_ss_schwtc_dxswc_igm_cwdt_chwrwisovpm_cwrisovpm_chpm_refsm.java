...
/**
* Class Ch_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm 
* Water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm extends www.google.com.digitalbuildings._0_0_1.hvac.Dxswc implements ICh_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm{

	IRI newInstance;
	public Ch_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm"));
	}
  ...
  public void addUsesChilled_water_differential_pressure_sensor (IChilled_water_differential_pressure_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm> getAllCh_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsmsObjectsCreated(){
		Set<ICh_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_dxswc_igm_cwdt_chwrwisovpm_cwrisovpm_chpm_refsm)mapper)
