...
public class Leaving_heating_coil_temperature_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ILeaving_heating_coil_temperature_sensor{

	IRI newInstance;
	public Leaving_heating_coil_temperature_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Leaving_heating_coil_temperature_sensor"));
	}
  ...
  public void addComposedOfTemperature (ITemperature parameter)
	...
	public static Set<ILeaving_heating_coil_temperature_sensor> getAllLeaving_heating_coil_temperature_sensorsObjectsCreated(){
		Set<ILeaving_heating_coil_temperature_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Leaving_heating_coil_temperature_sensor")).subjects().stream()
		.map(mapper->(ILeaving_heating_coil_temperature_sensor)mapper)
