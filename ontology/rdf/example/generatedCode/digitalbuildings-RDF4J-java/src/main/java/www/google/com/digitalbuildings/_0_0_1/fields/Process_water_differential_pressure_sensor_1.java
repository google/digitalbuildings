...
public class Process_water_differential_pressure_sensor_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IProcess_water_differential_pressure_sensor_1{

	IRI newInstance;
	public Process_water_differential_pressure_sensor_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_water_differential_pressure_sensor_1"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IProcess_water_differential_pressure_sensor_1> getAllProcess_water_differential_pressure_sensor_1sObjectsCreated(){
		Set<IProcess_water_differential_pressure_sensor_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_water_differential_pressure_sensor_1")).subjects().stream()
		.map(mapper->(IProcess_water_differential_pressure_sensor_1)mapper)
