...
public class Supply_air_heating_flowrate_capacity extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_air_heating_flowrate_capacity{

	IRI newInstance;
	public Supply_air_heating_flowrate_capacity(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_heating_flowrate_capacity"));
	}
  ...
  public void addComposedOfSupply (ISupply parameter)
	...
	public static Set<ISupply_air_heating_flowrate_capacity> getAllSupply_air_heating_flowrate_capacitysObjectsCreated(){
		Set<ISupply_air_heating_flowrate_capacity> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_heating_flowrate_capacity")).subjects().stream()
		.map(mapper->(ISupply_air_heating_flowrate_capacity)mapper)
