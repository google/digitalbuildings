...
public class Preheating_water_valve_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IPreheating_water_valve_percentage_command{

	IRI newInstance;
	public Preheating_water_valve_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Preheating_water_valve_percentage_command"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IPreheating_water_valve_percentage_command> getAllPreheating_water_valve_percentage_commandsObjectsCreated(){
		Set<IPreheating_water_valve_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Preheating_water_valve_percentage_command")).subjects().stream()
		.map(mapper->(IPreheating_water_valve_percentage_command)mapper)
