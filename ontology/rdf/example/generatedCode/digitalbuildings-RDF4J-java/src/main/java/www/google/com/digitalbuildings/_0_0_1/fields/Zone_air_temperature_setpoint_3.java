...
public class Zone_air_temperature_setpoint_3 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_air_temperature_setpoint_3{

	IRI newInstance;
	public Zone_air_temperature_setpoint_3(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_temperature_setpoint_3"));
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_air_temperature_setpoint_3> getAllZone_air_temperature_setpoint_3sObjectsCreated(){
		Set<IZone_air_temperature_setpoint_3> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_temperature_setpoint_3")).subjects().stream()
		.map(mapper->(IZone_air_temperature_setpoint_3)mapper)
