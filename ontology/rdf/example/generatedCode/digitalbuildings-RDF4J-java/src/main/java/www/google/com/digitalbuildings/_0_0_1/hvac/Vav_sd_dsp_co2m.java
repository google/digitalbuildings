...
/**
* Class Vav_sd_dsp_co2m 
* VAV with zone CO2 monitoring.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_co2m extends www.google.com.digitalbuildings._0_0_1.hvac.Co2m implements IVav_sd_dsp_co2m{

	IRI newInstance;
	public Vav_sd_dsp_co2m(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_co2m"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_co2m> getAllVav_sd_dsp_co2msObjectsCreated(){
		Set<IVav_sd_dsp_co2m> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_co2m")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_co2m)mapper)
