...
public class Ddsp extends www.google.com.digitalbuildings._0_0_1.Operational implements IDdsp{

	IRI newInstance;
	public Ddsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ddsp"));
	}
  ...
  public void addUsesOptionalsDischarge_air_temperature_sensor (IDischarge_air_temperature_sensor parameter)
	...
	public static Set<IDdsp> getAllDdspsObjectsCreated(){
		Set<IDdsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ddsp")).subjects().stream()
		.map(mapper->(IDdsp)mapper)
