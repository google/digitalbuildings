...
public class Process_water_flowrate_sensor_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IProcess_water_flowrate_sensor_2{

	IRI newInstance;
	public Process_water_flowrate_sensor_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_water_flowrate_sensor_2"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IProcess_water_flowrate_sensor_2> getAllProcess_water_flowrate_sensor_2sObjectsCreated(){
		Set<IProcess_water_flowrate_sensor_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_water_flowrate_sensor_2")).subjects().stream()
		.map(mapper->(IProcess_water_flowrate_sensor_2)mapper)
