...
public class Return_water_isolation_valve_status_3 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IReturn_water_isolation_valve_status_3{

	IRI newInstance;
	public Return_water_isolation_valve_status_3(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Return_water_isolation_valve_status_3"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IReturn_water_isolation_valve_status_3> getAllReturn_water_isolation_valve_status_3sObjectsCreated(){
		Set<IReturn_water_isolation_valve_status_3> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Return_water_isolation_valve_status_3")).subjects().stream()
		.map(mapper->(IReturn_water_isolation_valve_status_3)mapper)
