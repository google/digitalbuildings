...
/**
* Class Mau_dfss_dfvsc_dx2dc_ht2dc_dsp 
* Single zone heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dfvsc_dx2dc_ht2dc_dsp extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IMau_dfss_dfvsc_dx2dc_ht2dc_dsp{

	IRI newInstance;
	public Mau_dfss_dfvsc_dx2dc_ht2dc_dsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_dx2dc_ht2dc_dsp"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IMau_dfss_dfvsc_dx2dc_ht2dc_dsp> getAllMau_dfss_dfvsc_dx2dc_ht2dc_dspsObjectsCreated(){
		Set<IMau_dfss_dfvsc_dx2dc_ht2dc_dsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_dx2dc_ht2dc_dsp")).subjects().stream()
		.map(mapper->(IMau_dfss_dfvsc_dx2dc_ht2dc_dsp)mapper)
