...
public class Return_air_damper_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IReturn_air_damper_percentage_command{

	IRI newInstance;
	public Return_air_damper_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Return_air_damper_percentage_command"));
	}
  ...
  public void addComposedOfReturn (IReturn parameter)
	...
	public static Set<IReturn_air_damper_percentage_command> getAllReturn_air_damper_percentage_commandsObjectsCreated(){
		Set<IReturn_air_damper_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Return_air_damper_percentage_command")).subjects().stream()
		.map(mapper->(IReturn_air_damper_percentage_command)mapper)
