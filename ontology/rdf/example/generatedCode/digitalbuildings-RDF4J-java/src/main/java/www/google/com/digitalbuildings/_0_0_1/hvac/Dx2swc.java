...
public class Dx2swc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx2swc{

	IRI newInstance;
	public Dx2swc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2swc"));
	}
  ...
  public void addUsesSupply_water_temperature_setpoint (ISupply_water_temperature_setpoint parameter)
	...
	public static Set<IDx2swc> getAllDx2swcsObjectsCreated(){
		Set<IDx2swc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2swc")).subjects().stream()
		.map(mapper->(IDx2swc)mapper)
