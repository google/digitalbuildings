...
/**
* Class Blr_ss_swtc_swisovm_htswc 
* Boiler with single stage heat and supply isolation
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_swisovm_htswc extends www.google.com.digitalbuildings._0_0_1.hvac.Swisovm implements IBlr_ss_swtc_swisovm_htswc{

	IRI newInstance;
	public Blr_ss_swtc_swisovm_htswc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_swisovm_htswc"));
	}
  ...
  public void addUsesSupply_water_isolation_valve_status (ISupply_water_isolation_valve_status parameter)
	...
	public static Set<IBlr_ss_swtc_swisovm_htswc> getAllBlr_ss_swtc_swisovm_htswcsObjectsCreated(){
		Set<IBlr_ss_swtc_swisovm_htswc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_swisovm_htswc")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_swisovm_htswc)mapper)
