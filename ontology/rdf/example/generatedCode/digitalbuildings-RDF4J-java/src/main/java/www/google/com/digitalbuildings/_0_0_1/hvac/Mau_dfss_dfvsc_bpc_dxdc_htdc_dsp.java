...
/**
* Class Mau_dfss_dfvsc_bpc_dxdc_htdc_dsp 
* Single zone static control heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dfvsc_bpc_dxdc_htdc_dsp extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IMau_dfss_dfvsc_bpc_dxdc_htdc_dsp{

	IRI newInstance;
	public Mau_dfss_dfvsc_bpc_dxdc_htdc_dsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_bpc_dxdc_htdc_dsp"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IMau_dfss_dfvsc_bpc_dxdc_htdc_dsp> getAllMau_dfss_dfvsc_bpc_dxdc_htdc_dspsObjectsCreated(){
		Set<IMau_dfss_dfvsc_bpc_dxdc_htdc_dsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_bpc_dxdc_htdc_dsp")).subjects().stream()
		.map(mapper->(IMau_dfss_dfvsc_bpc_dxdc_htdc_dsp)mapper)
