...
/**
* Class Chws_swtc_wdpc_bypvpm_wfrm 
* Chilled water system (temp/pressure control) with bypass control and flow monitoring.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc_bypvpm_wfrm extends www.google.com.digitalbuildings._0_0_1.hvac.Wfrm implements IChws_swtc_wdpc_bypvpm_wfrm{

	IRI newInstance;
	public Chws_swtc_wdpc_bypvpm_wfrm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_bypvpm_wfrm"));
	}
  ...
  public void addUsesOptionalsCompressor_speed_frequency_sensor (ICompressor_speed_frequency_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc_bypvpm_wfrm> getAllChws_swtc_wdpc_bypvpm_wfrmsObjectsCreated(){
		Set<IChws_swtc_wdpc_bypvpm_wfrm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_bypvpm_wfrm")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc_bypvpm_wfrm)mapper)
