...
public class Exhaust_fan_power_capacity extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IExhaust_fan_power_capacity{

	IRI newInstance;
	public Exhaust_fan_power_capacity(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_fan_power_capacity"));
	}
  ...
  public void addComposedOfPower (IPower parameter)
	...
	public static Set<IExhaust_fan_power_capacity> getAllExhaust_fan_power_capacitysObjectsCreated(){
		Set<IExhaust_fan_power_capacity> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_fan_power_capacity")).subjects().stream()
		.map(mapper->(IExhaust_fan_power_capacity)mapper)
