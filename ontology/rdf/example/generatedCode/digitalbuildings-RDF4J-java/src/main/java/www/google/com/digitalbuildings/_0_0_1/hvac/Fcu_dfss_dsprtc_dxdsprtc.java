...
/**
* Class Fcu_dfss_dsprtc_dxdsprtc 
* Return temp control FCU with DX.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsprtc_dxdsprtc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxdsprtc implements IFcu_dfss_dsprtc_dxdsprtc{

	IRI newInstance;
	public Fcu_dfss_dsprtc_dxdsprtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsprtc_dxdsprtc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_dsprtc_dxdsprtc> getAllFcu_dfss_dsprtc_dxdsprtcsObjectsCreated(){
		Set<IFcu_dfss_dsprtc_dxdsprtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsprtc_dxdsprtc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsprtc_dxdsprtc)mapper)
