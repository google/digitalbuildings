...
/**
* Class Fcu_dfss_dsp_hwzc 
* Heating-only FCU (zone control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_hwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Hwzc implements IFcu_dfss_dsp_hwzc{

	IRI newInstance;
	public Fcu_dfss_dsp_hwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_hwzc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IFcu_dfss_dsp_hwzc> getAllFcu_dfss_dsp_hwzcsObjectsCreated(){
		Set<IFcu_dfss_dsp_hwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_hwzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_hwzc)mapper)
