...
public class Zone_occupancy_status extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_occupancy_status{

	IRI newInstance;
	public Zone_occupancy_status(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_occupancy_status"));
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_occupancy_status> getAllZone_occupancy_statussObjectsCreated(){
		Set<IZone_occupancy_status> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_occupancy_status")).subjects().stream()
		.map(mapper->(IZone_occupancy_status)mapper)
