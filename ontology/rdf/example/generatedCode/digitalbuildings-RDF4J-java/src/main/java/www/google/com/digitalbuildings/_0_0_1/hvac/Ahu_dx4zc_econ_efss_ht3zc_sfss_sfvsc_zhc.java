...
/**
* Class Ahu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc 
* Multi-zone AHU with some weird zone points.
*/
@SuppressWarnings("serial")
public class Ahu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc extends www.google.com.digitalbuildings._0_0_1.hvac.Efss implements IAhu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc{

	IRI newInstance;
	public Ahu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc> getAllAhu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhcsObjectsCreated(){
		Set<IAhu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc")).subjects().stream()
		.map(mapper->(IAhu_dx4zc_econ_efss_ht3zc_sfss_sfvsc_zhc)mapper)
