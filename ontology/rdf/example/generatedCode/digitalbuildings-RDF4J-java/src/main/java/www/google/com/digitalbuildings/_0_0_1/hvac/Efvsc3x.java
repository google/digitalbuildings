...
/**
* Class Efvsc3x 
* Exhaust fan variable speed control with feedback and sensoring for three fans.
*/
@SuppressWarnings("serial")
public class Efvsc3x extends www.google.com.digitalbuildings._0_0_1.Operational implements IEfvsc3x{

	IRI newInstance;
	public Efvsc3x(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Efvsc3x"));
	}
  ...
  public void addUsesOptionalsExhaust_fan_speed_percentage_sensor_3 (IExhaust_fan_speed_percentage_sensor_3 parameter)
	...
	public static Set<IEfvsc3x> getAllEfvsc3xsObjectsCreated(){
		Set<IEfvsc3x> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Efvsc3x")).subjects().stream()
		.map(mapper->(IEfvsc3x)mapper)
