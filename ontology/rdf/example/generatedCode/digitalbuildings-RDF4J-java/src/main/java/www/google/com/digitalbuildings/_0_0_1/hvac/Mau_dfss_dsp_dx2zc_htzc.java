...
/**
* Class Mau_dfss_dsp_dx2zc_htzc 
* Single zone heating (electric) and cooling (2-stage) make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dsp_dx2zc_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dx2zc implements IMau_dfss_dsp_dx2zc_htzc{

	IRI newInstance;
	public Mau_dfss_dsp_dx2zc_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dsp_dx2zc_htzc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IMau_dfss_dsp_dx2zc_htzc> getAllMau_dfss_dsp_dx2zc_htzcsObjectsCreated(){
		Set<IMau_dfss_dsp_dx2zc_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dsp_dx2zc_htzc")).subjects().stream()
		.map(mapper->(IMau_dfss_dsp_dx2zc_htzc)mapper)
