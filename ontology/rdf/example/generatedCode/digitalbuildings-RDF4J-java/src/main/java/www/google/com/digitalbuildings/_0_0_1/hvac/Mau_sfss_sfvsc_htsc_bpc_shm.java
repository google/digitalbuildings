...
/**
* Class Mau_sfss_sfvsc_htsc_bpc_shm 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc_htsc_bpc_shm extends www.google.com.digitalbuildings._0_0_1.hvac.Sfvsc implements IMau_sfss_sfvsc_htsc_bpc_shm{

	IRI newInstance;
	public Mau_sfss_sfvsc_htsc_bpc_shm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_htsc_bpc_shm"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IMau_sfss_sfvsc_htsc_bpc_shm> getAllMau_sfss_sfvsc_htsc_bpc_shmsObjectsCreated(){
		Set<IMau_sfss_sfvsc_htsc_bpc_shm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_htsc_bpc_shm")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_htsc_bpc_shm)mapper)
