...
/**
* Class Ahu_chwsdc_econd_htsdc_sfss_shc 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_chwsdc_econd_htsdc_sfss_shc extends www.google.com.digitalbuildings._0_0_1.hvac.Shc implements IAhu_chwsdc_econd_htsdc_sfss_shc{

	IRI newInstance;
	public Ahu_chwsdc_econd_htsdc_sfss_shc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwsdc_econd_htsdc_sfss_shc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_chwsdc_econd_htsdc_sfss_shc> getAllAhu_chwsdc_econd_htsdc_sfss_shcsObjectsCreated(){
		Set<IAhu_chwsdc_econd_htsdc_sfss_shc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwsdc_econd_htsdc_sfss_shc")).subjects().stream()
		.map(mapper->(IAhu_chwsdc_econd_htsdc_sfss_shc)mapper)
