...
/**
* Class Fcu_df2xss_rtc_dxrc 
* Two-fan DX fan coil with zone temp control.
*/
@SuppressWarnings("serial")
public class Fcu_df2xss_rtc_dxrc extends www.google.com.digitalbuildings._0_0_1.hvac.Df2xss implements IFcu_df2xss_rtc_dxrc{

	IRI newInstance;
	public Fcu_df2xss_rtc_dxrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_df2xss_rtc_dxrc"));
	}
  ...
  public void addUsesReturn_air_temperature_setpoint (IReturn_air_temperature_setpoint parameter)
	...
	public static Set<IFcu_df2xss_rtc_dxrc> getAllFcu_df2xss_rtc_dxrcsObjectsCreated(){
		Set<IFcu_df2xss_rtc_dxrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_df2xss_rtc_dxrc")).subjects().stream()
		.map(mapper->(IFcu_df2xss_rtc_dxrc)mapper)
