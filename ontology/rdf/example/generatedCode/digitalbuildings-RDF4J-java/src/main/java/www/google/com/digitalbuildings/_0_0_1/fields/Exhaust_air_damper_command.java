...
public class Exhaust_air_damper_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IExhaust_air_damper_command{

	IRI newInstance;
	public Exhaust_air_damper_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_damper_command"));
	}
  ...
  public void addComposedOfExhaust (IExhaust parameter)
	...
	public static Set<IExhaust_air_damper_command> getAllExhaust_air_damper_commandsObjectsCreated(){
		Set<IExhaust_air_damper_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_damper_command")).subjects().stream()
		.map(mapper->(IExhaust_air_damper_command)mapper)
