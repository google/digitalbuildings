...
public class Exhaust_fan_run_command_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IExhaust_fan_run_command_2{

	IRI newInstance;
	public Exhaust_fan_run_command_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_fan_run_command_2"));
	}
  ...
  public void addComposedOfRun (IRun parameter)
	...
	public static Set<IExhaust_fan_run_command_2> getAllExhaust_fan_run_command_2sObjectsCreated(){
		Set<IExhaust_fan_run_command_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_fan_run_command_2")).subjects().stream()
		.map(mapper->(IExhaust_fan_run_command_2)mapper)
