...
/**
* Class Dx2sc 
* Two compressor run control on supply air side.
*/
@SuppressWarnings("serial")
public class Dx2sc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx2sc{

	IRI newInstance;
	public Dx2sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2sc"));
	}
  ...
  public void addUsesOptionalsLeaving_cooling_coil_temperature_sensor (ILeaving_cooling_coil_temperature_sensor parameter)
	...
	public static Set<IDx2sc> getAllDx2scsObjectsCreated(){
		Set<IDx2sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2sc")).subjects().stream()
		.map(mapper->(IDx2sc)mapper)
