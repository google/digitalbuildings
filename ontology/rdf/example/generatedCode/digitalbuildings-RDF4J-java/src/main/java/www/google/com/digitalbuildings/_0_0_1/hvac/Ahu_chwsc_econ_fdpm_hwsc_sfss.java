...
/**
* Class Ahu_chwsc_econ_fdpm_hwsc_sfss 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_chwsc_econ_fdpm_hwsc_sfss extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IAhu_chwsc_econ_fdpm_hwsc_sfss{

	IRI newInstance;
	public Ahu_chwsc_econ_fdpm_hwsc_sfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwsc_econ_fdpm_hwsc_sfss"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_chwsc_econ_fdpm_hwsc_sfss> getAllAhu_chwsc_econ_fdpm_hwsc_sfsssObjectsCreated(){
		Set<IAhu_chwsc_econ_fdpm_hwsc_sfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwsc_econ_fdpm_hwsc_sfss")).subjects().stream()
		.map(mapper->(IAhu_chwsc_econ_fdpm_hwsc_sfss)mapper)
