...
public class Fan_ss_eatc extends www.google.com.digitalbuildings._0_0_1.hvac.Rtm implements IFan_ss_eatc{

	IRI newInstance;
	public Fan_ss_eatc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_eatc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IFan_ss_eatc> getAllFan_ss_eatcsObjectsCreated(){
		Set<IFan_ss_eatc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_eatc")).subjects().stream()
		.map(mapper->(IFan_ss_eatc)mapper)
