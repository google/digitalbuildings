...
public class Exhaust_fan_power_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IExhaust_fan_power_sensor{

	IRI newInstance;
	public Exhaust_fan_power_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_fan_power_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IExhaust_fan_power_sensor> getAllExhaust_fan_power_sensorsObjectsCreated(){
		Set<IExhaust_fan_power_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_fan_power_sensor")).subjects().stream()
		.map(mapper->(IExhaust_fan_power_sensor)mapper)
