...
import www.google.com.digitalbuildings._0_0_1.fields.Discharge_air_static_pressure_sensor;
...
public class Fcu_dfss_dfvsc_ztc_chwztc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfvsc implements IFcu_dfss_dfvsc_ztc_chwztc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_ztc_chwztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_ztc_chwztc"));
	}
  ...
  public void addUsesOptionalsDischarge_air_static_pressure_sensor (IDischarge_air_static_pressure_sensor parameter)
	...
	public Set<IDischarge_air_static_pressure_sensor> getUsesOptionalsDischarge_air_static_pressure_sensor (){
		Set<IDischarge_air_static_pressure_sensor> UsesOptionalsDischarge_air_static_pressure_sensor = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#usesOptional"), null)
		.objects().forEach(action->{
			if(action instanceof Discharge_air_static_pressure_sensor) {
				UsesOptionalsDischarge_air_static_pressure_sensor.add((Discharge_air_static_pressure_sensor)action);
			}
		});
		return UsesOptionalsDischarge_air_static_pressure_sensor;
	}
  ...
  public void addUsesOptionalsFilter_differential_pressure_sensor (IFilter_differential_pressure_sensor parameter)
	...
	public Set<IFilter_differential_pressure_sensor> getUsesOptionalsFilter_differential_pressure_sensor (){
		Set<IFilter_differential_pressure_sensor> UsesOptionalsFilter_differential_pressure_sensor = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#usesOptional"), null)
		.objects().forEach(action->{
			if(action instanceof Filter_differential_pressure_sensor) {
				UsesOptionalsFilter_differential_pressure_sensor.add((Filter_differential_pressure_sensor)action);
			}
		});
		return UsesOptionalsFilter_differential_pressure_sensor;
	}
  ...
  public void addUsesOptionalsZone_air_co2_concentration_sensor (IZone_air_co2_concentration_sensor parameter)
	...
	public Set<IZone_air_co2_concentration_sensor> getUsesOptionalsZone_air_co2_concentration_sensor (){
		Set<IZone_air_co2_concentration_sensor> UsesOptionalsZone_air_co2_concentration_sensor = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#usesOptional"), null)
		.objects().forEach(action->{
			if(action instanceof Zone_air_co2_concentration_sensor) {
				UsesOptionalsZone_air_co2_concentration_sensor.add((Zone_air_co2_concentration_sensor)action);
			}
		});
		return UsesOptionalsZone_air_co2_concentration_sensor;
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_dfvsc_ztc_chwztc> getAllFcu_dfss_dfvsc_ztc_chwztcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_ztc_chwztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_ztc_chwztc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_ztc_chwztc)mapper)
