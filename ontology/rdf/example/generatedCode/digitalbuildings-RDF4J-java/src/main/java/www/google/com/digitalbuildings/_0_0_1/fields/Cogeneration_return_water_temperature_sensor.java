...
public class Cogeneration_return_water_temperature_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICogeneration_return_water_temperature_sensor{

	IRI newInstance;
	public Cogeneration_return_water_temperature_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cogeneration_return_water_temperature_sensor"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<ICogeneration_return_water_temperature_sensor> getAllCogeneration_return_water_temperature_sensorsObjectsCreated(){
		Set<ICogeneration_return_water_temperature_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cogeneration_return_water_temperature_sensor")).subjects().stream()
		.map(mapper->(ICogeneration_return_water_temperature_sensor)mapper)
