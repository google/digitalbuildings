...
/**
* Class Mau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc extends www.google.com.digitalbuildings._0_0_1.hvac.Dx2sc implements IMau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc{

	IRI newInstance;
	public Mau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc"));
	}
  ...
  public void addUsesHeater_run_command_4 (IHeater_run_command_4 parameter)
	...
	public static Set<IMau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc> getAllMau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspcsObjectsCreated(){
		Set<IMau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_hwsc_dx2sc_ht4sc_sspc)mapper)
