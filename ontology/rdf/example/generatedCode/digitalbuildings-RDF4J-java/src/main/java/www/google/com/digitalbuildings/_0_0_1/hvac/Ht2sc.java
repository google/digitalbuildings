...
public class Ht2sc extends www.google.com.digitalbuildings._0_0_1.Control implements IHt2sc{

	IRI newInstance;
	public Ht2sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2sc"));
	}
  ...
  public void addUsesOptionalsHeating_thermal_power_capacity (IHeating_thermal_power_capacity parameter)
	...
	public static Set<IHt2sc> getAllHt2scsObjectsCreated(){
		Set<IHt2sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht2sc")).subjects().stream()
		.map(mapper->(IHt2sc)mapper)
