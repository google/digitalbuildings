...
public class Cooling_air_flowrate_sensor_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICooling_air_flowrate_sensor_1{

	IRI newInstance;
	public Cooling_air_flowrate_sensor_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_air_flowrate_sensor_1"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<ICooling_air_flowrate_sensor_1> getAllCooling_air_flowrate_sensor_1sObjectsCreated(){
		Set<ICooling_air_flowrate_sensor_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_air_flowrate_sensor_1")).subjects().stream()
		.map(mapper->(ICooling_air_flowrate_sensor_1)mapper)
