...
/**
* Class Vav_sd_dsp_vocc 
* Single duct cooling-only VAV with dual setpoint and VOC control.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_vocc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IVav_sd_dsp_vocc{

	IRI newInstance;
	public Vav_sd_dsp_vocc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_vocc"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_vocc> getAllVav_sd_dsp_voccsObjectsCreated(){
		Set<IVav_sd_dsp_vocc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_vocc")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_vocc)mapper)
