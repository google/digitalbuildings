...
import www.google.com.digitalbuildings._0_0_1.subfields.Wetbulb;
...
public class Outside_air_wetbulb_temperature_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IOutside_air_wetbulb_temperature_sensor{

	IRI newInstance;
	public Outside_air_wetbulb_temperature_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_wetbulb_temperature_sensor"));
	}
  ...
  public void addComposedOfWetbulb (IWetbulb parameter)
	...
	public Set<IWetbulb> getComposedOfWetbulb (){
		Set<IWetbulb> ComposedOfWetbulb = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Wetbulb) {
				ComposedOfWetbulb.add((Wetbulb)action);
			}
		});
		return ComposedOfWetbulb;
	}

	public static Set<IOutside_air_wetbulb_temperature_sensor> getAllOutside_air_wetbulb_temperature_sensorsObjectsCreated(){
		Set<IOutside_air_wetbulb_temperature_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_wetbulb_temperature_sensor")).subjects().stream()
		.map(mapper->(IOutside_air_wetbulb_temperature_sensor)mapper)
