...
/**
* Class Mau_dfss_dfvsc_dsp_chwzc_hwzc 
* Single zone heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dfvsc_dsp_chwzc_hwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Chwzc implements IMau_dfss_dfvsc_dsp_chwzc_hwzc{

	IRI newInstance;
	public Mau_dfss_dfvsc_dsp_chwzc_hwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_dsp_chwzc_hwzc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IMau_dfss_dfvsc_dsp_chwzc_hwzc> getAllMau_dfss_dfvsc_dsp_chwzc_hwzcsObjectsCreated(){
		Set<IMau_dfss_dfvsc_dsp_chwzc_hwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_dsp_chwzc_hwzc")).subjects().stream()
		.map(mapper->(IMau_dfss_dfvsc_dsp_chwzc_hwzc)mapper)
