...
/**
* Class Htzc 
* Gas or electric heater control on zone side (ZC).
*/
@SuppressWarnings("serial")
public class Htzc extends www.google.com.digitalbuildings._0_0_1.Control implements IHtzc{

	IRI newInstance;
	public Htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htzc"));
	}
  ...
  public void addUsesZone_air_temperature_sensor (IZone_air_temperature_sensor parameter)
	...
	public static Set<IHtzc> getAllHtzcsObjectsCreated(){
		Set<IHtzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htzc")).subjects().stream()
		.map(mapper->(IHtzc)mapper)
