...
/**
* Class Ahu_dx2sc_econ_sfss_sfvsc_sspc 
* Multi zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dx2sc_econ_sfss_sfvsc_sspc extends www.google.com.digitalbuildings._0_0_1.hvac.Econ implements IAhu_dx2sc_econ_sfss_sfvsc_sspc{

	IRI newInstance;
	public Ahu_dx2sc_econ_sfss_sfvsc_sspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dx2sc_econ_sfss_sfvsc_sspc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IAhu_dx2sc_econ_sfss_sfvsc_sspc> getAllAhu_dx2sc_econ_sfss_sfvsc_sspcsObjectsCreated(){
		Set<IAhu_dx2sc_econ_sfss_sfvsc_sspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dx2sc_econ_sfss_sfvsc_sspc")).subjects().stream()
		.map(mapper->(IAhu_dx2sc_econ_sfss_sfvsc_sspc)mapper)
