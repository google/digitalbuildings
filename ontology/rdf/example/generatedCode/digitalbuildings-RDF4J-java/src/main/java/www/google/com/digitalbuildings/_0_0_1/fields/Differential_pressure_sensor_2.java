...
public class Differential_pressure_sensor_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDifferential_pressure_sensor_2{

	IRI newInstance;
	public Differential_pressure_sensor_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Differential_pressure_sensor_2"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IDifferential_pressure_sensor_2> getAllDifferential_pressure_sensor_2sObjectsCreated(){
		Set<IDifferential_pressure_sensor_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Differential_pressure_sensor_2")).subjects().stream()
		.map(mapper->(IDifferential_pressure_sensor_2)mapper)
