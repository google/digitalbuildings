...
import www.google.com.digitalbuildings._0_0_1.subfields.Ventilation;
...
public class Ventilation_outside_air_damper_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IVentilation_outside_air_damper_percentage_command{

	IRI newInstance;
	public Ventilation_outside_air_damper_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Ventilation_outside_air_damper_percentage_command"));
	}
  ...
  public void addComposedOfVentilation (IVentilation parameter)
	...
	public Set<IVentilation> getComposedOfVentilation (){
		Set<IVentilation> ComposedOfVentilation = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Ventilation) {
				ComposedOfVentilation.add((Ventilation)action);
			}
		});
		return ComposedOfVentilation;
	}

	public static Set<IVentilation_outside_air_damper_percentage_command> getAllVentilation_outside_air_damper_percentage_commandsObjectsCreated(){
		Set<IVentilation_outside_air_damper_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Ventilation_outside_air_damper_percentage_command")).subjects().stream()
		.map(mapper->(IVentilation_outside_air_damper_percentage_command)mapper)
