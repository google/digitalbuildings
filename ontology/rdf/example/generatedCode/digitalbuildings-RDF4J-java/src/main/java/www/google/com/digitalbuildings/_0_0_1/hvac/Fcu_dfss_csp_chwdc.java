...
/**
* Class Fcu_dfss_csp_chwdc 
* Typical chilled water FCU with cooling-only (discharge control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_csp_chwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Csp implements IFcu_dfss_csp_chwdc{

	IRI newInstance;
	public Fcu_dfss_csp_chwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_csp_chwdc"));
	}
  ...
  public void addUsesHeater_run_command_3 (IHeater_run_command_3 parameter)
	...
	public static Set<IFcu_dfss_csp_chwdc> getAllFcu_dfss_csp_chwdcsObjectsCreated(){
		Set<IFcu_dfss_csp_chwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_csp_chwdc")).subjects().stream()
		.map(mapper->(IFcu_dfss_csp_chwdc)mapper)
