...
/**
* Class Chws_swtc_wdpc2x_bypvpm_wfrc 
* Chilled water system with dual differential pressure control.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc2x_bypvpm_wfrc extends www.google.com.digitalbuildings._0_0_1.hvac.Wdpc2x implements IChws_swtc_wdpc2x_bypvpm_wfrc{

	IRI newInstance;
	public Chws_swtc_wdpc2x_bypvpm_wfrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc2x_bypvpm_wfrc"));
	}
  ...
  public void addUsesOptionalsCompressor_speed_frequency_sensor (ICompressor_speed_frequency_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc2x_bypvpm_wfrc> getAllChws_swtc_wdpc2x_bypvpm_wfrcsObjectsCreated(){
		Set<IChws_swtc_wdpc2x_bypvpm_wfrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc2x_bypvpm_wfrc")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc2x_bypvpm_wfrc)mapper)
