...
/**
* Class Vav_sd_dsp_hwdc_dfss 
* Single duct fan-powered series VAV with reheat.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_hwdc_dfss extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IVav_sd_dsp_hwdc_dfss{

	IRI newInstance;
	public Vav_sd_dsp_hwdc_dfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_dfss"));
	}
  ...
  public void addUsesOptionalsSupply_air_ventilation_flowrate_requirement (ISupply_air_ventilation_flowrate_requirement parameter)
	...
	public static Set<IVav_sd_dsp_hwdc_dfss> getAllVav_sd_dsp_hwdc_dfsssObjectsCreated(){
		Set<IVav_sd_dsp_hwdc_dfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_dfss")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_hwdc_dfss)mapper)
