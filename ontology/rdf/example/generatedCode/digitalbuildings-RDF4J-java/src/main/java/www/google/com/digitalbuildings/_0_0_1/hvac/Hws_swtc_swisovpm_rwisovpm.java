...
/**
* Class Hws_swtc_swisovpm_rwisovpm 
* Simple heating water system with supply temp control and return/supply isolation.
*/
@SuppressWarnings("serial")
public class Hws_swtc_swisovpm_rwisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Swisovpm implements IHws_swtc_swisovpm_rwisovpm{

	IRI newInstance;
	public Hws_swtc_swisovpm_rwisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_swisovpm_rwisovpm"));
	}
  ...
  public void addUsesOptionalsSpeed_percentage_sensor (ISpeed_percentage_sensor parameter)
	...
	public static Set<IHws_swtc_swisovpm_rwisovpm> getAllHws_swtc_swisovpm_rwisovpmsObjectsCreated(){
		Set<IHws_swtc_swisovpm_rwisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_swisovpm_rwisovpm")).subjects().stream()
		.map(mapper->(IHws_swtc_swisovpm_rwisovpm)mapper)
