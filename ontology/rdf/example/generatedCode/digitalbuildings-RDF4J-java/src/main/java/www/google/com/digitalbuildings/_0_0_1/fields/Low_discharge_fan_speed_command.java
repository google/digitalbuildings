...
import www.google.com.digitalbuildings._0_0_1.subfields.Low;
...
public class Low_discharge_fan_speed_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ILow_discharge_fan_speed_command{

	IRI newInstance;
	public Low_discharge_fan_speed_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Low_discharge_fan_speed_command"));
	}
  ...
  public void addComposedOfLow (ILow parameter)
	...
	public Set<ILow> getComposedOfLow (){
		Set<ILow> ComposedOfLow = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Low) {
				ComposedOfLow.add((Low)action);
			}
		});
		return ComposedOfLow;
	}
  ...
  public void addComposedOfSpeed (ISpeed parameter)
	...
	public static Set<ILow_discharge_fan_speed_command> getAllLow_discharge_fan_speed_commandsObjectsCreated(){
		Set<ILow_discharge_fan_speed_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Low_discharge_fan_speed_command")).subjects().stream()
		.map(mapper->(ILow_discharge_fan_speed_command)mapper)
