...
/**
* Class Vav_sd_dsp_htdc 
* Single duct reheat VAV with electric heat.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_htdc extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_dsp_htdc{

	IRI newInstance;
	public Vav_sd_dsp_htdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_htdc"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_htdc> getAllVav_sd_dsp_htdcsObjectsCreated(){
		Set<IVav_sd_dsp_htdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_htdc")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_htdc)mapper)
