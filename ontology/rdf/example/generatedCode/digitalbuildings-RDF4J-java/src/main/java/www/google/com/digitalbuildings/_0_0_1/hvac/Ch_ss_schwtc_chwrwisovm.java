...
/**
* Class Ch_ss_schwtc_chwrwisovm 
* Simple water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_chwrwisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Chwrwisovm implements ICh_ss_schwtc_chwrwisovm{

	IRI newInstance;
	public Ch_ss_schwtc_chwrwisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovm"));
	}
  ...
  public void addUsesChilled_return_water_isolation_valve_status (IChilled_return_water_isolation_valve_status parameter)
	...
	public static Set<ICh_ss_schwtc_chwrwisovm> getAllCh_ss_schwtc_chwrwisovmsObjectsCreated(){
		Set<ICh_ss_schwtc_chwrwisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_chwrwisovm)mapper)
