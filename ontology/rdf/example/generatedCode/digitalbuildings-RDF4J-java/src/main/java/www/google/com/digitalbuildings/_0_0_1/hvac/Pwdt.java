...
public class Pwdt extends www.google.com.digitalbuildings._0_0_1.hvac.Functionality implements IPwdt{

	IRI newInstance;
	public Pwdt(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Pwdt"));
	}
  ...
  public void addUsesCogeneration_return_water_temperature_setpoint (ICogeneration_return_water_temperature_setpoint parameter)
	...
	public static Set<IPwdt> getAllPwdtsObjectsCreated(){
		Set<IPwdt> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Pwdt")).subjects().stream()
		.map(mapper->(IPwdt)mapper)
