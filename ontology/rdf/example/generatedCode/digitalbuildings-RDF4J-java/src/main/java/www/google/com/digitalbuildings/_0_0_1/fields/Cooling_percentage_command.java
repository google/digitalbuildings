...
public class Cooling_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICooling_percentage_command{

	IRI newInstance;
	public Cooling_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_percentage_command"));
	}
  ...
  public void addComposedOfPercentage (IPercentage parameter)
	...
	public static Set<ICooling_percentage_command> getAllCooling_percentage_commandsObjectsCreated(){
		Set<ICooling_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_percentage_command")).subjects().stream()
		.map(mapper->(ICooling_percentage_command)mapper)
