...
/**
* Class Vav_sd_dsp_hwdc_vocc 
* Single duct reheat VAV with VOC and temp control.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_hwdc_vocc extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_dsp_hwdc_vocc{

	IRI newInstance;
	public Vav_sd_dsp_hwdc_vocc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_vocc"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_hwdc_vocc> getAllVav_sd_dsp_hwdc_voccsObjectsCreated(){
		Set<IVav_sd_dsp_hwdc_vocc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_hwdc_vocc")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_hwdc_vocc)mapper)
