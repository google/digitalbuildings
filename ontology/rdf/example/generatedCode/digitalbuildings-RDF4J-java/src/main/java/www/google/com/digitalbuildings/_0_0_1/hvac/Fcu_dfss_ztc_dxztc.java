...
/**
* Class Fcu_dfss_ztc_dxztc 
* Typical DX FCU (zone control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_ztc_dxztc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxztc implements IFcu_dfss_ztc_dxztc{

	IRI newInstance;
	public Fcu_dfss_ztc_dxztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_ztc_dxztc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IFcu_dfss_ztc_dxztc> getAllFcu_dfss_ztc_dxztcsObjectsCreated(){
		Set<IFcu_dfss_ztc_dxztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_ztc_dxztc")).subjects().stream()
		.map(mapper->(IFcu_dfss_ztc_dxztc)mapper)
