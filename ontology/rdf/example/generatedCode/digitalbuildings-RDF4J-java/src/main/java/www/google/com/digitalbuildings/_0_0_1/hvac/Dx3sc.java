...
/**
* Class Dx3sc 
* Three compressor run control on supply air side.
*/
@SuppressWarnings("serial")
public class Dx3sc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx3sc{

	IRI newInstance;
	public Dx3sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx3sc"));
	}
  ...
  public void addUsesOptionalsLeaving_cooling_coil_temperature_sensor (ILeaving_cooling_coil_temperature_sensor parameter)
	...
	public static Set<IDx3sc> getAllDx3scsObjectsCreated(){
		Set<IDx3sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx3sc")).subjects().stream()
		.map(mapper->(IDx3sc)mapper)
