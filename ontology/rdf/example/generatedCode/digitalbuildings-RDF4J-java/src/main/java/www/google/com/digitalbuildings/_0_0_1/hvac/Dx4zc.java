...
/**
* Class Dx4zc 
* Four compressor run control on zone side.
*/
@SuppressWarnings("serial")
public class Dx4zc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx4zc{

	IRI newInstance;
	public Dx4zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx4zc"));
	}
  ...
  public void addUsesZone_air_temperature_sensor (IZone_air_temperature_sensor parameter)
	...
	public static Set<IDx4zc> getAllDx4zcsObjectsCreated(){
		Set<IDx4zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx4zc")).subjects().stream()
		.map(mapper->(IDx4zc)mapper)
