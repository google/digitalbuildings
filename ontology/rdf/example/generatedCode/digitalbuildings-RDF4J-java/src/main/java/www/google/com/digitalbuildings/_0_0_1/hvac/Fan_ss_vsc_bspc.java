...
/**
* Class Fan_ss_vsc_bspc 
* Variable-speed fan for controlling space static pressure.
*/
@SuppressWarnings("serial")
public class Fan_ss_vsc_bspc extends www.google.com.digitalbuildings._0_0_1.hvac.Bpc implements IFan_ss_vsc_bspc{

	IRI newInstance;
	public Fan_ss_vsc_bspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_bspc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFan_ss_vsc_bspc> getAllFan_ss_vsc_bspcsObjectsCreated(){
		Set<IFan_ss_vsc_bspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_bspc")).subjects().stream()
		.map(mapper->(IFan_ss_vsc_bspc)mapper)
