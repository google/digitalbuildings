...
/**
* Class Blr_ss_swtc_rwisovm_ht2swc 
* Two-stage boiler with supply control and return isolation.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_rwisovm_ht2swc extends www.google.com.digitalbuildings._0_0_1.hvac.Ht2swc implements IBlr_ss_swtc_rwisovm_ht2swc{

	IRI newInstance;
	public Blr_ss_swtc_rwisovm_ht2swc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_rwisovm_ht2swc"));
	}
  ...
  public void addUsesOptionalsRun_command (IRun_command parameter)
	...
	public static Set<IBlr_ss_swtc_rwisovm_ht2swc> getAllBlr_ss_swtc_rwisovm_ht2swcsObjectsCreated(){
		Set<IBlr_ss_swtc_rwisovm_ht2swc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_rwisovm_ht2swc")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_rwisovm_ht2swc)mapper)
