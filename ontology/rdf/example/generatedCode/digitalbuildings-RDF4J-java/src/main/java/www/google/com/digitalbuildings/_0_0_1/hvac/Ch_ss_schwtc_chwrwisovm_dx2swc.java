...
/**
* Class Ch_ss_schwtc_chwrwisovm_dx2swc 
* Tw-stage air cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_chwrwisovm_dx2swc extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICh_ss_schwtc_chwrwisovm_dx2swc{

	IRI newInstance;
	public Ch_ss_schwtc_chwrwisovm_dx2swc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovm_dx2swc"));
	}
  ...
  public void addUsesCompressor_run_status_2 (ICompressor_run_status_2 parameter)
	...
	public static Set<ICh_ss_schwtc_chwrwisovm_dx2swc> getAllCh_ss_schwtc_chwrwisovm_dx2swcsObjectsCreated(){
		Set<ICh_ss_schwtc_chwrwisovm_dx2swc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovm_dx2swc")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_chwrwisovm_dx2swc)mapper)
