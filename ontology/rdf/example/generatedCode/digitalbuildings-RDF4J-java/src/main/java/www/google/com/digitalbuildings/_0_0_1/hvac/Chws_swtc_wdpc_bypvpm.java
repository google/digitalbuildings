...
/**
* Class Chws_swtc_wdpc_bypvpm 
* Chilled water system (temp/pressure control) with bypass control.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc_bypvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Wdpc implements IChws_swtc_wdpc_bypvpm{

	IRI newInstance;
	public Chws_swtc_wdpc_bypvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_bypvpm"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc_bypvpm> getAllChws_swtc_wdpc_bypvpmsObjectsCreated(){
		Set<IChws_swtc_wdpc_bypvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_bypvpm")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc_bypvpm)mapper)
