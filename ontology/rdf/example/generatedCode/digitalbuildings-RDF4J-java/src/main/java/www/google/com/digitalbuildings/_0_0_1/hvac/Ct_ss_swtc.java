...
/**
* Class Ct_ss_swtc 
* Simple supply temp controlling cooling tower.
*/
@SuppressWarnings("serial")
public class Ct_ss_swtc extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICt_ss_swtc{

	IRI newInstance;
	public Ct_ss_swtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_swtc"));
	}
  ...
  public void addUsesSupply_water_isolation_valve_percentage_sensor (ISupply_water_isolation_valve_percentage_sensor parameter)
	...
	public static Set<ICt_ss_swtc> getAllCt_ss_swtcsObjectsCreated(){
		Set<ICt_ss_swtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_swtc")).subjects().stream()
		.map(mapper->(ICt_ss_swtc)mapper)
