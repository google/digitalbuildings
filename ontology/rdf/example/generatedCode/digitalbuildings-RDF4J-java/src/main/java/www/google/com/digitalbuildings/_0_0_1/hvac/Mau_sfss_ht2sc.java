...
public class Mau_sfss_ht2sc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IMau_sfss_ht2sc{

	IRI newInstance;
	public Mau_sfss_ht2sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_ht2sc"));
	}
  ...
  public void addUsesOptionalsHeating_thermal_power_capacity (IHeating_thermal_power_capacity parameter)
	...
	public static Set<IMau_sfss_ht2sc> getAllMau_sfss_ht2scsObjectsCreated(){
		Set<IMau_sfss_ht2sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_ht2sc")).subjects().stream()
		.map(mapper->(IMau_sfss_ht2sc)mapper)
