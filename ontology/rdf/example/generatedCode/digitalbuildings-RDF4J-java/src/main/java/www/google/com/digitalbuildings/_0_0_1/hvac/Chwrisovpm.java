...
public class Chwrisovpm extends www.google.com.digitalbuildings._0_0_1.Monitoring implements IChwrisovpm{

	IRI newInstance;
	public Chwrisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwrisovpm"));
	}
  ...
  public void addUsesChilled_return_water_isolation_valve_percentage_sensor (IChilled_return_water_isolation_valve_percentage_sensor parameter)
	...
	public static Set<IChwrisovpm> getAllChwrisovpmsObjectsCreated(){
		Set<IChwrisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwrisovpm")).subjects().stream()
		.map(mapper->(IChwrisovpm)mapper)
