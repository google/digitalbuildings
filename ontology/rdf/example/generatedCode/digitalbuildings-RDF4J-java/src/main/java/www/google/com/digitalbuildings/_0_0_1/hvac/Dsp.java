...
/**
* Class Dsp 
* Dual setpoint control (heating/cooling thresholds with deadband in between).
*/
@SuppressWarnings("serial")
public class Dsp extends www.google.com.digitalbuildings._0_0_1.Operational implements IDsp{

	IRI newInstance;
	public Dsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dsp"));
	}
  ...
  public void addUsesOptionalsZone_air_relative_humidity_sensor (IZone_air_relative_humidity_sensor parameter)
	...
	public static Set<IDsp> getAllDspsObjectsCreated(){
		Set<IDsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dsp")).subjects().stream()
		.map(mapper->(IDsp)mapper)
