...
public class Hp2sc extends www.google.com.digitalbuildings._0_0_1.Control implements IHp2sc{

	IRI newInstance;
	public Hp2sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hp2sc"));
	}
  ...
  public void addUsesSupply_air_temperature_setpoint (ISupply_air_temperature_setpoint parameter)
	...
	public static Set<IHp2sc> getAllHp2scsObjectsCreated(){
		Set<IHp2sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hp2sc")).subjects().stream()
		.map(mapper->(IHp2sc)mapper)
