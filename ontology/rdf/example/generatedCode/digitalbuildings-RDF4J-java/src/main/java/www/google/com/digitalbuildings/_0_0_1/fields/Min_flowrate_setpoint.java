...
import www.google.com.digitalbuildings._0_0_1.subfields.Min;
...
public class Min_flowrate_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IMin_flowrate_setpoint{

	IRI newInstance;
	public Min_flowrate_setpoint(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Min_flowrate_setpoint"));
	}
  ...
  public void addComposedOfMin (IMin parameter)
	...
	public Set<IMin> getComposedOfMin (){
		Set<IMin> ComposedOfMin = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Min) {
				ComposedOfMin.add((Min)action);
			}
		});
		return ComposedOfMin;
	}
  ...
  public void addComposedOfSetpoint (ISetpoint parameter)
	...
	public static Set<IMin_flowrate_setpoint> getAllMin_flowrate_setpointsObjectsCreated(){
		Set<IMin_flowrate_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Min_flowrate_setpoint")).subjects().stream()
		.map(mapper->(IMin_flowrate_setpoint)mapper)
