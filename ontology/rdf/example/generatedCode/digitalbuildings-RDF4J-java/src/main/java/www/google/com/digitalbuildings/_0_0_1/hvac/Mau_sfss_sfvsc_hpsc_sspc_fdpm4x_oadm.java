...
/**
* Class Mau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm extends www.google.com.digitalbuildings._0_0_1.hvac.Sfvsc implements IMau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm{

	IRI newInstance;
	public Mau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IMau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm> getAllMau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadmsObjectsCreated(){
		Set<IMau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_hpsc_sspc_fdpm4x_oadm)mapper)
