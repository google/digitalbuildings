...
/**
* Class Ch_ss_swtc_dx2swc_swisovm 
* Two stage air cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_swtc_dx2swc_swisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICh_ss_swtc_dx2swc_swisovm{

	IRI newInstance;
	public Ch_ss_swtc_dx2swc_swisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc_dx2swc_swisovm"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<ICh_ss_swtc_dx2swc_swisovm> getAllCh_ss_swtc_dx2swc_swisovmsObjectsCreated(){
		Set<ICh_ss_swtc_dx2swc_swisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc_dx2swc_swisovm")).subjects().stream()
		.map(mapper->(ICh_ss_swtc_dx2swc_swisovm)mapper)
