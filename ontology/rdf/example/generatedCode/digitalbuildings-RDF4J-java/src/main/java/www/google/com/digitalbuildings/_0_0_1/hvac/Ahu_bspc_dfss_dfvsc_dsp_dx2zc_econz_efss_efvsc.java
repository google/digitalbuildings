...
/**
* Class Ahu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc extends www.google.com.digitalbuildings._0_0_1.hvac.Dx2zc implements IAhu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc{

	IRI newInstance;
	public Ahu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc> getAllAhu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvscsObjectsCreated(){
		Set<IAhu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc")).subjects().stream()
		.map(mapper->(IAhu_bspc_dfss_dfvsc_dsp_dx2zc_econz_efss_efvsc)mapper)
