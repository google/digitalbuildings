...
/**
* Class Hwsc 
* Heating water valve monitoring on supply air side.
*/
@SuppressWarnings("serial")
public class Hwsc extends www.google.com.digitalbuildings._0_0_1.Control implements IHwsc{

	IRI newInstance;
	public Hwsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hwsc"));
	}
  ...
  public void addUsesOptionalsHeating_water_valve_percentage_sensor (IHeating_water_valve_percentage_sensor parameter)
	...
	public static Set<IHwsc> getAllHwscsObjectsCreated(){
		Set<IHwsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hwsc")).subjects().stream()
		.map(mapper->(IHwsc)mapper)
