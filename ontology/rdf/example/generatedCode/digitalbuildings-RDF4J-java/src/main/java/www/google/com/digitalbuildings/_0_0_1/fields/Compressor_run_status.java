...
public class Compressor_run_status extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICompressor_run_status{

	IRI newInstance;
	public Compressor_run_status(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_run_status"));
	}
  ...
  public void addComposedOfStatus (IStatus parameter)
	...
	public static Set<ICompressor_run_status> getAllCompressor_run_statussObjectsCreated(){
		Set<ICompressor_run_status> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_run_status")).subjects().stream()
		.map(mapper->(ICompressor_run_status)mapper)
