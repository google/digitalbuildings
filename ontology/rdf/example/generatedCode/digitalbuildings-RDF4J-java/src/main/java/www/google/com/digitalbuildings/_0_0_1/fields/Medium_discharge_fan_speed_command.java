...
import www.google.com.digitalbuildings._0_0_1.subfields.Medium;
...
public class Medium_discharge_fan_speed_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IMedium_discharge_fan_speed_command{

	IRI newInstance;
	public Medium_discharge_fan_speed_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Medium_discharge_fan_speed_command"));
	}
  ...
  public void addComposedOfMedium (IMedium parameter)
	...
	public Set<IMedium> getComposedOfMedium (){
		Set<IMedium> ComposedOfMedium = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Medium) {
				ComposedOfMedium.add((Medium)action);
			}
		});
		return ComposedOfMedium;
	}
  ...
  public void addComposedOfSpeed (ISpeed parameter)
	...
	public static Set<IMedium_discharge_fan_speed_command> getAllMedium_discharge_fan_speed_commandsObjectsCreated(){
		Set<IMedium_discharge_fan_speed_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Medium_discharge_fan_speed_command")).subjects().stream()
		.map(mapper->(IMedium_discharge_fan_speed_command)mapper)
