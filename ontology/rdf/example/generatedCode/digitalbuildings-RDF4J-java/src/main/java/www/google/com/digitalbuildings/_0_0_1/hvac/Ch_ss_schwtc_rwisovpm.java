...
/**
* Class Ch_ss_schwtc_rwisovpm 
* Simple water-cooled chiller with condenser isolation.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_rwisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Rwisovpm implements ICh_ss_schwtc_rwisovpm{

	IRI newInstance;
	public Ch_ss_schwtc_rwisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_rwisovpm"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_rwisovpm> getAllCh_ss_schwtc_rwisovpmsObjectsCreated(){
		Set<ICh_ss_schwtc_rwisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_rwisovpm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_rwisovpm)mapper)
