...
/**
* Class Vav_sd_dsp 
* Simple cooling only VAV.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_dsp{

	IRI newInstance;
	public Vav_sd_dsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IVav_sd_dsp> getAllVav_sd_dspsObjectsCreated(){
		Set<IVav_sd_dsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp")).subjects().stream()
		.map(mapper->(IVav_sd_dsp)mapper)
