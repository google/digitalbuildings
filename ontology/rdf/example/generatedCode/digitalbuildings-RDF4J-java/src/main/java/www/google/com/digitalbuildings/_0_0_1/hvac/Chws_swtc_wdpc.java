...
/**
* Class Chws_swtc_wdpc 
* Chilled water system with supply temperature and differential pressure control.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IChws_swtc_wdpc{

	IRI newInstance;
	public Chws_swtc_wdpc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc"));
	}
  ...
  public void addUsesOptionalsProcess_cooling_thermal_power_sensor (IProcess_cooling_thermal_power_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc> getAllChws_swtc_wdpcsObjectsCreated(){
		Set<IChws_swtc_wdpc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc)mapper)
