...
public class Supply_water_isolation_valve_status extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_water_isolation_valve_status{

	IRI newInstance;
	public Supply_water_isolation_valve_status(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_water_isolation_valve_status"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<ISupply_water_isolation_valve_status> getAllSupply_water_isolation_valve_statussObjectsCreated(){
		Set<ISupply_water_isolation_valve_status> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_water_isolation_valve_status")).subjects().stream()
		.map(mapper->(ISupply_water_isolation_valve_status)mapper)
