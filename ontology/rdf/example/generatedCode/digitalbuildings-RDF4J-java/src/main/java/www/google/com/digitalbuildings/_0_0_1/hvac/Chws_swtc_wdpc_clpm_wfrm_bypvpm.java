...
/**
* Class Chws_swtc_wdpc_clpm_wfrm_bypvpm 
* Chilled water system with supply temp, pressure and bypass control.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc_clpm_wfrm_bypvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Wfrm implements IChws_swtc_wdpc_clpm_wfrm_bypvpm{

	IRI newInstance;
	public Chws_swtc_wdpc_clpm_wfrm_bypvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm_wfrm_bypvpm"));
	}
  ...
  public void addUsesProcess_cooling_thermal_power_sensor (IProcess_cooling_thermal_power_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc_clpm_wfrm_bypvpm> getAllChws_swtc_wdpc_clpm_wfrm_bypvpmsObjectsCreated(){
		Set<IChws_swtc_wdpc_clpm_wfrm_bypvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm_wfrm_bypvpm")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc_clpm_wfrm_bypvpm)mapper)
