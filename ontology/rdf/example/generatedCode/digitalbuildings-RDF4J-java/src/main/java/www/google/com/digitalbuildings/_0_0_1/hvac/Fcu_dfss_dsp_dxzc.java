...
/**
* Class Fcu_dfss_dsp_dxzc 
* Typical DX water FCU (zone control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_dsp_dxzc{

	IRI newInstance;
	public Fcu_dfss_dsp_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_dxzc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_dsp_dxzc> getAllFcu_dfss_dsp_dxzcsObjectsCreated(){
		Set<IFcu_dfss_dsp_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_dxzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_dxzc)mapper)
