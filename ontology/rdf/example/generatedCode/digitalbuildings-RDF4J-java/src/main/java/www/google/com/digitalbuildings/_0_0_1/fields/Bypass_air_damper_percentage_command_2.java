...
public class Bypass_air_damper_percentage_command_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IBypass_air_damper_percentage_command_2{

	IRI newInstance;
	public Bypass_air_damper_percentage_command_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Bypass_air_damper_percentage_command_2"));
	}
  ...
  public void addComposedOfPercentage (IPercentage parameter)
	...
	public static Set<IBypass_air_damper_percentage_command_2> getAllBypass_air_damper_percentage_command_2sObjectsCreated(){
		Set<IBypass_air_damper_percentage_command_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Bypass_air_damper_percentage_command_2")).subjects().stream()
		.map(mapper->(IBypass_air_damper_percentage_command_2)mapper)
