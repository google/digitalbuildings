...
public class Discharge_fan_run_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDischarge_fan_run_command{

	IRI newInstance;
	public Discharge_fan_run_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_fan_run_command"));
	}
  ...
  public void addComposedOfRun (IRun parameter)
	...
	public static Set<IDischarge_fan_run_command> getAllDischarge_fan_run_commandsObjectsCreated(){
		Set<IDischarge_fan_run_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_fan_run_command")).subjects().stream()
		.map(mapper->(IDischarge_fan_run_command)mapper)
