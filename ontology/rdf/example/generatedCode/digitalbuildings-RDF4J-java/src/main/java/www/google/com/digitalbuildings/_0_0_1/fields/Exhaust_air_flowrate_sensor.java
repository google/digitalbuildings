...
public class Exhaust_air_flowrate_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IExhaust_air_flowrate_sensor{

	IRI newInstance;
	public Exhaust_air_flowrate_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_flowrate_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IExhaust_air_flowrate_sensor> getAllExhaust_air_flowrate_sensorsObjectsCreated(){
		Set<IExhaust_air_flowrate_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_flowrate_sensor")).subjects().stream()
		.map(mapper->(IExhaust_air_flowrate_sensor)mapper)
