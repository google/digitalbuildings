...
/**
* Class Ch_ss_schwtc_cwrisovpm 
* Simple water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_cwrisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Schwtc implements ICh_ss_schwtc_cwrisovpm{

	IRI newInstance;
	public Ch_ss_schwtc_cwrisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_cwrisovpm"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_cwrisovpm> getAllCh_ss_schwtc_cwrisovpmsObjectsCreated(){
		Set<ICh_ss_schwtc_cwrisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_cwrisovpm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_cwrisovpm)mapper)
