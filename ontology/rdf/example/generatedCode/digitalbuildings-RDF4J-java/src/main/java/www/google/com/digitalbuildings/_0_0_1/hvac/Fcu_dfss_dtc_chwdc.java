...
/**
* Class Fcu_dfss_dtc_chwdc 
* Discharge temperature control FCU with chilled water.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dtc_chwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_dtc_chwdc{

	IRI newInstance;
	public Fcu_dfss_dtc_chwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dtc_chwdc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_dtc_chwdc> getAllFcu_dfss_dtc_chwdcsObjectsCreated(){
		Set<IFcu_dfss_dtc_chwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dtc_chwdc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dtc_chwdc)mapper)
