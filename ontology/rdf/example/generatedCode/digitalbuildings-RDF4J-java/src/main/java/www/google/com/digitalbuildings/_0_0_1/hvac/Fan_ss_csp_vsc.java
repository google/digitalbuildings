...
/**
* Class Fan_ss_csp_vsc 
* Cooling fan with variable speed command (no feedback).
*/
@SuppressWarnings("serial")
public class Fan_ss_csp_vsc extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IFan_ss_csp_vsc{

	IRI newInstance;
	public Fan_ss_csp_vsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_csp_vsc"));
	}
  ...
  public void addUsesFlowrate_setpoint (IFlowrate_setpoint parameter)
	...
	public static Set<IFan_ss_csp_vsc> getAllFan_ss_csp_vscsObjectsCreated(){
		Set<IFan_ss_csp_vsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_csp_vsc")).subjects().stream()
		.map(mapper->(IFan_ss_csp_vsc)mapper)
