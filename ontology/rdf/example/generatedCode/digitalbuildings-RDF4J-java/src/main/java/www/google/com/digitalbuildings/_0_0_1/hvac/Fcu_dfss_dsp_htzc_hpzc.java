...
/**
* Class Fcu_dfss_dsp_htzc_hpzc 
* Heat pump fan coil with reheat (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_htzc_hpzc extends www.google.com.digitalbuildings._0_0_1.hvac.Htzc implements IFcu_dfss_dsp_htzc_hpzc{

	IRI newInstance;
	public Fcu_dfss_dsp_htzc_hpzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_htzc_hpzc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_dsp_htzc_hpzc> getAllFcu_dfss_dsp_htzc_hpzcsObjectsCreated(){
		Set<IFcu_dfss_dsp_htzc_hpzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_htzc_hpzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_htzc_hpzc)mapper)
