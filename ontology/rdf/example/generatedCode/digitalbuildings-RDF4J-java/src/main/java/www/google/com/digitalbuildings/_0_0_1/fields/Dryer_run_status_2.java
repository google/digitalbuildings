...
public class Dryer_run_status_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDryer_run_status_2{

	IRI newInstance;
	public Dryer_run_status_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Dryer_run_status_2"));
	}
  ...
  public void addComposedOfStatus (IStatus parameter)
	...
	public static Set<IDryer_run_status_2> getAllDryer_run_status_2sObjectsCreated(){
		Set<IDryer_run_status_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Dryer_run_status_2")).subjects().stream()
		.map(mapper->(IDryer_run_status_2)mapper)
