...
/**
* Class Ch_ss_swtc_dx4swc_chwdpm 
* Air cooled chiller with 4 stages cooling.
*/
@SuppressWarnings("serial")
public class Ch_ss_swtc_dx4swc_chwdpm extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements ICh_ss_swtc_dx4swc_chwdpm{

	IRI newInstance;
	public Ch_ss_swtc_dx4swc_chwdpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc_dx4swc_chwdpm"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<ICh_ss_swtc_dx4swc_chwdpm> getAllCh_ss_swtc_dx4swc_chwdpmsObjectsCreated(){
		Set<ICh_ss_swtc_dx4swc_chwdpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc_dx4swc_chwdpm")).subjects().stream()
		.map(mapper->(ICh_ss_swtc_dx4swc_chwdpm)mapper)
