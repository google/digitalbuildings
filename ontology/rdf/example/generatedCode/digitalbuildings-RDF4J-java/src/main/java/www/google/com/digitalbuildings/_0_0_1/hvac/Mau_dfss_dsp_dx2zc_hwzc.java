...
/**
* Class Mau_dfss_dsp_dx2zc_hwzc 
* Single zone heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dsp_dx2zc_hwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Hwzc implements IMau_dfss_dsp_dx2zc_hwzc{

	IRI newInstance;
	public Mau_dfss_dsp_dx2zc_hwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dsp_dx2zc_hwzc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IMau_dfss_dsp_dx2zc_hwzc> getAllMau_dfss_dsp_dx2zc_hwzcsObjectsCreated(){
		Set<IMau_dfss_dsp_dx2zc_hwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dsp_dx2zc_hwzc")).subjects().stream()
		.map(mapper->(IMau_dfss_dsp_dx2zc_hwzc)mapper)
