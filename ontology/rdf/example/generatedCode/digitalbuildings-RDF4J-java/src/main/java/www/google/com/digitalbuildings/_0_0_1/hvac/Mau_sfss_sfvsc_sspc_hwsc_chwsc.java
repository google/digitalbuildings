...
/**
* Class Mau_sfss_sfvsc_sspc_hwsc_chwsc 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc_sspc_hwsc_chwsc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IMau_sfss_sfvsc_sspc_hwsc_chwsc{

	IRI newInstance;
	public Mau_sfss_sfvsc_sspc_hwsc_chwsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_sspc_hwsc_chwsc"));
	}
  ...
  public void addUsesHeater_run_command_4 (IHeater_run_command_4 parameter)
	...
	public static Set<IMau_sfss_sfvsc_sspc_hwsc_chwsc> getAllMau_sfss_sfvsc_sspc_hwsc_chwscsObjectsCreated(){
		Set<IMau_sfss_sfvsc_sspc_hwsc_chwsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_sspc_hwsc_chwsc")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_sspc_hwsc_chwsc)mapper)
