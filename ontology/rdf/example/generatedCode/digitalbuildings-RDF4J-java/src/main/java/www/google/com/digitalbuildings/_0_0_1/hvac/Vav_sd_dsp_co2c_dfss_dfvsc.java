...
/**
* Class Vav_sd_dsp_co2c_dfss_dfvsc 
* Fan powered VAV with variable speed control and CO2 control.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_co2c_dfss_dfvsc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IVav_sd_dsp_co2c_dfss_dfvsc{

	IRI newInstance;
	public Vav_sd_dsp_co2c_dfss_dfvsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_co2c_dfss_dfvsc"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_co2c_dfss_dfvsc> getAllVav_sd_dsp_co2c_dfss_dfvscsObjectsCreated(){
		Set<IVav_sd_dsp_co2c_dfss_dfvsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_co2c_dfss_dfvsc")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_co2c_dfss_dfvsc)mapper)
