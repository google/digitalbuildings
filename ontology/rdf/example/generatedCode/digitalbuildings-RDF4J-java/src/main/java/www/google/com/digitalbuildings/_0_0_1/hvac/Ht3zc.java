...
public class Ht3zc extends www.google.com.digitalbuildings._0_0_1.Control implements IHt3zc{

	IRI newInstance;
	public Ht3zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht3zc"));
	}
  ...
  public void addUsesOptionalsHeating_thermal_power_capacity (IHeating_thermal_power_capacity parameter)
	...
	public static Set<IHt3zc> getAllHt3zcsObjectsCreated(){
		Set<IHt3zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht3zc")).subjects().stream()
		.map(mapper->(IHt3zc)mapper)
