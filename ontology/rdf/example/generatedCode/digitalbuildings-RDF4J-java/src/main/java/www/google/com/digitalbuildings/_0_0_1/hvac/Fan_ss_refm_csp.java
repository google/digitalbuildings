...
/**
* Class Fan_ss_refm_csp 
* Cooling control fan with refrigerant monitoring.
*/
@SuppressWarnings("serial")
public class Fan_ss_refm_csp extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IFan_ss_refm_csp{

	IRI newInstance;
	public Fan_ss_refm_csp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_refm_csp"));
	}
  ...
  public void addUsesFlowrate_setpoint (IFlowrate_setpoint parameter)
	...
	public static Set<IFan_ss_refm_csp> getAllFan_ss_refm_cspsObjectsCreated(){
		Set<IFan_ss_refm_csp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_refm_csp")).subjects().stream()
		.map(mapper->(IFan_ss_refm_csp)mapper)
