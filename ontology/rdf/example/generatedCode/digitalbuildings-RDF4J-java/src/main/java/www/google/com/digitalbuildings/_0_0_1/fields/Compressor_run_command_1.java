...
public class Compressor_run_command_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICompressor_run_command_1{

	IRI newInstance;
	public Compressor_run_command_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_run_command_1"));
	}
  ...
  public void addComposedOfRun (IRun parameter)
	...
	public static Set<ICompressor_run_command_1> getAllCompressor_run_command_1sObjectsCreated(){
		Set<ICompressor_run_command_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_run_command_1")).subjects().stream()
		.map(mapper->(ICompressor_run_command_1)mapper)
