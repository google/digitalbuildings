...
public class Exhaust_air_damper_percentage_command_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IExhaust_air_damper_percentage_command_1{

	IRI newInstance;
	public Exhaust_air_damper_percentage_command_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_damper_percentage_command_1"));
	}
  ...
  public void addComposedOfPercentage (IPercentage parameter)
	...
	public static Set<IExhaust_air_damper_percentage_command_1> getAllExhaust_air_damper_percentage_command_1sObjectsCreated(){
		Set<IExhaust_air_damper_percentage_command_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Exhaust_air_damper_percentage_command_1")).subjects().stream()
		.map(mapper->(IExhaust_air_damper_percentage_command_1)mapper)
