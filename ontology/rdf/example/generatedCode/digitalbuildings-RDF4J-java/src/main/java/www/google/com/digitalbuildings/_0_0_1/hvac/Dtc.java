...
public class Dtc extends www.google.com.digitalbuildings._0_0_1.Operational implements IDtc{

	IRI newInstance;
	public Dtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dtc"));
	}
  ...
  public void addUsesDischarge_air_temperature_setpoint (IDischarge_air_temperature_setpoint parameter)
	...
	public static Set<IDtc> getAllDtcsObjectsCreated(){
		Set<IDtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dtc")).subjects().stream()
		.map(mapper->(IDtc)mapper)
