...
/**
* Class Ahu_dfss_dsp_dxzc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_dxzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IAhu_dfss_dsp_dxzc{

	IRI newInstance;
	public Ahu_dfss_dsp_dxzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxzc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dfss_dsp_dxzc> getAllAhu_dfss_dsp_dxzcsObjectsCreated(){
		Set<IAhu_dfss_dsp_dxzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxzc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_dxzc)mapper)
