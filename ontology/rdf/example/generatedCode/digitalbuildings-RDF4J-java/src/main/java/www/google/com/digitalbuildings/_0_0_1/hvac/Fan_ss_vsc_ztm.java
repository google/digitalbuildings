...
/**
* Class Fan_ss_vsc_ztm 
* Fan with zone temp monitoring and independent variable speed control (such as a kitchen hood, where the setpoints may be hidden).
*/
@SuppressWarnings("serial")
public class Fan_ss_vsc_ztm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IFan_ss_vsc_ztm{

	IRI newInstance;
	public Fan_ss_vsc_ztm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_ztm"));
	}
  ...
  public void addUsesZone_air_refrigerant_concentration_sensor (IZone_air_refrigerant_concentration_sensor parameter)
	...
	public static Set<IFan_ss_vsc_ztm> getAllFan_ss_vsc_ztmsObjectsCreated(){
		Set<IFan_ss_vsc_ztm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_ztm")).subjects().stream()
		.map(mapper->(IFan_ss_vsc_ztm)mapper)
