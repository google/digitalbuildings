...
public class Zone_air_co2_concentration_sensor_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_air_co2_concentration_sensor_1{

	IRI newInstance;
	public Zone_air_co2_concentration_sensor_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_co2_concentration_sensor_1"));
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_air_co2_concentration_sensor_1> getAllZone_air_co2_concentration_sensor_1sObjectsCreated(){
		Set<IZone_air_co2_concentration_sensor_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_co2_concentration_sensor_1")).subjects().stream()
		.map(mapper->(IZone_air_co2_concentration_sensor_1)mapper)
