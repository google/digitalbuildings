...
/**
* Class Fcu_dfss_ztc_hpztc 
* Single zone heat pump.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_ztc_hpztc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_ztc_hpztc{

	IRI newInstance;
	public Fcu_dfss_ztc_hpztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_ztc_hpztc"));
	}
  ...
  public void addUsesReversing_valve_command (IReversing_valve_command parameter)
	...
	public static Set<IFcu_dfss_ztc_hpztc> getAllFcu_dfss_ztc_hpztcsObjectsCreated(){
		Set<IFcu_dfss_ztc_hpztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_ztc_hpztc")).subjects().stream()
		.map(mapper->(IFcu_dfss_ztc_hpztc)mapper)
