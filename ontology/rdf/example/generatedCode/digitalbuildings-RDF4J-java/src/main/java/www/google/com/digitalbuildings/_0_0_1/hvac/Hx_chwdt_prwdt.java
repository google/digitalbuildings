...
/**
* Class Hx_chwdt_prwdt 
* Chilled/process water heat exchanger.
*/
@SuppressWarnings("serial")
public class Hx_chwdt_prwdt extends www.google.com.digitalbuildings._0_0_1.hvac.Prwdt implements IHx_chwdt_prwdt{

	IRI newInstance;
	public Hx_chwdt_prwdt(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_chwdt_prwdt"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<IHx_chwdt_prwdt> getAllHx_chwdt_prwdtsObjectsCreated(){
		Set<IHx_chwdt_prwdt> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_chwdt_prwdt")).subjects().stream()
		.map(mapper->(IHx_chwdt_prwdt)mapper)
