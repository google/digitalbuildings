...
public class Dx4swc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx4swc{

	IRI newInstance;
	public Dx4swc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx4swc"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<IDx4swc> getAllDx4swcsObjectsCreated(){
		Set<IDx4swc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx4swc")).subjects().stream()
		.map(mapper->(IDx4swc)mapper)
