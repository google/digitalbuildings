...
/**
* Class Ct_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm 
* Variable speed supply temp controlling cooling tower.
*/
@SuppressWarnings("serial")
public class Ct_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Vsc implements ICt_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm{

	IRI newInstance;
	public Ct_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm"));
	}
  ...
  public void addUsesOptionalsSpeed_percentage_sensor (ISpeed_percentage_sensor parameter)
	...
	public static Set<ICt_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm> getAllCt_ss_vsc_swtc_swisovpm_rwisovpm_mwvpmsObjectsCreated(){
		Set<ICt_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm")).subjects().stream()
		.map(mapper->(ICt_ss_vsc_swtc_swisovpm_rwisovpm_mwvpm)mapper)
