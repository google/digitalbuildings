...
/**
* Class Ahu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm extends www.google.com.digitalbuildings._0_0_1.hvac.Econz implements IAhu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm{

	IRI newInstance;
	public Ahu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm"));
	}
  ...
  public void addUsesZone_air_relative_humidity_sensor (IZone_air_relative_humidity_sensor parameter)
	...
	public static Set<IAhu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm> getAllAhu_dfss_dfvsc_dx4zc_econz_ht3zc_zhmsObjectsCreated(){
		Set<IAhu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm")).subjects().stream()
		.map(mapper->(IAhu_dfss_dfvsc_dx4zc_econz_ht3zc_zhm)mapper)
