...
/**
* Class Fan_ss_vsc_epc 
* Fan with exhaust static pressure control.
*/
@SuppressWarnings("serial")
public class Fan_ss_vsc_epc extends www.google.com.digitalbuildings._0_0_1.hvac.Vsc implements IFan_ss_vsc_epc{

	IRI newInstance;
	public Fan_ss_vsc_epc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_epc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFan_ss_vsc_epc> getAllFan_ss_vsc_epcsObjectsCreated(){
		Set<IFan_ss_vsc_epc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_vsc_epc")).subjects().stream()
		.map(mapper->(IFan_ss_vsc_epc)mapper)
