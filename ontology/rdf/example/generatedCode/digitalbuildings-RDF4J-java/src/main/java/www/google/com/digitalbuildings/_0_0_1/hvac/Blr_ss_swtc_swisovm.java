...
/**
* Class Blr_ss_swtc_swisovm 
* Simple boiler with supply control and supply isolation.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_swisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IBlr_ss_swtc_swisovm{

	IRI newInstance;
	public Blr_ss_swtc_swisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_swisovm"));
	}
  ...
  public void addUsesOptionalsRun_command (IRun_command parameter)
	...
	public static Set<IBlr_ss_swtc_swisovm> getAllBlr_ss_swtc_swisovmsObjectsCreated(){
		Set<IBlr_ss_swtc_swisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_swisovm")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_swisovm)mapper)
