...
/**
* Class Fcu_dfss_dsp_dx2zc 
* Typical 2-stage DX water FCU (zone control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_dx2zc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IFcu_dfss_dsp_dx2zc{

	IRI newInstance;
	public Fcu_dfss_dsp_dx2zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_dx2zc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IFcu_dfss_dsp_dx2zc> getAllFcu_dfss_dsp_dx2zcsObjectsCreated(){
		Set<IFcu_dfss_dsp_dx2zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_dx2zc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_dx2zc)mapper)
