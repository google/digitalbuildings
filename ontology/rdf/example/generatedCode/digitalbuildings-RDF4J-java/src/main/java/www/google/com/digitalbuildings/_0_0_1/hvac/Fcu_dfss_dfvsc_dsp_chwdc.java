...
/**
* Class Fcu_dfss_dfvsc_dsp_chwdc 
* Hydronic variable speed fan coil with cooling (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfvsc_dsp_chwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Chwdc implements IFcu_dfss_dfvsc_dsp_chwdc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_dsp_chwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_dsp_chwdc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFcu_dfss_dfvsc_dsp_chwdc> getAllFcu_dfss_dfvsc_dsp_chwdcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_dsp_chwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_dsp_chwdc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_dsp_chwdc)mapper)
