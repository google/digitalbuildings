...
public class Outside_air_relative_humidity_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IOutside_air_relative_humidity_sensor{

	IRI newInstance;
	public Outside_air_relative_humidity_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_relative_humidity_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IOutside_air_relative_humidity_sensor> getAllOutside_air_relative_humidity_sensorsObjectsCreated(){
		Set<IOutside_air_relative_humidity_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_relative_humidity_sensor")).subjects().stream()
		.map(mapper->(IOutside_air_relative_humidity_sensor)mapper)
