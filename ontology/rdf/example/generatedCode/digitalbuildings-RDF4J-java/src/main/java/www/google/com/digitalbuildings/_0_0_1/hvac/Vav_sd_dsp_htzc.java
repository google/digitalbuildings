...
/**
* Class Vav_sd_dsp_htzc 
* Single duct reheat VAV with electric heat.
*/
@SuppressWarnings("serial")
public class Vav_sd_dsp_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Htzc implements IVav_sd_dsp_htzc{

	IRI newInstance;
	public Vav_sd_dsp_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_htzc"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_sd_dsp_htzc> getAllVav_sd_dsp_htzcsObjectsCreated(){
		Set<IVav_sd_dsp_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_dsp_htzc")).subjects().stream()
		.map(mapper->(IVav_sd_dsp_htzc)mapper)
