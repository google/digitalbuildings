...
public class Htsdc extends www.google.com.digitalbuildings._0_0_1.Control implements IHtsdc{

	IRI newInstance;
	public Htsdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htsdc"));
	}
  ...
  public void addUsesSupply_air_temperature_sensor (ISupply_air_temperature_sensor parameter)
	...
	public static Set<IHtsdc> getAllHtsdcsObjectsCreated(){
		Set<IHtsdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htsdc")).subjects().stream()
		.map(mapper->(IHtsdc)mapper)
