...
import www.google.com.digitalbuildings._0_0_1.subfields.Co;
import www.google.com.digitalbuildings._0_0_1.subfields.ISensor;
import www.google.com.digitalbuildings._0_0_1.subfields.Sensor;


@SuppressWarnings("serial")
public class Zone_air_co_concentration_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_air_co_concentration_sensor{

	IRI newInstance;
	public Zone_air_co_concentration_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_co_concentration_sensor"));
	}
  ...
  public void addComposedOfCo (ICo parameter)
	...
	public Set<ICo> getComposedOfCo (){
		Set<ICo> ComposedOfCo = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#isComposedOf"), null)
		.objects().forEach(action->{
			if(action instanceof Co) {
				ComposedOfCo.add((Co)action);
			}
		});
		return ComposedOfCo;
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_air_co_concentration_sensor> getAllZone_air_co_concentration_sensorsObjectsCreated(){
		Set<IZone_air_co_concentration_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_air_co_concentration_sensor")).subjects().stream()
		.map(mapper->(IZone_air_co_concentration_sensor)mapper)
