...
/**
* Class Ahu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxsc implements IAhu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc{

	IRI newInstance;
	public Ahu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc"));
	}
  ...
  public void addUsesOptionalsCooling_request_count (ICooling_request_count parameter)
	...
	public static Set<IAhu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc> getAllAhu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stcsObjectsCreated(){
		Set<IAhu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc")).subjects().stream()
		.map(mapper->(IAhu_bspc_dxsc_econm_efss_sfss_sfvsc_sspc_stc)mapper)
