...
public class Condensing_return_water_temperature_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICondensing_return_water_temperature_sensor{

	IRI newInstance;
	public Condensing_return_water_temperature_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Condensing_return_water_temperature_sensor"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<ICondensing_return_water_temperature_sensor> getAllCondensing_return_water_temperature_sensorsObjectsCreated(){
		Set<ICondensing_return_water_temperature_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Condensing_return_water_temperature_sensor")).subjects().stream()
		.map(mapper->(ICondensing_return_water_temperature_sensor)mapper)
