...
/**
* Class Dx3dc 
* Three compressor run control on discharge side (DTC).
*/
@SuppressWarnings("serial")
public class Dx3dc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx3dc{

	IRI newInstance;
	public Dx3dc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx3dc"));
	}
  ...
  public void addUsesDischarge_air_temperature_setpoint (IDischarge_air_temperature_setpoint parameter)
	...
	public static Set<IDx3dc> getAllDx3dcsObjectsCreated(){
		Set<IDx3dc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx3dc")).subjects().stream()
		.map(mapper->(IDx3dc)mapper)
