...
/**
* Class Ahu_bypsspc2x_dx2sc_econ_ht2sc_sfss 
* Single zone AHU with bypass static pressure control.
*/
@SuppressWarnings("serial")
public class Ahu_bypsspc2x_dx2sc_econ_ht2sc_sfss extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IAhu_bypsspc2x_dx2sc_econ_ht2sc_sfss{

	IRI newInstance;
	public Ahu_bypsspc2x_dx2sc_econ_ht2sc_sfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc2x_dx2sc_econ_ht2sc_sfss"));
	}
  ...
  public void addUsesOptionalsHeating_percentage_command (IHeating_percentage_command parameter)
	...
	public static Set<IAhu_bypsspc2x_dx2sc_econ_ht2sc_sfss> getAllAhu_bypsspc2x_dx2sc_econ_ht2sc_sfsssObjectsCreated(){
		Set<IAhu_bypsspc2x_dx2sc_econ_ht2sc_sfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc2x_dx2sc_econ_ht2sc_sfss")).subjects().stream()
		.map(mapper->(IAhu_bypsspc2x_dx2sc_econ_ht2sc_sfss)mapper)
