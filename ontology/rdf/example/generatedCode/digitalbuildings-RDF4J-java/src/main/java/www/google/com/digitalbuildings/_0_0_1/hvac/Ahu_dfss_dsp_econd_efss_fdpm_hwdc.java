...
/**
* Class Ahu_dfss_dsp_econd_efss_fdpm_hwdc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_econd_efss_fdpm_hwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Fdpm implements IAhu_dfss_dsp_econd_efss_fdpm_hwdc{

	IRI newInstance;
	public Ahu_dfss_dsp_econd_efss_fdpm_hwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_econd_efss_fdpm_hwdc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dfss_dsp_econd_efss_fdpm_hwdc> getAllAhu_dfss_dsp_econd_efss_fdpm_hwdcsObjectsCreated(){
		Set<IAhu_dfss_dsp_econd_efss_fdpm_hwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_econd_efss_fdpm_hwdc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_econd_efss_fdpm_hwdc)mapper)
