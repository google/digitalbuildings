...
/**
* Class Ahu_co2m_dfss_dsp_dx2zc_econz 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_co2m_dfss_dsp_dx2zc_econz extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IAhu_co2m_dfss_dsp_dx2zc_econz{

	IRI newInstance;
	public Ahu_co2m_dfss_dsp_dx2zc_econz(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2m_dfss_dsp_dx2zc_econz"));
	}
  ...
  public void addUsesZone_air_co2_concentration_sensor (IZone_air_co2_concentration_sensor parameter)
	...
	public static Set<IAhu_co2m_dfss_dsp_dx2zc_econz> getAllAhu_co2m_dfss_dsp_dx2zc_econzsObjectsCreated(){
		Set<IAhu_co2m_dfss_dsp_dx2zc_econz> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2m_dfss_dsp_dx2zc_econz")).subjects().stream()
		.map(mapper->(IAhu_co2m_dfss_dsp_dx2zc_econz)mapper)
