...
/**
* Class Mau_dfss_dfvsc_dsp_htsc 
* Single zone heating-only make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dfvsc_dsp_htsc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IMau_dfss_dfvsc_dsp_htsc{

	IRI newInstance;
	public Mau_dfss_dfvsc_dsp_htsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_dsp_htsc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IMau_dfss_dfvsc_dsp_htsc> getAllMau_dfss_dfvsc_dsp_htscsObjectsCreated(){
		Set<IMau_dfss_dfvsc_dsp_htsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_dsp_htsc")).subjects().stream()
		.map(mapper->(IMau_dfss_dfvsc_dsp_htsc)mapper)
