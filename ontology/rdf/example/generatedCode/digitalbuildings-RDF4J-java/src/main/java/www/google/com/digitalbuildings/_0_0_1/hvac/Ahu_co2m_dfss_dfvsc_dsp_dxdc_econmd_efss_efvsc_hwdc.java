...
/**
* Class Ahu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxdc implements IAhu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc{

	IRI newInstance;
	public Ahu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc> getAllAhu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdcsObjectsCreated(){
		Set<IAhu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc")).subjects().stream()
		.map(mapper->(IAhu_co2m_dfss_dfvsc_dsp_dxdc_econmd_efss_efvsc_hwdc)mapper)
