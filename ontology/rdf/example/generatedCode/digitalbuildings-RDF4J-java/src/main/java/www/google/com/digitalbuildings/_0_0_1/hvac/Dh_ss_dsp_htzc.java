...
/**
* Class Dh_ss_dsp_htzc 
* Electric single-zone duct heater.
*/
@SuppressWarnings("serial")
public class Dh_ss_dsp_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Htzc implements IDh_ss_dsp_htzc{

	IRI newInstance;
	public Dh_ss_dsp_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dh_ss_dsp_htzc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IDh_ss_dsp_htzc> getAllDh_ss_dsp_htzcsObjectsCreated(){
		Set<IDh_ss_dsp_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dh_ss_dsp_htzc")).subjects().stream()
		.map(mapper->(IDh_ss_dsp_htzc)mapper)
