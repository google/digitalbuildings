...
/**
* Class Hws_swtc_wdpc_pwdt 
* Primary/secondary heating water system with differential pressure and supply temp control.
*/
@SuppressWarnings("serial")
public class Hws_swtc_wdpc_pwdt extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IHws_swtc_wdpc_pwdt{

	IRI newInstance;
	public Hws_swtc_wdpc_pwdt(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_pwdt"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IHws_swtc_wdpc_pwdt> getAllHws_swtc_wdpc_pwdtsObjectsCreated(){
		Set<IHws_swtc_wdpc_pwdt> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_pwdt")).subjects().stream()
		.map(mapper->(IHws_swtc_wdpc_pwdt)mapper)
