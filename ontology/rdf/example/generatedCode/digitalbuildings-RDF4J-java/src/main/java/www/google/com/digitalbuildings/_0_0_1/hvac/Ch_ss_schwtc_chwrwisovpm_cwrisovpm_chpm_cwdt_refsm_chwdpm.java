...
/**
* Class Ch_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm 
* Water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm extends www.google.com.digitalbuildings._0_0_1.hvac.Cwrisovpm implements ICh_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm{

	IRI newInstance;
	public Ch_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm"));
	}
  ...
  public void addUsesChilled_water_differential_pressure_sensor (IChilled_water_differential_pressure_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm> getAllCh_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpmsObjectsCreated(){
		Set<ICh_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_chwrwisovpm_cwrisovpm_chpm_cwdt_refsm_chwdpm)mapper)
