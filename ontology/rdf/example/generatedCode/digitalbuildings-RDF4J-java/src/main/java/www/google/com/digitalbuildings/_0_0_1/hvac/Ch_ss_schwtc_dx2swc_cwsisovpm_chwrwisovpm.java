...
/**
* Class Ch_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm 
* Two stage water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICh_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm{

	IRI newInstance;
	public Ch_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm"));
	}
  ...
  public void addUsesCondensing_supply_water_isolation_valve_status (ICondensing_supply_water_isolation_valve_status parameter)
	...
	public static Set<ICh_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm> getAllCh_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpmsObjectsCreated(){
		Set<ICh_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_dx2swc_cwsisovpm_chwrwisovpm)mapper)
