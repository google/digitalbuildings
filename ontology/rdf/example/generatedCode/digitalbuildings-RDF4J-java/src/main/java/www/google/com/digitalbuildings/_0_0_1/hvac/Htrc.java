...
/**
* Class Htrc 
* Gas or electric heater control on return side (RC).
*/
@SuppressWarnings("serial")
public class Htrc extends www.google.com.digitalbuildings._0_0_1.Control implements IHtrc{

	IRI newInstance;
	public Htrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htrc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IHtrc> getAllHtrcsObjectsCreated(){
		Set<IHtrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htrc")).subjects().stream()
		.map(mapper->(IHtrc)mapper)
