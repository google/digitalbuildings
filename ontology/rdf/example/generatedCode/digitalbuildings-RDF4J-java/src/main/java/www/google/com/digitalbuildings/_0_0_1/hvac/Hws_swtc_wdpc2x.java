...
/**
* Class Hws_swtc_wdpc2x 
* Heating water system with supply temp control and two differential pressure controlled headers.
*/
@SuppressWarnings("serial")
public class Hws_swtc_wdpc2x extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IHws_swtc_wdpc2x{

	IRI newInstance;
	public Hws_swtc_wdpc2x(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc2x"));
	}
  ...
  public void addUsesSupply_water_isolation_valve_status (ISupply_water_isolation_valve_status parameter)
	...
	public static Set<IHws_swtc_wdpc2x> getAllHws_swtc_wdpc2xsObjectsCreated(){
		Set<IHws_swtc_wdpc2x> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc2x")).subjects().stream()
		.map(mapper->(IHws_swtc_wdpc2x)mapper)
