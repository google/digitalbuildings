...
public class Outside_air_damper_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IOutside_air_damper_percentage_command{

	IRI newInstance;
	public Outside_air_damper_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_damper_percentage_command"));
	}
  ...
  public void addComposedOfPercentage (IPercentage parameter)
	...
	public static Set<IOutside_air_damper_percentage_command> getAllOutside_air_damper_percentage_commandsObjectsCreated(){
		Set<IOutside_air_damper_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Outside_air_damper_percentage_command")).subjects().stream()
		.map(mapper->(IOutside_air_damper_percentage_command)mapper)
