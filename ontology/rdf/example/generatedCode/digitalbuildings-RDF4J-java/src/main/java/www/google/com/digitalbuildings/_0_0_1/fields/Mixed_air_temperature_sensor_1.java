...
public class Mixed_air_temperature_sensor_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IMixed_air_temperature_sensor_1{

	IRI newInstance;
	public Mixed_air_temperature_sensor_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Mixed_air_temperature_sensor_1"));
	}
  ...
  public void addComposedOfTemperature (ITemperature parameter)
	...
	public static Set<IMixed_air_temperature_sensor_1> getAllMixed_air_temperature_sensor_1sObjectsCreated(){
		Set<IMixed_air_temperature_sensor_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Mixed_air_temperature_sensor_1")).subjects().stream()
		.map(mapper->(IMixed_air_temperature_sensor_1)mapper)
