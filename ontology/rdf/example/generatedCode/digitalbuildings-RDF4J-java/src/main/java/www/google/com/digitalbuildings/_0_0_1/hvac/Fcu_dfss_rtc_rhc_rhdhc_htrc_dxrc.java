...
/**
* Class Fcu_dfss_rtc_rhc_rhdhc_htrc_dxrc 
* DX fan coil with reheat and return temp and humidity control.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_rtc_rhc_rhdhc_htrc_dxrc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_rtc_rhc_rhdhc_htrc_dxrc{

	IRI newInstance;
	public Fcu_dfss_rtc_rhc_rhdhc_htrc_dxrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_rtc_rhc_rhdhc_htrc_dxrc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IFcu_dfss_rtc_rhc_rhdhc_htrc_dxrc> getAllFcu_dfss_rtc_rhc_rhdhc_htrc_dxrcsObjectsCreated(){
		Set<IFcu_dfss_rtc_rhc_rhdhc_htrc_dxrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_rtc_rhc_rhdhc_htrc_dxrc")).subjects().stream()
		.map(mapper->(IFcu_dfss_rtc_rhc_rhdhc_htrc_dxrc)mapper)
