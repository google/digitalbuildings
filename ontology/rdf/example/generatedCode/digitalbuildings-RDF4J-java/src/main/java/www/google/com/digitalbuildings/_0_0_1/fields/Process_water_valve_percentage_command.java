...
public class Process_water_valve_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IProcess_water_valve_percentage_command{

	IRI newInstance;
	public Process_water_valve_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_water_valve_percentage_command"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IProcess_water_valve_percentage_command> getAllProcess_water_valve_percentage_commandsObjectsCreated(){
		Set<IProcess_water_valve_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Process_water_valve_percentage_command")).subjects().stream()
		.map(mapper->(IProcess_water_valve_percentage_command)mapper)
