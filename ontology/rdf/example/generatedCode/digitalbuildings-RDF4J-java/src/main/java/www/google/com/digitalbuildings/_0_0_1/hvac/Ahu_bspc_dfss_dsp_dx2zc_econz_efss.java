...
/**
* Class Ahu_bspc_dfss_dsp_dx2zc_econz_efss 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_bspc_dfss_dsp_dx2zc_econz_efss extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IAhu_bspc_dfss_dsp_dx2zc_econz_efss{

	IRI newInstance;
	public Ahu_bspc_dfss_dsp_dx2zc_econz_efss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dfss_dsp_dx2zc_econz_efss"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_speed_percentage_sensor (IDischarge_fan_speed_percentage_sensor parameter)
	...
	public static Set<IAhu_bspc_dfss_dsp_dx2zc_econz_efss> getAllAhu_bspc_dfss_dsp_dx2zc_econz_efsssObjectsCreated(){
		Set<IAhu_bspc_dfss_dsp_dx2zc_econz_efss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bspc_dfss_dsp_dx2zc_econz_efss")).subjects().stream()
		.map(mapper->(IAhu_bspc_dfss_dsp_dx2zc_econz_efss)mapper)
