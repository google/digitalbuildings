...
public class Stc extends www.google.com.digitalbuildings._0_0_1.Operational implements IStc{

	IRI newInstance;
	public Stc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Stc"));
	}
  ...
  public void addUsesOptionalsHeating_request_count (IHeating_request_count parameter)
	...
	public static Set<IStc> getAllStcsObjectsCreated(){
		Set<IStc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Stc")).subjects().stream()
		.map(mapper->(IStc)mapper)
