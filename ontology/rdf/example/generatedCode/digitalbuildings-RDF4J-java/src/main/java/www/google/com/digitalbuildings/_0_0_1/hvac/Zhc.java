...
public class Zhc extends www.google.com.digitalbuildings._0_0_1.Operational implements IZhc{

	IRI newInstance;
	public Zhc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Zhc"));
	}
  ...
  public void addUsesHeater_run_command_3 (IHeater_run_command_3 parameter)
	...
	public static Set<IZhc> getAllZhcsObjectsCreated(){
		Set<IZhc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Zhc")).subjects().stream()
		.map(mapper->(IZhc)mapper)
