...
/**
* Class Ahu_chwztc_dfss_econz_hwztc_ztc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_chwztc_dfss_econz_hwztc_ztc extends www.google.com.digitalbuildings._0_0_1.hvac.Hwztc implements IAhu_chwztc_dfss_econz_hwztc_ztc{

	IRI newInstance;
	public Ahu_chwztc_dfss_econz_hwztc_ztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwztc_dfss_econz_hwztc_ztc"));
	}
  ...
  public void addUsesOptionalsZone_air_deadband_temperature_setpoint (IZone_air_deadband_temperature_setpoint parameter)
	...
	public static Set<IAhu_chwztc_dfss_econz_hwztc_ztc> getAllAhu_chwztc_dfss_econz_hwztc_ztcsObjectsCreated(){
		Set<IAhu_chwztc_dfss_econz_hwztc_ztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwztc_dfss_econz_hwztc_ztc")).subjects().stream()
		.map(mapper->(IAhu_chwztc_dfss_econz_hwztc_ztc)mapper)
