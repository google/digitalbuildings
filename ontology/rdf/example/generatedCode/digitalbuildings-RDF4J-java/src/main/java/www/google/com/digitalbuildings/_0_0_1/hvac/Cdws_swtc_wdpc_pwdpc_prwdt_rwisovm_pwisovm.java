...
/**
* Class Cdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm 
* Condenser water system with supply temp and differential pressure control.
*/
@SuppressWarnings("serial")
public class Cdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Rwisovm implements ICdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm{

	IRI newInstance;
	public Cdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm"));
	}
  ...
  public void addUsesProcess_water_isolation_valve_command (IProcess_water_isolation_valve_command parameter)
	...
	public static Set<ICdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm> getAllCdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovmsObjectsCreated(){
		Set<ICdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Cdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm")).subjects().stream()
		.map(mapper->(ICdws_swtc_wdpc_pwdpc_prwdt_rwisovm_pwisovm)mapper)
