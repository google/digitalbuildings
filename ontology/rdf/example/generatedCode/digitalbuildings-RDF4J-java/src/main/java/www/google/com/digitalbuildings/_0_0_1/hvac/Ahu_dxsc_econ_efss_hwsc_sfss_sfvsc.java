...
/**
* Class Ahu_dxsc_econ_efss_hwsc_sfss_sfvsc 
* Multi-zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dxsc_econ_efss_hwsc_sfss_sfvsc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxsc implements IAhu_dxsc_econ_efss_hwsc_sfss_sfvsc{

	IRI newInstance;
	public Ahu_dxsc_econ_efss_hwsc_sfss_sfvsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dxsc_econ_efss_hwsc_sfss_sfvsc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dxsc_econ_efss_hwsc_sfss_sfvsc> getAllAhu_dxsc_econ_efss_hwsc_sfss_sfvscsObjectsCreated(){
		Set<IAhu_dxsc_econ_efss_hwsc_sfss_sfvsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dxsc_econ_efss_hwsc_sfss_sfvsc")).subjects().stream()
		.map(mapper->(IAhu_dxsc_econ_efss_hwsc_sfss_sfvsc)mapper)
