...
public class Supply_air_dehumidification_relative_humidity_setpoint extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_air_dehumidification_relative_humidity_setpoint{

	IRI newInstance;
	public Supply_air_dehumidification_relative_humidity_setpoint(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_dehumidification_relative_humidity_setpoint"));
	}
  ...
  public void addComposedOfSupply (ISupply parameter)
	...
	public static Set<ISupply_air_dehumidification_relative_humidity_setpoint> getAllSupply_air_dehumidification_relative_humidity_setpointsObjectsCreated(){
		Set<ISupply_air_dehumidification_relative_humidity_setpoint> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_air_dehumidification_relative_humidity_setpoint")).subjects().stream()
		.map(mapper->(ISupply_air_dehumidification_relative_humidity_setpoint)mapper)
