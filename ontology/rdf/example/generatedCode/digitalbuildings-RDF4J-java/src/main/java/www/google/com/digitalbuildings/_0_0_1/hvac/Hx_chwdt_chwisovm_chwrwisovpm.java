...
/**
* Class Hx_chwdt_chwisovm_chwrwisovpm 
* Chilled and condenser water heat exchanger with isolation.
*/
@SuppressWarnings("serial")
public class Hx_chwdt_chwisovm_chwrwisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Chwisovm implements IHx_chwdt_chwisovm_chwrwisovpm{

	IRI newInstance;
	public Hx_chwdt_chwisovm_chwrwisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_chwdt_chwisovm_chwrwisovpm"));
	}
  ...
  public void addUsesChilled_return_water_isolation_valve_percentage_sensor (IChilled_return_water_isolation_valve_percentage_sensor parameter)
	...
	public static Set<IHx_chwdt_chwisovm_chwrwisovpm> getAllHx_chwdt_chwisovm_chwrwisovpmsObjectsCreated(){
		Set<IHx_chwdt_chwisovm_chwrwisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_chwdt_chwisovm_chwrwisovpm")).subjects().stream()
		.map(mapper->(IHx_chwdt_chwisovm_chwrwisovpm)mapper)
