...
/**
* Class Vav_dd_dsp_co2c 
* Typical dual duct VAV with CO2 conotrol.
*/
@SuppressWarnings("serial")
public class Vav_dd_dsp_co2c extends www.google.com.digitalbuildings._0_0_1.hvac.Dd implements IVav_dd_dsp_co2c{

	IRI newInstance;
	public Vav_dd_dsp_co2c(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_dd_dsp_co2c"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IVav_dd_dsp_co2c> getAllVav_dd_dsp_co2csObjectsCreated(){
		Set<IVav_dd_dsp_co2c> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_dd_dsp_co2c")).subjects().stream()
		.map(mapper->(IVav_dd_dsp_co2c)mapper)
