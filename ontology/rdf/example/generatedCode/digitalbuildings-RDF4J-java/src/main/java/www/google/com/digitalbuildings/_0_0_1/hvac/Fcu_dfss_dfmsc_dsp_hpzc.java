...
/**
* Class Fcu_dfss_dfmsc_dsp_hpzc 
* Multi-speed heat pump fan coil with zone temp control.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfmsc_dsp_hpzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IFcu_dfss_dfmsc_dsp_hpzc{

	IRI newInstance;
	public Fcu_dfss_dfmsc_dsp_hpzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfmsc_dsp_hpzc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IFcu_dfss_dfmsc_dsp_hpzc> getAllFcu_dfss_dfmsc_dsp_hpzcsObjectsCreated(){
		Set<IFcu_dfss_dfmsc_dsp_hpzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfmsc_dsp_hpzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfmsc_dsp_hpzc)mapper)
