...
public class Supply_water_temperature_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISupply_water_temperature_sensor{
	...
	public Supply_water_temperature_sensor(String namespace, String instanceId) {
		...
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_water_temperature_sensor"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<ISupply_water_temperature_sensor> getAllSupply_water_temperature_sensorsObjectsCreated(){
		Set<ISupply_water_temperature_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Supply_water_temperature_sensor")).subjects().stream()
		.map(mapper->(ISupply_water_temperature_sensor)mapper)
