...
/**
* Class Fan_ss_csp 
* Single cooling setpoint fan.
*/
@SuppressWarnings("serial")
public class Fan_ss_csp extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IFan_ss_csp{

	IRI newInstance;
	public Fan_ss_csp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_csp"));
	}
  ...
  public void addUsesHeater_run_command_2 (IHeater_run_command_2 parameter)
	...
	public static Set<IFan_ss_csp> getAllFan_ss_cspsObjectsCreated(){
		Set<IFan_ss_csp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_csp")).subjects().stream()
		.map(mapper->(IFan_ss_csp)mapper)
