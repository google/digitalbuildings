...
public class Hwdc extends www.google.com.digitalbuildings._0_0_1.Control implements IHwdc{

	IRI newInstance;
	public Hwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hwdc"));
	}
  ...
  public void addUsesHeating_water_valve_percentage_command (IHeating_water_valve_percentage_command parameter)
	...
	public static Set<IHwdc> getAllHwdcsObjectsCreated(){
		Set<IHwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hwdc")).subjects().stream()
		.map(mapper->(IHwdc)mapper)
