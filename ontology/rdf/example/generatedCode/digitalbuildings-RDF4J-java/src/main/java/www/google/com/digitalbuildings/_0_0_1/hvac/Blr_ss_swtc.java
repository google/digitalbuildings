...
public class Blr_ss_swtc extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IBlr_ss_swtc{

	IRI newInstance;
	public Blr_ss_swtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc"));
	}
  ...
  public void addUsesRun_status (IRun_status parameter)
	...
	public static Set<IBlr_ss_swtc> getAllBlr_ss_swtcsObjectsCreated(){
		Set<IBlr_ss_swtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc)mapper)
