...
public class Ch_ss_swtc extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements ICh_ss_swtc{

	IRI newInstance;
	public Ch_ss_swtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<ICh_ss_swtc> getAllCh_ss_swtcsObjectsCreated(){
		Set<ICh_ss_swtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_swtc")).subjects().stream()
		.map(mapper->(ICh_ss_swtc)mapper)
