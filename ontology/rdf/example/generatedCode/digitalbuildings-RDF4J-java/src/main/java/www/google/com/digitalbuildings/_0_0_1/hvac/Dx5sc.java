...
/**
* Class Dx5sc 
* Five compressor run control on supply side.
*/
@SuppressWarnings("serial")
public class Dx5sc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx5sc{

	IRI newInstance;
	public Dx5sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx5sc"));
	}
  ...
  public void addUsesSupply_air_flowrate_setpoint (ISupply_air_flowrate_setpoint parameter)
	...
	public static Set<IDx5sc> getAllDx5scsObjectsCreated(){
		Set<IDx5sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx5sc")).subjects().stream()
		.map(mapper->(IDx5sc)mapper)
