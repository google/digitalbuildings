...
/**
* Class Ahu_co2c_dfss_dsp_econz_hpzc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_co2c_dfss_dsp_econz_hpzc extends www.google.com.digitalbuildings._0_0_1.hvac.Co2c implements IAhu_co2c_dfss_dsp_econz_hpzc{

	IRI newInstance;
	public Ahu_co2c_dfss_dsp_econz_hpzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2c_dfss_dsp_econz_hpzc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_co2c_dfss_dsp_econz_hpzc> getAllAhu_co2c_dfss_dsp_econz_hpzcsObjectsCreated(){
		Set<IAhu_co2c_dfss_dsp_econz_hpzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_co2c_dfss_dsp_econz_hpzc")).subjects().stream()
		.map(mapper->(IAhu_co2c_dfss_dsp_econz_hpzc)mapper)
