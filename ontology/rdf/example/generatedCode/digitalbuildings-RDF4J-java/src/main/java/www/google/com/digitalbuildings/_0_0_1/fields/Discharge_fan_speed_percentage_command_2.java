...
public class Discharge_fan_speed_percentage_command_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDischarge_fan_speed_percentage_command_2{

	IRI newInstance;
	public Discharge_fan_speed_percentage_command_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_fan_speed_percentage_command_2"));
	}
  ...
  public void addComposedOfSpeed (ISpeed parameter)
	...
	public static Set<IDischarge_fan_speed_percentage_command_2> getAllDischarge_fan_speed_percentage_command_2sObjectsCreated(){
		Set<IDischarge_fan_speed_percentage_command_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_fan_speed_percentage_command_2")).subjects().stream()
		.map(mapper->(IDischarge_fan_speed_percentage_command_2)mapper)
