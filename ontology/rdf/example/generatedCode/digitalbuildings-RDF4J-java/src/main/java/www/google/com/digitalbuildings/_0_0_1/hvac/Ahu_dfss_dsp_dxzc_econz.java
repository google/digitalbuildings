...
/**
* Class Ahu_dfss_dsp_dxzc_econz 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_dxzc_econz extends www.google.com.digitalbuildings._0_0_1.hvac.Econz implements IAhu_dfss_dsp_dxzc_econz{

	IRI newInstance;
	public Ahu_dfss_dsp_dxzc_econz(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxzc_econz"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IAhu_dfss_dsp_dxzc_econz> getAllAhu_dfss_dsp_dxzc_econzsObjectsCreated(){
		Set<IAhu_dfss_dsp_dxzc_econz> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxzc_econz")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_dxzc_econz)mapper)
