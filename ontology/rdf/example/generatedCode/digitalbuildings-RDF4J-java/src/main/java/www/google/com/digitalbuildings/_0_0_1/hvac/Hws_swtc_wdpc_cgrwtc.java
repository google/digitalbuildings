...
/**
* Class Hws_swtc_wdpc_cgrwtc 
* Heating water system with supply temp and differential pressure control, with cogen tie-in.
*/
@SuppressWarnings("serial")
public class Hws_swtc_wdpc_cgrwtc extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IHws_swtc_wdpc_cgrwtc{

	IRI newInstance;
	public Hws_swtc_wdpc_cgrwtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_cgrwtc"));
	}
  ...
  public void addUsesOptionalsCogeneration_supply_water_temperature_sensor (ICogeneration_supply_water_temperature_sensor parameter)
	...
	public static Set<IHws_swtc_wdpc_cgrwtc> getAllHws_swtc_wdpc_cgrwtcsObjectsCreated(){
		Set<IHws_swtc_wdpc_cgrwtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wdpc_cgrwtc")).subjects().stream()
		.map(mapper->(IHws_swtc_wdpc_cgrwtc)mapper)
