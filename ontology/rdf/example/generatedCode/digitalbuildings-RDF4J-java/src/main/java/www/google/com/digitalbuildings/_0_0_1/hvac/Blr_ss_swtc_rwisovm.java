...
/**
* Class Blr_ss_swtc_rwisovm 
* Simple boiler with supply control and return isolation.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_rwisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Swtc implements IBlr_ss_swtc_rwisovm{

	IRI newInstance;
	public Blr_ss_swtc_rwisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_rwisovm"));
	}
  ...
  public void addUsesSupply_water_temperature_setpoint (ISupply_water_temperature_setpoint parameter)
	...
	public static Set<IBlr_ss_swtc_rwisovm> getAllBlr_ss_swtc_rwisovmsObjectsCreated(){
		Set<IBlr_ss_swtc_rwisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_rwisovm")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_rwisovm)mapper)
