...
public class Differential_pressure_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDifferential_pressure_sensor{
	...
	public Differential_pressure_sensor(String namespace, String instanceId) {
		...
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Differential_pressure_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IDifferential_pressure_sensor> getAllDifferential_pressure_sensorsObjectsCreated(){
		Set<IDifferential_pressure_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Differential_pressure_sensor")).subjects().stream()
		.map(mapper->(IDifferential_pressure_sensor)mapper)
