...
/**
* Class Ahu_dfss_dxzc_econd_efss_htsc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dxzc_econd_efss_htsc extends www.google.com.digitalbuildings._0_0_1.hvac.Efss implements IAhu_dfss_dxzc_econd_efss_htsc{

	IRI newInstance;
	public Ahu_dfss_dxzc_econd_efss_htsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxzc_econd_efss_htsc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_dfss_dxzc_econd_efss_htsc> getAllAhu_dfss_dxzc_econd_efss_htscsObjectsCreated(){
		Set<IAhu_dfss_dxzc_econd_efss_htsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxzc_econd_efss_htsc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dxzc_econd_efss_htsc)mapper)
