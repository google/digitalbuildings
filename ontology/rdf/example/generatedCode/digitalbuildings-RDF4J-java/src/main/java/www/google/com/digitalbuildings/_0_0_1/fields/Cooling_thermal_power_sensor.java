...
public class Cooling_thermal_power_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICooling_thermal_power_sensor{

	IRI newInstance;
	public Cooling_thermal_power_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_thermal_power_sensor"));
	}
  ...
  public void addComposedOfThermal (IThermal parameter)
	...
	public static Set<ICooling_thermal_power_sensor> getAllCooling_thermal_power_sensorsObjectsCreated(){
		Set<ICooling_thermal_power_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_thermal_power_sensor")).subjects().stream()
		.map(mapper->(ICooling_thermal_power_sensor)mapper)
