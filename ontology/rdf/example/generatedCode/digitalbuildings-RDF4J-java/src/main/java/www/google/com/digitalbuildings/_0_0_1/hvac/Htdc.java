...
public class Htdc extends www.google.com.digitalbuildings._0_0_1.Control implements IHtdc{

	IRI newInstance;
	public Htdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htdc"));
	}
  ...
  public void addUsesHeater_run_command (IHeater_run_command parameter)
	...
	public static Set<IHtdc> getAllHtdcsObjectsCreated(){
		Set<IHtdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Htdc")).subjects().stream()
		.map(mapper->(IHtdc)mapper)
