...
public class Compressor_speed_frequency_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICompressor_speed_frequency_sensor{

	IRI newInstance;
	public Compressor_speed_frequency_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_speed_frequency_sensor"));
	}
  ...
  public void addComposedOfSpeed (ISpeed parameter)
	...
	public static Set<ICompressor_speed_frequency_sensor> getAllCompressor_speed_frequency_sensorsObjectsCreated(){
		Set<ICompressor_speed_frequency_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_speed_frequency_sensor")).subjects().stream()
		.map(mapper->(ICompressor_speed_frequency_sensor)mapper)
