...
/**
* Class Fcu_dfss_rtc_dxrc 
* Typical DX FCU (return control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_rtc_dxrc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxrc implements IFcu_dfss_rtc_dxrc{

	IRI newInstance;
	public Fcu_dfss_rtc_dxrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_rtc_dxrc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IFcu_dfss_rtc_dxrc> getAllFcu_dfss_rtc_dxrcsObjectsCreated(){
		Set<IFcu_dfss_rtc_dxrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_rtc_dxrc")).subjects().stream()
		.map(mapper->(IFcu_dfss_rtc_dxrc)mapper)
