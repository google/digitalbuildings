...
/**
* Class Blr_ss_swtc_rwisovpm 
* Simple boiler with supply control and return isolation.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_rwisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IBlr_ss_swtc_rwisovpm{

	IRI newInstance;
	public Blr_ss_swtc_rwisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_rwisovpm"));
	}
  ...
  public void addUsesReturn_water_isolation_valve_status (IReturn_water_isolation_valve_status parameter)
	...
	public static Set<IBlr_ss_swtc_rwisovpm> getAllBlr_ss_swtc_rwisovpmsObjectsCreated(){
		Set<IBlr_ss_swtc_rwisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_rwisovpm")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_rwisovpm)mapper)
