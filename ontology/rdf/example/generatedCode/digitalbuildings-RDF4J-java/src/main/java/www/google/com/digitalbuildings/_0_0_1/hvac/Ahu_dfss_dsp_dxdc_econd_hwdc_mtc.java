...
/**
* Class Ahu_dfss_dsp_dxdc_econd_hwdc_mtc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_dxdc_econd_hwdc_mtc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxdc implements IAhu_dfss_dsp_dxdc_econd_hwdc_mtc{

	IRI newInstance;
	public Ahu_dfss_dsp_dxdc_econd_hwdc_mtc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxdc_econd_hwdc_mtc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IAhu_dfss_dsp_dxdc_econd_hwdc_mtc> getAllAhu_dfss_dsp_dxdc_econd_hwdc_mtcsObjectsCreated(){
		Set<IAhu_dfss_dsp_dxdc_econd_hwdc_mtc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxdc_econd_hwdc_mtc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_dxdc_econd_hwdc_mtc)mapper)
