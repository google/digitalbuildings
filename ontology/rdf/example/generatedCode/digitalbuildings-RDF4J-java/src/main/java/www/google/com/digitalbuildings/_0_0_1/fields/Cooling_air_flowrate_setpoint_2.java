...
public class Cooling_air_flowrate_setpoint_2 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICooling_air_flowrate_setpoint_2{

	IRI newInstance;
	public Cooling_air_flowrate_setpoint_2(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_air_flowrate_setpoint_2"));
	}
  ...
  public void addComposedOfSetpoint (ISetpoint parameter)
	...
	public static Set<ICooling_air_flowrate_setpoint_2> getAllCooling_air_flowrate_setpoint_2sObjectsCreated(){
		Set<ICooling_air_flowrate_setpoint_2> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Cooling_air_flowrate_setpoint_2")).subjects().stream()
		.map(mapper->(ICooling_air_flowrate_setpoint_2)mapper)
