...
public class Rtm extends www.google.com.digitalbuildings._0_0_1.Monitoring implements IRtm{

	IRI newInstance;
	public Rtm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Rtm"));
	}
  ...
  public void addUsesReturn_air_temperature_sensor (IReturn_air_temperature_sensor parameter)
	...
	public static Set<IRtm> getAllRtmsObjectsCreated(){
		Set<IRtm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Rtm")).subjects().stream()
		.map(mapper->(IRtm)mapper)
