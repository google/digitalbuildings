...
/**
* Class Mau_dfss_dfvsc_htzc_dx2zc 
* Single zone heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_dfss_dfvsc_htzc_dx2zc extends www.google.com.digitalbuildings._0_0_1.hvac.Htzc implements IMau_dfss_dfvsc_htzc_dx2zc{

	IRI newInstance;
	public Mau_dfss_dfvsc_htzc_dx2zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_htzc_dx2zc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IMau_dfss_dfvsc_htzc_dx2zc> getAllMau_dfss_dfvsc_htzc_dx2zcsObjectsCreated(){
		Set<IMau_dfss_dfvsc_htzc_dx2zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_dfss_dfvsc_htzc_dx2zc")).subjects().stream()
		.map(mapper->(IMau_dfss_dfvsc_htzc_dx2zc)mapper)
