...
public class Dh_ss_hwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IDh_ss_hwzc{

	IRI newInstance;
	public Dh_ss_hwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dh_ss_hwzc"));
	}
  ...
  public void addUsesZone_air_temperature_sensor (IZone_air_temperature_sensor parameter)
	...
	public static Set<IDh_ss_hwzc> getAllDh_ss_hwzcsObjectsCreated(){
		Set<IDh_ss_hwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dh_ss_hwzc")).subjects().stream()
		.map(mapper->(IDh_ss_hwzc)mapper)
