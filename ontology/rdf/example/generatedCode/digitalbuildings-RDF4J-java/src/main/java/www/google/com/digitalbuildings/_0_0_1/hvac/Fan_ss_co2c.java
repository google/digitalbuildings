...
public class Fan_ss_co2c extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IFan_ss_co2c{

	IRI newInstance;
	public Fan_ss_co2c(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_co2c"));
	}
  ...
  public void addUsesDischarge_air_temperature_setpoint (IDischarge_air_temperature_setpoint parameter)
	...
	public static Set<IFan_ss_co2c> getAllFan_ss_co2csObjectsCreated(){
		Set<IFan_ss_co2c> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_co2c")).subjects().stream()
		.map(mapper->(IFan_ss_co2c)mapper)
