...
public class Chdx4sc extends www.google.com.digitalbuildings._0_0_1.hvac.Functionality implements IChdx4sc{

	IRI newInstance;
	public Chdx4sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chdx4sc"));
	}
  ...
  public void addUsesCompressor_run_status_4 (ICompressor_run_status_4 parameter)
	...
	public static Set<IChdx4sc> getAllChdx4scsObjectsCreated(){
		Set<IChdx4sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chdx4sc")).subjects().stream()
		.map(mapper->(IChdx4sc)mapper)
