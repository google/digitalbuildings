...
/**
* Class Ahu_dfss_dxzc_econm 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dxzc_econm extends www.google.com.digitalbuildings._0_0_1.hvac.Econm implements IAhu_dfss_dxzc_econm{

	IRI newInstance;
	public Ahu_dfss_dxzc_econm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxzc_econm"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IAhu_dfss_dxzc_econm> getAllAhu_dfss_dxzc_econmsObjectsCreated(){
		Set<IAhu_dfss_dxzc_econm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxzc_econm")).subjects().stream()
		.map(mapper->(IAhu_dfss_dxzc_econm)mapper)
