...
/**
* Class Dfr_sfss_bypsspc_ht2sc_rtm 
* Two-stage gas/electric duct furnace.
*/
@SuppressWarnings("serial")
public class Dfr_sfss_bypsspc_ht2sc_rtm extends www.google.com.digitalbuildings._0_0_1.hvac.Ht2sc implements IDfr_sfss_bypsspc_ht2sc_rtm{

	IRI newInstance;
	public Dfr_sfss_bypsspc_ht2sc_rtm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfr_sfss_bypsspc_ht2sc_rtm"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IDfr_sfss_bypsspc_ht2sc_rtm> getAllDfr_sfss_bypsspc_ht2sc_rtmsObjectsCreated(){
		Set<IDfr_sfss_bypsspc_ht2sc_rtm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dfr_sfss_bypsspc_ht2sc_rtm")).subjects().stream()
		.map(mapper->(IDfr_sfss_bypsspc_ht2sc_rtm)mapper)
