...
/**
* Class Mau_sfss_chwsc_ht4sc 
* Heating (4-stage) and cooling (chilled water) make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_chwsc_ht4sc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfss implements IMau_sfss_chwsc_ht4sc{

	IRI newInstance;
	public Mau_sfss_chwsc_ht4sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_chwsc_ht4sc"));
	}
  ...
  public void addUsesBypass_air_damper_percentage_command (IBypass_air_damper_percentage_command parameter)
	...
	public static Set<IMau_sfss_chwsc_ht4sc> getAllMau_sfss_chwsc_ht4scsObjectsCreated(){
		Set<IMau_sfss_chwsc_ht4sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_chwsc_ht4sc")).subjects().stream()
		.map(mapper->(IMau_sfss_chwsc_ht4sc)mapper)
