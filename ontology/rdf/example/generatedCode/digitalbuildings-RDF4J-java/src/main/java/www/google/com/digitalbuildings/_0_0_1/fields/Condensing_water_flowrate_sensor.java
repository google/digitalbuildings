...
public class Condensing_water_flowrate_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICondensing_water_flowrate_sensor{

	IRI newInstance;
	public Condensing_water_flowrate_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Condensing_water_flowrate_sensor"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<ICondensing_water_flowrate_sensor> getAllCondensing_water_flowrate_sensorsObjectsCreated(){
		Set<ICondensing_water_flowrate_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Condensing_water_flowrate_sensor")).subjects().stream()
		.map(mapper->(ICondensing_water_flowrate_sensor)mapper)
