...
/**
* Class Ht4sc 
* Four gas or electric heater control on supply side.
*/
@SuppressWarnings("serial")
public class Ht4sc extends www.google.com.digitalbuildings._0_0_1.Control implements IHt4sc{

	IRI newInstance;
	public Ht4sc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht4sc"));
	}
  ...
  public void addUsesSupply_air_temperature_setpoint (ISupply_air_temperature_setpoint parameter)
	...
	public static Set<IHt4sc> getAllHt4scsObjectsCreated(){
		Set<IHt4sc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ht4sc")).subjects().stream()
		.map(mapper->(IHt4sc)mapper)
