...
public class Compressor_run_command_5 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICompressor_run_command_5{

	IRI newInstance;
	public Compressor_run_command_5(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_run_command_5"));
	}
  ...
  public void addComposedOfRun (IRun parameter)
	...
	public static Set<ICompressor_run_command_5> getAllCompressor_run_command_5sObjectsCreated(){
		Set<ICompressor_run_command_5> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Compressor_run_command_5")).subjects().stream()
		.map(mapper->(ICompressor_run_command_5)mapper)
