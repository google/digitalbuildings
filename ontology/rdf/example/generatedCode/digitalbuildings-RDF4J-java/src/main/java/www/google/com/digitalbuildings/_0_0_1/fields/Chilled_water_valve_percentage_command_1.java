...
public class Chilled_water_valve_percentage_command_1 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IChilled_water_valve_percentage_command_1{

	IRI newInstance;
	public Chilled_water_valve_percentage_command_1(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Chilled_water_valve_percentage_command_1"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<IChilled_water_valve_percentage_command_1> getAllChilled_water_valve_percentage_command_1sObjectsCreated(){
		Set<IChilled_water_valve_percentage_command_1> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Chilled_water_valve_percentage_command_1")).subjects().stream()
		.map(mapper->(IChilled_water_valve_percentage_command_1)mapper)
