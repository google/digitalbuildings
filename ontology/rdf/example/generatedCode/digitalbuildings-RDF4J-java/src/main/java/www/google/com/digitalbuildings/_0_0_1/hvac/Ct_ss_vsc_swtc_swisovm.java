...
/**
* Class Ct_ss_vsc_swtc_swisovm 
* Variable speed supply temp controlling cooling tower.
*/
@SuppressWarnings("serial")
public class Ct_ss_vsc_swtc_swisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICt_ss_vsc_swtc_swisovm{

	IRI newInstance;
	public Ct_ss_vsc_swtc_swisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovm"));
	}
  ...
  public void addUsesOptionalsCompressor_speed_frequency_sensor (ICompressor_speed_frequency_sensor parameter)
	...
	public static Set<ICt_ss_vsc_swtc_swisovm> getAllCt_ss_vsc_swtc_swisovmsObjectsCreated(){
		Set<ICt_ss_vsc_swtc_swisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovm")).subjects().stream()
		.map(mapper->(ICt_ss_vsc_swtc_swisovm)mapper)
