...
public class Speed_percentage_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ISpeed_percentage_sensor{

	IRI newInstance;
	public Speed_percentage_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Speed_percentage_sensor"));
	}
  ...
  public void addComposedOfSpeed (ISpeed parameter)
	...
	public static Set<ISpeed_percentage_sensor> getAllSpeed_percentage_sensorsObjectsCreated(){
		Set<ISpeed_percentage_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Speed_percentage_sensor")).subjects().stream()
		.map(mapper->(ISpeed_percentage_sensor)mapper)
