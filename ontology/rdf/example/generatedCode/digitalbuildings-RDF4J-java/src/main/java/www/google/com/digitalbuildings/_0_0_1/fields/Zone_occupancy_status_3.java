...
public class Zone_occupancy_status_3 extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IZone_occupancy_status_3{

	IRI newInstance;
	public Zone_occupancy_status_3(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_occupancy_status_3"));
	}
  ...
  public void addComposedOfZone (IZone parameter)
	...
	public static Set<IZone_occupancy_status_3> getAllZone_occupancy_status_3sObjectsCreated(){
		Set<IZone_occupancy_status_3> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Zone_occupancy_status_3")).subjects().stream()
		.map(mapper->(IZone_occupancy_status_3)mapper)
