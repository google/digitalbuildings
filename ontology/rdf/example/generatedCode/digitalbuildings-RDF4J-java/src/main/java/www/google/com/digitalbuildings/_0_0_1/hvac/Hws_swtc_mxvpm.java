...
/**
* Class Hws_swtc_mxvpm 
* Heating water system with mixed supply temp control.
*/
@SuppressWarnings("serial")
public class Hws_swtc_mxvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Mxvpm implements IHws_swtc_mxvpm{

	IRI newInstance;
	public Hws_swtc_mxvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_mxvpm"));
	}
  ...
  public void addUsesSpeed_percentage_command (ISpeed_percentage_command parameter)
	...
	public static Set<IHws_swtc_mxvpm> getAllHws_swtc_mxvpmsObjectsCreated(){
		Set<IHws_swtc_mxvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_mxvpm")).subjects().stream()
		.map(mapper->(IHws_swtc_mxvpm)mapper)
