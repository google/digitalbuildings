...
/**
* Class Ahu_bypsspc_dxsc_econ_efss_htsc_sfss 
* Multi-zone AHU
*/
@SuppressWarnings("serial")
public class Ahu_bypsspc_dxsc_econ_efss_htsc_sfss extends www.google.com.digitalbuildings._0_0_1.hvac.Dxsc implements IAhu_bypsspc_dxsc_econ_efss_htsc_sfss{

	IRI newInstance;
	public Ahu_bypsspc_dxsc_econ_efss_htsc_sfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dxsc_econ_efss_htsc_sfss"));
	}
  ...
  public void addUsesOptionalsCooling_request_count (ICooling_request_count parameter)
	...
	public static Set<IAhu_bypsspc_dxsc_econ_efss_htsc_sfss> getAllAhu_bypsspc_dxsc_econ_efss_htsc_sfsssObjectsCreated(){
		Set<IAhu_bypsspc_dxsc_econ_efss_htsc_sfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dxsc_econ_efss_htsc_sfss")).subjects().stream()
		.map(mapper->(IAhu_bypsspc_dxsc_econ_efss_htsc_sfss)mapper)
