...
public class Hws_swtc_wfrm extends www.google.com.digitalbuildings._0_0_1.hvac.Wfrm implements IHws_swtc_wfrm{

	IRI newInstance;
	public Hws_swtc_wfrm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wfrm"));
	}
  ...
  public void addUsesSpeed_percentage_command (ISpeed_percentage_command parameter)
	...
	public static Set<IHws_swtc_wfrm> getAllHws_swtc_wfrmsObjectsCreated(){
		Set<IHws_swtc_wfrm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_wfrm")).subjects().stream()
		.map(mapper->(IHws_swtc_wfrm)mapper)
