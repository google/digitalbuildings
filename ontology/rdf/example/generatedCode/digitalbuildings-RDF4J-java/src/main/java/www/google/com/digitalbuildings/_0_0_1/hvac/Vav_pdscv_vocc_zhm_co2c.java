...
import www.google.com.digitalbuildings._0_0_1.fields.Zone_air_voc_concentration_sensor;
...
import www.google.com.digitalbuildings._0_0_1.fields.IZone_air_voc_concentration_setpoint;
import www.google.com.digitalbuildings._0_0_1.fields.Zone_air_voc_concentration_setpoint;
...
/**
* Class Vav_pdscv_vocc_zhm_co2c 
* Pressure dependent ventilation control VAV.
*/
@SuppressWarnings("serial")
public class Vav_pdscv_vocc_zhm_co2c extends www.google.com.digitalbuildings._0_0_1.hvac.Pdscv implements IVav_pdscv_vocc_zhm_co2c{

	IRI newInstance;
	public Vav_pdscv_vocc_zhm_co2c(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_pdscv_vocc_zhm_co2c"));
	}
  ...
  public void addUsesZone_air_voc_concentration_sensor (IZone_air_voc_concentration_sensor parameter)
	...
	public Set<IZone_air_voc_concentration_sensor> getUsesZone_air_voc_concentration_sensor (){
		Set<IZone_air_voc_concentration_sensor> UsesZone_air_voc_concentration_sensor = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), null)
		.objects().forEach(action->{
			if(action instanceof Zone_air_voc_concentration_sensor) {
				UsesZone_air_voc_concentration_sensor.add((Zone_air_voc_concentration_sensor)action);
			}
		});
		return UsesZone_air_voc_concentration_sensor;
	}


  public void addUsesZone_air_voc_concentration_setpoint (IZone_air_voc_concentration_setpoint parameter)
	{
		GLOBAL.model.add(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), parameter);
	}

	public Set<IZone_air_voc_concentration_setpoint> getUsesZone_air_voc_concentration_setpoint (){
		Set<IZone_air_voc_concentration_setpoint> UsesZone_air_voc_concentration_setpoint = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), null)
		.objects().forEach(action->{
			if(action instanceof Zone_air_voc_concentration_setpoint) {
				UsesZone_air_voc_concentration_setpoint.add((Zone_air_voc_concentration_setpoint)action);
			}
		});
		return UsesZone_air_voc_concentration_setpoint;
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_pdscv_vocc_zhm_co2c> getAllVav_pdscv_vocc_zhm_co2csObjectsCreated(){
		Set<IVav_pdscv_vocc_zhm_co2c> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_pdscv_vocc_zhm_co2c")).subjects().stream()
		.map(mapper->(IVav_pdscv_vocc_zhm_co2c)mapper)
