...
/**
* Class Fcu_dfss_ztc_zhdhc_dxztc 
* DX Fan coil with zone humidity and temp control.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_ztc_zhdhc_dxztc extends www.google.com.digitalbuildings._0_0_1.hvac.Zhdhc implements IFcu_dfss_ztc_zhdhc_dxztc{

	IRI newInstance;
	public Fcu_dfss_ztc_zhdhc_dxztc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_ztc_zhdhc_dxztc"));
	}
  ...
  public void addUsesReturn_air_relative_humidity_setpoint (IReturn_air_relative_humidity_setpoint parameter)
	...
	public static Set<IFcu_dfss_ztc_zhdhc_dxztc> getAllFcu_dfss_ztc_zhdhc_dxztcsObjectsCreated(){
		Set<IFcu_dfss_ztc_zhdhc_dxztc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_ztc_zhdhc_dxztc")).subjects().stream()
		.map(mapper->(IFcu_dfss_ztc_zhdhc_dxztc)mapper)
