...
/**
* Class Ahu_dfss_econz_hp2zc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_econz_hp2zc extends www.google.com.digitalbuildings._0_0_1.hvac.Econz implements IAhu_dfss_econz_hp2zc{

	IRI newInstance;
	public Ahu_dfss_econz_hp2zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_econz_hp2zc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IAhu_dfss_econz_hp2zc> getAllAhu_dfss_econz_hp2zcsObjectsCreated(){
		Set<IAhu_dfss_econz_hp2zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_econz_hp2zc")).subjects().stream()
		.map(mapper->(IAhu_dfss_econz_hp2zc)mapper)
