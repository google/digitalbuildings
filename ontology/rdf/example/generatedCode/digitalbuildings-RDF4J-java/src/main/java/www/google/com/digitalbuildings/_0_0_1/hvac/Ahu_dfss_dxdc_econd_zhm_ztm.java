...
/**
* Class Ahu_dfss_dxdc_econd_zhm_ztm 
* Single zone AHU with minimal zone monitoring.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dxdc_econd_zhm_ztm extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IAhu_dfss_dxdc_econd_zhm_ztm{

	IRI newInstance;
	public Ahu_dfss_dxdc_econd_zhm_ztm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxdc_econd_zhm_ztm"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IAhu_dfss_dxdc_econd_zhm_ztm> getAllAhu_dfss_dxdc_econd_zhm_ztmsObjectsCreated(){
		Set<IAhu_dfss_dxdc_econd_zhm_ztm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dxdc_econd_zhm_ztm")).subjects().stream()
		.map(mapper->(IAhu_dfss_dxdc_econd_zhm_ztm)mapper)
