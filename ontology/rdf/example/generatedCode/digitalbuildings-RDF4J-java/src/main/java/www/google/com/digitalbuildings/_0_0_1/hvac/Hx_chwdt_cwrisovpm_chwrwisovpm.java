...
/**
* Class Hx_chwdt_cwrisovpm_chwrwisovpm 
* Chilled and condenser water heat exchangers.
*/
@SuppressWarnings("serial")
public class Hx_chwdt_cwrisovpm_chwrwisovpm extends www.google.com.digitalbuildings._0_0_1.hvac.Chwrwisovpm implements IHx_chwdt_cwrisovpm_chwrwisovpm{

	IRI newInstance;
	public Hx_chwdt_cwrisovpm_chwrwisovpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_chwdt_cwrisovpm_chwrwisovpm"));
	}
  ...
  public void addUsesCondensing_supply_water_temperature_sensor (ICondensing_supply_water_temperature_sensor parameter)
	...
	public static Set<IHx_chwdt_cwrisovpm_chwrwisovpm> getAllHx_chwdt_cwrisovpm_chwrwisovpmsObjectsCreated(){
		Set<IHx_chwdt_cwrisovpm_chwrwisovpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hx_chwdt_cwrisovpm_chwrwisovpm")).subjects().stream()
		.map(mapper->(IHx_chwdt_cwrisovpm_chwrwisovpm)mapper)
