...
/**
* Class Vav_sd_csp 
* Simple IDF room unit.
*/
@SuppressWarnings("serial")
public class Vav_sd_csp extends www.google.com.digitalbuildings._0_0_1.hvac.Sd implements IVav_sd_csp{

	IRI newInstance;
	public Vav_sd_csp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_csp"));
	}
  ...
  public void addUsesMedium_discharge_fan_speed_command (IMedium_discharge_fan_speed_command parameter)
	...
	public static Set<IVav_sd_csp> getAllVav_sd_cspsObjectsCreated(){
		Set<IVav_sd_csp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_sd_csp")).subjects().stream()
		.map(mapper->(IVav_sd_csp)mapper)
