...
/**
* Class Ct_ss_vsc_swtc_swisovm_rwisovm 
* Variable speed supply temp controlling cooling tower.
*/
@SuppressWarnings("serial")
public class Ct_ss_vsc_swtc_swisovm_rwisovm extends www.google.com.digitalbuildings._0_0_1.hvac.Swisovm implements ICt_ss_vsc_swtc_swisovm_rwisovm{

	IRI newInstance;
	public Ct_ss_vsc_swtc_swisovm_rwisovm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovm_rwisovm"));
	}
  ...
  public void addUsesOptionalsSpeed_percentage_sensor (ISpeed_percentage_sensor parameter)
	...
	public static Set<ICt_ss_vsc_swtc_swisovm_rwisovm> getAllCt_ss_vsc_swtc_swisovm_rwisovmsObjectsCreated(){
		Set<ICt_ss_vsc_swtc_swisovm_rwisovm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ct_ss_vsc_swtc_swisovm_rwisovm")).subjects().stream()
		.map(mapper->(ICt_ss_vsc_swtc_swisovm_rwisovm)mapper)
