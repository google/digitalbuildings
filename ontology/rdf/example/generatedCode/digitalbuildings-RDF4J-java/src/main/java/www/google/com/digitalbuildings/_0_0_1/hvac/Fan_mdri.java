...
public class Fan_mdri extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements IFan_mdri{

	IRI newInstance;
	public Fan_mdri(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_mdri"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFan_mdri> getAllFan_mdrisObjectsCreated(){
		Set<IFan_mdri> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_mdri")).subjects().stream()
		.map(mapper->(IFan_mdri)mapper)
