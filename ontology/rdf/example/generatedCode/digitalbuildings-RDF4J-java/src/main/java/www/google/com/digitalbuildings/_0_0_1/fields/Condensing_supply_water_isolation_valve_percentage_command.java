...
public class Condensing_supply_water_isolation_valve_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements ICondensing_supply_water_isolation_valve_percentage_command{

	IRI newInstance;
	public Condensing_supply_water_isolation_valve_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Condensing_supply_water_isolation_valve_percentage_command"));
	}
  ...
  public void addComposedOfWater (IWater parameter)
	...
	public static Set<ICondensing_supply_water_isolation_valve_percentage_command> getAllCondensing_supply_water_isolation_valve_percentage_commandsObjectsCreated(){
		Set<ICondensing_supply_water_isolation_valve_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Condensing_supply_water_isolation_valve_percentage_command")).subjects().stream()
		.map(mapper->(ICondensing_supply_water_isolation_valve_percentage_command)mapper)
