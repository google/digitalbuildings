...
public class Power_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IPower_sensor{

	IRI newInstance;
	public Power_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Power_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IPower_sensor> getAllPower_sensorsObjectsCreated(){
		Set<IPower_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Power_sensor")).subjects().stream()
		.map(mapper->(IPower_sensor)mapper)
