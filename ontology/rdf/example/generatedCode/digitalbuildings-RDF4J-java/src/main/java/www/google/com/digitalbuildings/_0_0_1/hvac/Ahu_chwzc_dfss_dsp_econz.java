...
/**
* Class Ahu_chwzc_dfss_dsp_econz 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_chwzc_dfss_dsp_econz extends www.google.com.digitalbuildings._0_0_1.hvac.Econz implements IAhu_chwzc_dfss_dsp_econz{

	IRI newInstance;
	public Ahu_chwzc_dfss_dsp_econz(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwzc_dfss_dsp_econz"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_chwzc_dfss_dsp_econz> getAllAhu_chwzc_dfss_dsp_econzsObjectsCreated(){
		Set<IAhu_chwzc_dfss_dsp_econz> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_chwzc_dfss_dsp_econz")).subjects().stream()
		.map(mapper->(IAhu_chwzc_dfss_dsp_econz)mapper)
