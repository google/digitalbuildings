...
/**
* Class Hws_swtc_bypvpm 
* Heating water system with supply temp control and bypass.
*/
@SuppressWarnings("serial")
public class Hws_swtc_bypvpm extends www.google.com.digitalbuildings._0_0_1.hvac.Bypvpm implements IHws_swtc_bypvpm{

	IRI newInstance;
	public Hws_swtc_bypvpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_bypvpm"));
	}
  ...
  public void addUsesSpeed_percentage_command (ISpeed_percentage_command parameter)
	...
	public static Set<IHws_swtc_bypvpm> getAllHws_swtc_bypvpmsObjectsCreated(){
		Set<IHws_swtc_bypvpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Hws_swtc_bypvpm")).subjects().stream()
		.map(mapper->(IHws_swtc_bypvpm)mapper)
