...
/**
* Class Ahu_dfss_dsp_dxzc_econz_htzc 
* Single zone AHU.
*/
@SuppressWarnings("serial")
public class Ahu_dfss_dsp_dxzc_econz_htzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dsp implements IAhu_dfss_dsp_dxzc_econz_htzc{

	IRI newInstance;
	public Ahu_dfss_dsp_dxzc_econz_htzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxzc_econz_htzc"));
	}
  ...
  public void addUsesDischarge_air_heating_temperature_setpoint (IDischarge_air_heating_temperature_setpoint parameter)
	...
	public static Set<IAhu_dfss_dsp_dxzc_econz_htzc> getAllAhu_dfss_dsp_dxzc_econz_htzcsObjectsCreated(){
		Set<IAhu_dfss_dsp_dxzc_econz_htzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_dfss_dsp_dxzc_econz_htzc")).subjects().stream()
		.map(mapper->(IAhu_dfss_dsp_dxzc_econz_htzc)mapper)
