...
public class Boost_fan_run_status extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IBoost_fan_run_status{

	IRI newInstance;
	public Boost_fan_run_status(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Boost_fan_run_status"));
	}
  ...
  public void addComposedOfStatus (IStatus parameter)
	...
	public static Set<IBoost_fan_run_status> getAllBoost_fan_run_statussObjectsCreated(){
		Set<IBoost_fan_run_status> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Boost_fan_run_status")).subjects().stream()
		.map(mapper->(IBoost_fan_run_status)mapper)
