...
public class Dx2zc2x extends www.google.com.digitalbuildings._0_0_1.Control implements IDx2zc2x{

	IRI newInstance;
	public Dx2zc2x(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2zc2x"));
	}
  ...
  public void addUsesZone_air_temperature_sensor_2 (IZone_air_temperature_sensor_2 parameter)
	...
	public static Set<IDx2zc2x> getAllDx2zc2xsObjectsCreated(){
		Set<IDx2zc2x> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2zc2x")).subjects().stream()
		.map(mapper->(IDx2zc2x)mapper)
