...
/**
* Class Dx2zc 
* Two compressor run control on zone side (DSP, CSP).
*/
@SuppressWarnings("serial")
public class Dx2zc extends www.google.com.digitalbuildings._0_0_1.Control implements IDx2zc{

	IRI newInstance;
	public Dx2zc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2zc"));
	}
  ...
  public void addUsesOptionalsLeaving_cooling_coil_temperature_sensor (ILeaving_cooling_coil_temperature_sensor parameter)
	...
	public static Set<IDx2zc> getAllDx2zcsObjectsCreated(){
		Set<IDx2zc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Dx2zc")).subjects().stream()
		.map(mapper->(IDx2zc)mapper)
