...
/**
* Class Ahu_bypsspc_dsp_dx2zc_econ_htzc_sfss 
* Weird type where the unit serves a zone, but has static control.
*/
@SuppressWarnings("serial")
public class Ahu_bypsspc_dsp_dx2zc_econ_htzc_sfss extends www.google.com.digitalbuildings._0_0_1.hvac.Econ implements IAhu_bypsspc_dsp_dx2zc_econ_htzc_sfss{

	IRI newInstance;
	public Ahu_bypsspc_dsp_dx2zc_econ_htzc_sfss(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dsp_dx2zc_econ_htzc_sfss"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IAhu_bypsspc_dsp_dx2zc_econ_htzc_sfss> getAllAhu_bypsspc_dsp_dx2zc_econ_htzc_sfsssObjectsCreated(){
		Set<IAhu_bypsspc_dsp_dx2zc_econ_htzc_sfss> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_dsp_dx2zc_econ_htzc_sfss")).subjects().stream()
		.map(mapper->(IAhu_bypsspc_dsp_dx2zc_econ_htzc_sfss)mapper)
