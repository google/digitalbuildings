...
/**
* Class Ahu_bypsspc_econ_efss_hp2zc_sfss_stm 
* Multi-zone AHU. Weird unit with supply static control for a single zone.
*/
@SuppressWarnings("serial")
public class Ahu_bypsspc_econ_efss_hp2zc_sfss_stm extends www.google.com.digitalbuildings._0_0_1.hvac.Hp2zc implements IAhu_bypsspc_econ_efss_hp2zc_sfss_stm{

	IRI newInstance;
	public Ahu_bypsspc_econ_efss_hp2zc_sfss_stm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_econ_efss_hp2zc_sfss_stm"));
	}
  ...
  public void addUsesOptionalsCooling_request_count (ICooling_request_count parameter)
	...
	public static Set<IAhu_bypsspc_econ_efss_hp2zc_sfss_stm> getAllAhu_bypsspc_econ_efss_hp2zc_sfss_stmsObjectsCreated(){
		Set<IAhu_bypsspc_econ_efss_hp2zc_sfss_stm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ahu_bypsspc_econ_efss_hp2zc_sfss_stm")).subjects().stream()
		.map(mapper->(IAhu_bypsspc_econ_efss_hp2zc_sfss_stm)mapper)
