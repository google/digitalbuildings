...
public class Discharge_fan_power_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IDischarge_fan_power_sensor{

	IRI newInstance;
	public Discharge_fan_power_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_fan_power_sensor"));
	}
  ...
  public void addComposedOfSensor (ISensor parameter)
	...
	public static Set<IDischarge_fan_power_sensor> getAllDischarge_fan_power_sensorsObjectsCreated(){
		Set<IDischarge_fan_power_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Discharge_fan_power_sensor")).subjects().stream()
		.map(mapper->(IDischarge_fan_power_sensor)mapper)
