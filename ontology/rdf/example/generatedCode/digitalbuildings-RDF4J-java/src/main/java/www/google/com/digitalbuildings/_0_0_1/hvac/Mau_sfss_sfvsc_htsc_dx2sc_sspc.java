...
/**
* Class Mau_sfss_sfvsc_htsc_dx2sc_sspc 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc_htsc_dx2sc_sspc extends www.google.com.digitalbuildings._0_0_1.hvac.Sfvsc implements IMau_sfss_sfvsc_htsc_dx2sc_sspc{

	IRI newInstance;
	public Mau_sfss_sfvsc_htsc_dx2sc_sspc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_htsc_dx2sc_sspc"));
	}
  ...
  public void addUsesSupply_air_heating_temperature_setpoint (ISupply_air_heating_temperature_setpoint parameter)
	...
	public static Set<IMau_sfss_sfvsc_htsc_dx2sc_sspc> getAllMau_sfss_sfvsc_htsc_dx2sc_sspcsObjectsCreated(){
		Set<IMau_sfss_sfvsc_htsc_dx2sc_sspc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_htsc_dx2sc_sspc")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_htsc_dx2sc_sspc)mapper)
