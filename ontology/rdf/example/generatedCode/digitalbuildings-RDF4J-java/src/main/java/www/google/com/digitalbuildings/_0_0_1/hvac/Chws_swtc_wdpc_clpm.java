...
/**
* Class Chws_swtc_wdpc_clpm 
* Chilled water system with supply temp and pressure control.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc_clpm extends www.google.com.digitalbuildings._0_0_1.hvac.Wdpc implements IChws_swtc_wdpc_clpm{

	IRI newInstance;
	public Chws_swtc_wdpc_clpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm"));
	}
  ...
  public void addUsesProcess_cooling_thermal_power_sensor (IProcess_cooling_thermal_power_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc_clpm> getAllChws_swtc_wdpc_clpmsObjectsCreated(){
		Set<IChws_swtc_wdpc_clpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_clpm")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc_clpm)mapper)
