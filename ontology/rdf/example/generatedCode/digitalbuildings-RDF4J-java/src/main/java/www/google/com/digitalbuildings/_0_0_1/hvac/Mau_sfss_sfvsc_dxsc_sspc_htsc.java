...
/**
* Class Mau_sfss_sfvsc_dxsc_sspc_htsc 
* Heating and cooling make-up air unit.
*/
@SuppressWarnings("serial")
public class Mau_sfss_sfvsc_dxsc_sspc_htsc extends www.google.com.digitalbuildings._0_0_1.hvac.Sspc implements IMau_sfss_sfvsc_dxsc_sspc_htsc{

	IRI newInstance;
	public Mau_sfss_sfvsc_dxsc_sspc_htsc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_dxsc_sspc_htsc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IMau_sfss_sfvsc_dxsc_sspc_htsc> getAllMau_sfss_sfvsc_dxsc_sspc_htscsObjectsCreated(){
		Set<IMau_sfss_sfvsc_dxsc_sspc_htsc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Mau_sfss_sfvsc_dxsc_sspc_htsc")).subjects().stream()
		.map(mapper->(IMau_sfss_sfvsc_dxsc_sspc_htsc)mapper)
