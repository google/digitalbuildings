...
/**
* Class Uh_ss_dsp_hwzc 
* Heating water zone unit heater.
*/
@SuppressWarnings("serial")
public class Uh_ss_dsp_hwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Hwzc implements IUh_ss_dsp_hwzc{

	IRI newInstance;
	public Uh_ss_dsp_hwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Uh_ss_dsp_hwzc"));
	}
  ...
  public void addUsesOptionalsDischarge_fan_run_status (IDischarge_fan_run_status parameter)
	...
	public static Set<IUh_ss_dsp_hwzc> getAllUh_ss_dsp_hwzcsObjectsCreated(){
		Set<IUh_ss_dsp_hwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Uh_ss_dsp_hwzc")).subjects().stream()
		.map(mapper->(IUh_ss_dsp_hwzc)mapper)
