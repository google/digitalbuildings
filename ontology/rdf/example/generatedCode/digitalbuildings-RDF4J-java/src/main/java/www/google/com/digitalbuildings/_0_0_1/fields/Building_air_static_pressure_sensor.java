...
public class Building_air_static_pressure_sensor extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IBuilding_air_static_pressure_sensor{

	IRI newInstance;
	public Building_air_static_pressure_sensor(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Building_air_static_pressure_sensor"));
	}
  ...
  public void addComposedOfStatic (IStatic parameter)
	...
	public static Set<IBuilding_air_static_pressure_sensor> getAllBuilding_air_static_pressure_sensorsObjectsCreated(){
		Set<IBuilding_air_static_pressure_sensor> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Building_air_static_pressure_sensor")).subjects().stream()
		.map(mapper->(IBuilding_air_static_pressure_sensor)mapper)
