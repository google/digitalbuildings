...
/**
* Class Vav_dd_dsp 
* Typical dual duct VAV.
*/
@SuppressWarnings("serial")
public class Vav_dd_dsp extends www.google.com.digitalbuildings._0_0_1.hvac.Dd implements IVav_dd_dsp{

	IRI newInstance;
	public Vav_dd_dsp(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_dd_dsp"));
	}
  ...
  public void addUsesOptionalsZone_use_label (IZone_use_label parameter)
	...
	public static Set<IVav_dd_dsp> getAllVav_dd_dspsObjectsCreated(){
		Set<IVav_dd_dsp> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Vav_dd_dsp")).subjects().stream()
		.map(mapper->(IVav_dd_dsp)mapper)
