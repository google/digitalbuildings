...
/**
* Class Fcu_dfss_dsp_hwzc_chwzc 
* Hydronic fan coil with heating and cooling (zone temp control).
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dsp_hwzc_chwzc extends www.google.com.digitalbuildings._0_0_1.hvac.Dfss implements IFcu_dfss_dsp_hwzc_chwzc{

	IRI newInstance;
	public Fcu_dfss_dsp_hwzc_chwzc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_hwzc_chwzc"));
	}
  ...
  public void addUsesOptionalsBypass_valve_percentage_sensor (IBypass_valve_percentage_sensor parameter)
	...
	public static Set<IFcu_dfss_dsp_hwzc_chwzc> getAllFcu_dfss_dsp_hwzc_chwzcsObjectsCreated(){
		Set<IFcu_dfss_dsp_hwzc_chwzc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dsp_hwzc_chwzc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dsp_hwzc_chwzc)mapper)
