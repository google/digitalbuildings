...
public class Chwdc extends www.google.com.digitalbuildings._0_0_1.Control implements IChwdc{

	IRI newInstance;
	public Chwdc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwdc"));
	}
  ...
  public void addUsesDischarge_air_temperature_setpoint (IDischarge_air_temperature_setpoint parameter)
	...
	public static Set<IChwdc> getAllChwdcsObjectsCreated(){
		Set<IChwdc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chwdc")).subjects().stream()
		.map(mapper->(IChwdc)mapper)
