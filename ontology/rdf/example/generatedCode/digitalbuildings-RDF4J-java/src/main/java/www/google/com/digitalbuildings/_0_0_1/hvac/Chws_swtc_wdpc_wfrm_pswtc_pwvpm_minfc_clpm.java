...
import www.google.com.digitalbuildings._0_0_1.fields.IProcess_supply_water_temperature_setpoint;
import www.google.com.digitalbuildings._0_0_1.fields.Process_supply_water_temperature_setpoint;
...
/**
* Class Chws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm 
* Chilled and process water system.
*/
@SuppressWarnings("serial")
public class Chws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm extends www.google.com.digitalbuildings._0_0_1.hvac.Wdpc implements IChws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm{

	IRI newInstance;
	public Chws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm"));
	}
  ...
  public void addUsesProcess_supply_water_temperature_setpoint (IProcess_supply_water_temperature_setpoint parameter)
	{
		GLOBAL.model.add(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), parameter);
	}

	public Set<IProcess_supply_water_temperature_setpoint> getUsesProcess_supply_water_temperature_setpoint (){
		Set<IProcess_supply_water_temperature_setpoint> UsesProcess_supply_water_temperature_setpoint = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#uses"), null)
		.objects().forEach(action->{
			if(action instanceof Process_supply_water_temperature_setpoint) {
				UsesProcess_supply_water_temperature_setpoint.add((Process_supply_water_temperature_setpoint)action);
			}
		});
		return UsesProcess_supply_water_temperature_setpoint;
	}
  ...
  public void addUsesOptionalsProcess_return_water_temperature_sensor (IProcess_return_water_temperature_sensor parameter)
	{
		GLOBAL.model.add(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#usesOptional"), parameter);
	}

	public Set<IProcess_return_water_temperature_sensor> getUsesOptionalsProcess_return_water_temperature_sensor (){
		Set<IProcess_return_water_temperature_sensor> UsesOptionalsProcess_return_water_temperature_sensor = new HashSet<>();
		GLOBAL.model.filter(this, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1#usesOptional"), null)
		.objects().forEach(action->{
			if(action instanceof Process_return_water_temperature_sensor) {
				UsesOptionalsProcess_return_water_temperature_sensor.add((Process_return_water_temperature_sensor)action);
			}
		});
		return UsesOptionalsProcess_return_water_temperature_sensor;
	}
  ...
  public void addUsesOptionalsCompressor_speed_frequency_sensor (ICompressor_speed_frequency_sensor parameter)
	...
	public static Set<IChws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm> getAllChws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpmsObjectsCreated(){
		Set<IChws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Chws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm")).subjects().stream()
		.map(mapper->(IChws_swtc_wdpc_wfrm_pswtc_pwvpm_minfc_clpm)mapper)
