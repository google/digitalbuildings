...
/**
* Class Ch_ss_schwtc_cwdt 
* Simple water cooled chiller.
*/
@SuppressWarnings("serial")
public class Ch_ss_schwtc_cwdt extends www.google.com.digitalbuildings._0_0_1.hvac.Ss implements ICh_ss_schwtc_cwdt{

	IRI newInstance;
	public Ch_ss_schwtc_cwdt(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_cwdt"));
	}
  ...
  public void addUsesRefrigerant_evaporator_saturation_temperature_sensor (IRefrigerant_evaporator_saturation_temperature_sensor parameter)
	...
	public static Set<ICh_ss_schwtc_cwdt> getAllCh_ss_schwtc_cwdtsObjectsCreated(){
		Set<ICh_ss_schwtc_cwdt> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Ch_ss_schwtc_cwdt")).subjects().stream()
		.map(mapper->(ICh_ss_schwtc_cwdt)mapper)
