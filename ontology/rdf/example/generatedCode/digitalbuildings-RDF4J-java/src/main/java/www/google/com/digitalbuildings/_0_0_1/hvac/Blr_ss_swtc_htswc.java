...
/**
* Class Blr_ss_swtc_htswc 
* Single-stage boiler with supply control.
*/
@SuppressWarnings("serial")
public class Blr_ss_swtc_htswc extends www.google.com.digitalbuildings._0_0_1.hvac.Htswc implements IBlr_ss_swtc_htswc{

	IRI newInstance;
	public Blr_ss_swtc_htswc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_htswc"));
	}
  ...
  public void addUsesHeater_run_command_2 (IHeater_run_command_2 parameter)
	...
	public static Set<IBlr_ss_swtc_htswc> getAllBlr_ss_swtc_htswcsObjectsCreated(){
		Set<IBlr_ss_swtc_htswc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Blr_ss_swtc_htswc")).subjects().stream()
		.map(mapper->(IBlr_ss_swtc_htswc)mapper)
