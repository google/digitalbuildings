...
public class Humidification_percentage_command extends www.google.com.digitalbuildings._0_0_1.fields.Field implements IHumidification_percentage_command{

	IRI newInstance;
	public Humidification_percentage_command(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Humidification_percentage_command"));
	}
  ...
  public void addComposedOfPercentage (IPercentage parameter)
	...
	public static Set<IHumidification_percentage_command> getAllHumidification_percentage_commandsObjectsCreated(){
		Set<IHumidification_percentage_command> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/fields#Humidification_percentage_command")).subjects().stream()
		.map(mapper->(IHumidification_percentage_command)mapper)
