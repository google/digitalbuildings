...
public class Wdpc extends www.google.com.digitalbuildings._0_0_1.Operational implements IWdpc{

	IRI newInstance;
	public Wdpc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Wdpc"));
	}
  ...
  public void addUsesOptionalsPressurization_request_count (IPressurization_request_count parameter)
	...
	public static Set<IWdpc> getAllWdpcsObjectsCreated(){
		Set<IWdpc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Wdpc")).subjects().stream()
		.map(mapper->(IWdpc)mapper)
