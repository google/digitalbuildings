...
/**
* Class Fan_ss_refc 
* Refrigerant control fan.
*/
@SuppressWarnings("serial")
public class Fan_ss_refc extends www.google.com.digitalbuildings._0_0_1.hvac.Refc implements IFan_ss_refc{

	IRI newInstance;
	public Fan_ss_refc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_refc"));
	}
  ...
  public void addUsesOptionalsLeaving_heating_coil_temperature_sensor (ILeaving_heating_coil_temperature_sensor parameter)
	...
	public static Set<IFan_ss_refc> getAllFan_ss_refcsObjectsCreated(){
		Set<IFan_ss_refc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fan_ss_refc")).subjects().stream()
		.map(mapper->(IFan_ss_refc)mapper)
