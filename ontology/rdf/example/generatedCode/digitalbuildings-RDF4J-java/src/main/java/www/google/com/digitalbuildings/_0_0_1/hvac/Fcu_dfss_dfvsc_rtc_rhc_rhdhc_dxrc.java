...
/**
* Class Fcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc 
* Variable speed DX fan coil with return temp and humidity control.
*/
@SuppressWarnings("serial")
public class Fcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc extends www.google.com.digitalbuildings._0_0_1.hvac.Dxrc implements IFcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc{

	IRI newInstance;
	public Fcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc(String namespace, String instanceId) {
		super(namespace, instanceId);

		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(this, RDF.TYPE, GLOBAL.factory.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc"));
	}
  ...
  public void addUsesOptionalsEconomizer_mode (IEconomizer_mode parameter)
	...
	public static Set<IFcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc> getAllFcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrcsObjectsCreated(){
		Set<IFcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc> objects = new HashSet<>();
		objects = GLOBAL.model.filter(null, RDF.TYPE, GLOBAL.factory
		.createIRI("http://www.google.com/digitalbuildings/0.0.1/hvac#Fcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc")).subjects().stream()
		.map(mapper->(IFcu_dfss_dfvsc_rtc_rhc_rhdhc_dxrc)mapper)
