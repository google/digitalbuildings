...
_DEFAULT_ONTOLOGY_LOCATION = path.join('third_party/digitalbuildings/',
                                       'ontology', 'yaml', 'resources')
_BAD_MODIFIED_ONTOLOGY = path.join('third_party/digitalbuildings/tools/validators/instance_validator/', 'fake_resources/', 'BAD/', 'BAD_FORMAT/')
