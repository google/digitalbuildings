...
class EntityTypeField(StandardField):
    ...
    Attributes:
        ...
        is_required: optionality of the field relative to it's Entity Type# Configure the Azure provider

    Returns:
        An instance of the EntityTypeField class
    """

    def __init__(self, namespace_name: str, standard_field_name: str, is_required: bool, increment: str = ''):
        super().__init__(namespace_name, standard_field_name)
        self._increment = increment
        self._is_required = is_required

    def GetIncrement() -> str:
