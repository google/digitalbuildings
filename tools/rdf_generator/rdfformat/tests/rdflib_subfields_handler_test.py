  ...
  def testSubfieldsGraphGeneration(self):
    ...
    self.assertIn(
        (
            concentration,
            rdflib.RDFS.comment,
            rdflib.Literal(concentration_description),
        ),
        g_subfields,
    )
    ...
    self.assertIn(
        (air, rdflib.RDFS.comment, rdflib.Literal(air_description)), g_subfields
    )
    ...
    self.assertIn(
        (point_type, rdflib.RDFS.subClassOf, subfield_type), g_subfields
    )
    self.assertIn((capacity, rdflib.RDFS.subClassOf, point_type), g_subfields)

    self.assertIn(
        (aggregation, rdflib.RDFS.subClassOf, subfield_type), g_subfields
    )
