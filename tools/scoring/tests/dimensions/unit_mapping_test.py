...
class UnitMappingTest(absltest.TestCase):
  ...
  def setUp(self):
    super().setUp()
    one_entity_file_path = 'tests/samples/proposed/unit_mapping_one_entity.yaml'
  ...
  def testEvaluate_ScoreNone(self):
    ...
    """
    none_score_expected = UnitMapping(
  ...
  def testEvaluate_ScoreHighestPossible(self):
    ...
    """
    highest_score_expected = UnitMapping(
    ...
    # Inherited calculated attributes
    self.assertEqual(highest_score_expected.correct_total(), 1)
    self.assertEqual(highest_score_expected.correct_ceiling(), 1)
  ...
  def testEvaluate_ScoreLowestPossible(self):
    ...
    """
    lowest_score_expected = UnitMapping(
    ...
    self.assertEqual(lowest_score_expected.correct_ceiling(), 1)
    self.assertEqual(lowest_score_expected.incorrect_total(), 1)
  ...
  def testEvaluate_ScoreMiddling(self):
    ...
    middling_score_expected = UnitMapping(
    ...
    self.assertEqual(middling_score_expected.incorrect_reporting, 1)
