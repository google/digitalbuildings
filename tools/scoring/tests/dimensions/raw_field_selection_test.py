...
class RawFieldSelectionTest(absltest.TestCase):
  ...
  def testEvaluate_ScoreNone(self):
    ...
    """
    none_score_expected = RawFieldSelection(
  ...
  def testEvaluate_ScoreHighestPossible(self):
    ...
    """
    highest_score_expected = RawFieldSelection(
  ...
  def testEvaluate_ScoreLowestPossible(self):
    ...
    """
    lowest_score_expected = RawFieldSelection(
  ...
  def testEvaluate_ScoreMiddling(self):
    ...
    middling_score_expected = RawFieldSelection(
