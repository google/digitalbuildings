...
class ParseConfigTest(absltest.TestCase):
  ...
  def testAppendTypes(self, mock_print):
    ...
    deserialized_files_appended = self.parse.append_types(  # pylint: disable=protected-access
  ...
  def testMatchReportingEntities(self):
    ...
    matches = parse_config.ParseConfig.match_reporting_entities(  # pylint: disable=protected-access
  ...
  def testRetrieveReportingTranslations(self):
    ...
    translations = parse_config.ParseConfig.retrieve_reporting_translations(  # pylint: disable=protected-access
        matches=matches,
        proposed_entities=proposed_entities,
        solution_entities=solution_entities)
