...
DIR_ONE_LEVEL = path.join(path.dirname(path.realpath(__file__)), 'fake_resources', 'dir1')
DIR_MULTI_DIR = path.join(path.join(path.dirname(path.realpath(__file__)), 'fake_resources', 'dir2')
