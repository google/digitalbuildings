...
def FileNameEnumerationHelper(filename: str) -> str:
  ...
  Args:
    filename: string representing the filename to be enumerated with a naive UTC
      timestamp according to ISO 8601.

  Returns:
    the filename enumerated as <naive UTC timestamp>_<filename>. example:
    2020-10-15T17:21:59Z_instance_validation_report.txt where the timestamp
    is given as 2020-10-15T17:21:59Z and the filename as
