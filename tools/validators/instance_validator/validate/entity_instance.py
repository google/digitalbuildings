...
class InstanceValidator(object):
  ...
  def Validate(self, entity: 'EntityInstance') -> bool:
    ...
    if self.config_mode == instance_parser.ConfigMode.INITIALIZE and entity.operation != instance_parser.EntityOperation.ADD:
    ...
    # This check should never fail as syntax checks currently catch this
    if entity.operation == instance_parser.EntityOperation.UPDATE and not entity.etag:
